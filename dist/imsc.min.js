...
c.explicit_dur:null!==c.explicit_end&&null===c.explicit_dur?q+c.explicit_end:b;delete c.explicit_begin;delete c.explicit_dur;delete c.explicit_end;a._registerEvent(c)}function D(a){this.node=a}function e(){this.events=[];this.head=new a;this.body=null}function a(){this.styling=new c;this.layout=new t}function c(){this.styles={};this.initials={}}function f(){this.styleRefs=this.styleAttrs=this.id=null}function q(){this.styleAttrs=null}function t(){this.regions={}}function R(a,c){this.kind="image";
this.src=a;this.type=c}function n(a){this.id=a}function A(a){this.regionID=a}function I(a){this.styleAttrs=a}function u(a){this.sets=a}function J(a){this.contents=a}function p(a,c,b){this.explicit_begin=a;this.explicit_end=c;this.explicit_dur=b}function v(){this.kind="body"}function O(){this.kind="div"}function E(){this.kind="p"}function r(){this.kind="span"}function z(){this.kind="span"}function P(){this.kind="br"}function K(){}function W(){}function y(a){var c=null;a&&(a=a.attributes["xml:id"]||
...
a[b])}function M(a,c){if(a&&a.warn&&a.warn(c))throw c;}function L(a,c){if(a&&a.error&&a.error(c))throw c;}function B(a,c){a&&a.fatal&&a.fatal(c);throw c;}function Z(a,c){for(var b=0,f=a.length-1,d;b<=f;){d=Math.floor((b+f)/2);var q=a[d];if(q<c)b=d+1;else if(q>c)f=d-1;else return{found:!0,index:d}}return{found:!1,index:b}}x.fromXML=function(H,w,C){var u=g.parser(!0,{xmlns:!0}),m=[],n=[],x=[],A=0,h=null;u.onclosetag=function(a){if(m[0]instanceof c)for(var b in m[0].styles)X(m[0],m[0].styles[b],w);else if(m[0]instanceof
E||m[0]instanceof r){if(1<m[0].contents.length){a=[m[0].contents[0]];for(b=1;b<m[0].contents.length;b++)m[0].contents[b]instanceof z&&a[a.length-1]instanceof z?a[a.length-1].text+=m[0].contents[b].text:a.push(m[0].contents[b]);m[0].contents=a}m[0]instanceof r&&1===m[0].contents.length&&m[0].contents[0]instanceof z&&(m[0].text=m[0].contents[0].text,delete m[0].contents)}else if(m[0]instanceof D)if(m[0].node.uri===k.ns_tt&&"metadata"===m[0].node.local)A--;else if(0<A&&C&&"onCloseTag"in C)C.onCloseTag();
x.shift();n.shift();m.shift()};u.ontext=function(a){if(void 0!==m[0])if(m[0]instanceof r||m[0]instanceof E){if(m[0]instanceof r){var c=m[0].styleAttrs[l.byName.ruby.qname];if("container"===c||"textContainer"===c||"baseContainer"===c)return}c=new z;c.initFromText(h,m[0],a,x[0],w);m[0].contents.push(c)}else if(m[0]instanceof D&&0<A&&C&&"onText"in C)C.onText(a)};u.onopentag=function(b){function d(a){k.ttaf_map[a.uri]&&(a.uri=k.ttaf_map[a.uri])}var H=b.attributes["xml:space"];H?x.unshift(H.value):0===
x.length?x.unshift("default"):x.unshift(x[0]);(H=b.attributes["xml:lang"])?n.unshift(H.value):0===n.length?n.unshift(""):n.unshift(n[0]);d(b);if(b.attributes)for(var u in b.attributes)b.attributes.hasOwnProperty(u)&&d(b.attributes[u]);if(b.uri===k.ns_tt)if("tt"===b.local)null!==h&&B(w,"Two <tt> elements at ("+this.line+","+this.column+")"),h=new e,h.initFromNode(b,w),m.unshift(h);else if("head"===b.local)m[0]instanceof e||B(w,"Parent of <head> element is not <tt> at ("+this.line+","+this.column+")"),
...
null!==d&&(c=/(\d+)\s+(\d+)/.exec(d),null!==c?(d=parseInt(c[1]),c=parseInt(c[2]),0!==d&&0!==c?f=d/c:L(b,"Illegal aspectRatio values (ignoring)")):L(b,"Malformed aspectRatio attribute (ignoring)"));this.aspectRatio=f;f=N(a,k.ns_ttp,"timeBase");null!==f&&"media"!==f&&B(b,"Unsupported time base");a=aa(a,b);null===a?this.pxLength={h:null,w:null}:("px"===a.h.unit&&"px"===a.w.unit||B(b,"Extent on TT must be in px or absent"),this.pxLength={h:new h.ComputedLength(0,1/a.h.value),w:new h.ComputedLength(1/
...
b.attributes?b.attributes.type.value:null)||L(f,"Invalid image@type attribute");I.prototype.initFromNode.call(this,a,c,b,f);p.prototype.initFromNode.call(this,a,c,b,f);u.prototype.initFromNode.call(this,a,c,b,f);A.prototype.initFromNode.call(this,a,c,b,f)};n.prototype.initFromNode=function(a,c,b,f){this.id=y(b)};A.prototype.initFromNode=function(a,c,b,f){this.regionID=b&&"region"in b.attributes?b.attributes.region.value:""};I.prototype.initFromNode=function(a,b,c,f){this.styleAttrs=T(c,f);null!==
a.head&&null!==a.head.styling&&Y(a.head.styling,S(c),this.styleAttrs,f)};u.prototype.initFromNode=function(a,c,b,f){this.sets=[]};J.prototype.initFromNode=function(a,c,b,f){this.contents=[]};p.prototype.initFromNode=function(a,c,b,f){c=null;b&&"begin"in b.attributes&&(c=U(a.tickRate,a.effectiveFrameRate,b.attributes.begin.value),null===c&&M(f,"Malformed begin value "+b.attributes.begin.value+" (using 0)"));var d=null;b&&"dur"in b.attributes&&(d=U(a.tickRate,a.effectiveFrameRate,b.attributes.dur.value),
...
function(a,b,c){I.prototype.initFromNode.call(this,a,null,b,c);p.prototype.initFromNode.call(this,a,null,b,c);u.prototype.initFromNode.call(this,a,null,b,c);A.prototype.initFromNode.call(this,a,null,b,c);J.prototype.initFromNode.call(this,a,null,b,c)};O.prototype.initFromNode=function(a,b,c,f){I.prototype.initFromNode.call(this,a,b,c,f);p.prototype.initFromNode.call(this,a,b,c,f);u.prototype.initFromNode.call(this,a,b,c,f);A.prototype.initFromNode.call(this,a,b,c,f);J.prototype.initFromNode.call(this,
a,b,c,f)};E.prototype.initFromNode=function(a,b,c,f){I.prototype.initFromNode.call(this,a,b,c,f);p.prototype.initFromNode.call(this,a,b,c,f);u.prototype.initFromNode.call(this,a,b,c,f);A.prototype.initFromNode.call(this,a,b,c,f);J.prototype.initFromNode.call(this,a,b,c,f)};r.prototype.initFromNode=function(a,b,c,f,d){I.prototype.initFromNode.call(this,a,b,c,d);p.prototype.initFromNode.call(this,a,b,c,d);u.prototype.initFromNode.call(this,a,b,c,d);A.prototype.initFromNode.call(this,a,b,c,d);J.prototype.initFromNode.call(this,
a,b,c,d);this.space=f};z.prototype.initFromText=function(a,b,c,f,d){p.prototype.initFromNode.call(this,a,b,null,d);this.text=c;this.space=f};P.prototype.initFromNode=function(a,b,c,f){A.prototype.initFromNode.call(this,a,b,c,f);p.prototype.initFromNode.call(this,a,b,c,f)};K.prototype.createDefaultRegion=function(a,b){var c=new K;c.id="";I.prototype.initFromNode.call(c,a,null,{name:"region",attributes:{"tts:displayAlign":{name:"tts:displayAlign",value:"after",prefix:"tts",local:"displayAlign",uri:"http://www.w3.org/ns/ttml#styling"},
...
itts:"http://www.w3.org/ns/ttml/profile/imsc1#styling",ttm:"http://www.w3.org/ns/ttml#metadata",ttp:"http://www.w3.org/ns/ttml#parameter",tts:"http://www.w3.org/ns/ttml#styling",xml:"http://www.w3.org/XML/1998/namespace"},prefix:"",local:"region",uri:"http://www.w3.org/ns/ttml",isSelfClosing:!0},b);c.sets=[];p.call(c,0,Number.POSITIVE_INFINITY,null);return c};K.prototype.initFromNode=function(a,b,c){n.prototype.initFromNode.call(this,a,null,b,c);I.prototype.initFromNode.call(this,a,null,b,c);p.prototype.initFromNode.call(this,
...
function d(a){this.contents=[];this.aspectRatio=a.aspectRatio}function D(a){this.kind=a.kind||"region";a.id&&(this.id=a.id);this.styleAttrs={};for(var b in a.styleAttrs)this.styleAttrs[b]=a.styleAttrs[b];"src"in a&&(this.src=a.src);"type"in a&&(this.type=a.type);if("text"in a)this.text=a.text;else if("region"===this.kind||"contents"in a)this.contents=[];"space"in a&&(this.space=a.space)}g.generateISD=function(a,b,e){function c(a,b){function d(b){return!(a<b.begin||a>=b.end)}if(b.contents){var e={},
f;for(f in b)e[f]=b[f];e.contents=[];b.contents.filter(d).forEach(function(b){b=c(a,b);null!==b&&e.contents.push(b)});return e}return b}var f=new d(a),g={},h={};h=c(b,a.body);for(var k in a.head.layout.regions){var D=x(a,b,a.head.layout.regions[k],h,null,"",a.head.layout.regions[k],e,g);null!==D&&f.contents.push(D.element)}return f};var e=[k.byName.color.qname,k.byName.textCombine.qname,k.byName.textDecoration.qname,k.byName.textEmphasis.qname,k.byName.textOutline.qname,k.byName.textShadow.qname]})("undefined"===
typeof h?this.imscISD={}:h,"undefined"===typeof imscNames?g("./names"):imscNames,"undefined"===typeof imscStyles?g("./styles"):imscStyles,"undefined"===typeof imscUtils?g("./utils"):imscUtils)},{"./names":5,"./styles":6,"./utils":7}],4:[function(g,r,h){h.generateISD=g("./isd").generateISD;h.fromXML=g("./doc").fromXML;h.renderHTML=g("./html").render},{"./doc":1,"./html":2,"./isd":3}],5:[function(g,r,h){g="undefined"===typeof h?this.imscNames={}:h;g.ns_tt="http://www.w3.org/ns/ttml";g.ns_tts="http://www.w3.org/ns/ttml#styling";
