...
b[d])}function L(b,a){if(b&&b.warn&&b.warn(a))throw a;}function K(b,a){if(b&&b.error&&b.error(a))throw a;}function F(b,a){b&&b.fatal&&b.fatal(a);throw a;}function Z(b,a){for(var d=0,c=b.length-1,e;d<=c;){e=Math.floor((d+c)/2);var l=b[e];if(l<a)d=e+1;else if(l>a)c=e-1;else return{found:!0,index:e}}return{found:!1,index:d}}f.fromXML=function(f,w,D){var r=g.parser(!0,{xmlns:!0}),p=[],x=[],A=[],n=0,m=null;r.onclosetag=function(b){if(p[0]instanceof d)for(var a in p[0].styles)X(p[0],p[0].styles[a],w);else if(p[0]instanceof
P||p[0]instanceof G){if(1<p[0].contents.length){b=[p[0].contents[0]];for(a=1;a<p[0].contents.length;a++)p[0].contents[a]instanceof C&&b[b.length-1]instanceof C?b[b.length-1].text+=p[0].contents[a].text:b.push(p[0].contents[a]);p[0].contents=b}p[0]instanceof G&&1===p[0].contents.length&&p[0].contents[0]instanceof C&&(p[0].text=p[0].contents[0].text,delete p[0].contents)}else if(p[0]instanceof E)if(p[0].node.uri===e.ns_tt&&"metadata"===p[0].node.local)n--;else if(0<n&&D&&"onCloseTag"in D)D.onCloseTag();
A.shift();x.shift();p.shift()};r.ontext=function(b){if(void 0!==p[0])if(p[0]instanceof G||p[0]instanceof P){if(p[0]instanceof G){var a=p[0].styleAttrs[k.byName.ruby.qname];if("container"===a||"textContainer"===a||"baseContainer"===a)return}a=new C;a.initFromText(m,p[0],b,A[0],w);p[0].contents.push(a)}else if(p[0]instanceof E&&0<n&&D&&"onText"in D)D.onText(b)};r.onopentag=function(a){function c(b){e.ttaf_map[b.uri]&&(b.uri=e.ttaf_map[b.uri])}var f=a.attributes["xml:space"];f?A.unshift(f.value):0===
A.length?A.unshift("default"):A.unshift(A[0]);(f=a.attributes["xml:lang"])?x.unshift(f.value):0===x.length?x.unshift(""):x.unshift(x[0]);c(a);if(a.attributes)for(var g in a.attributes)a.attributes.hasOwnProperty(g)&&c(a.attributes[g]);if(a.uri===e.ns_tt)if("tt"===a.local)null!==m&&F(w,"Two <tt> elements at ("+this.line+","+this.column+")"),m=new h,m.initFromNode(a,w),p.unshift(m);else if("head"===a.local)p[0]instanceof h||F(w,"Parent of <head> element is not <tt> at ("+this.line+","+this.column+")"),
p.unshift(m.head);else if("styling"===a.local)p[0]instanceof b||F(w,"Parent of <styling> element is not <head> at ("+this.line+","+this.column+")"),p.unshift(m.head.styling);else if("style"===a.local)if(p[0]instanceof d){var r=new l;r.initFromNode(a,w);r.id?m.head.styling.styles[r.id]=r:K(w,"<style> element missing @id attribute");p.unshift(r)}else p[0]instanceof J?(r=new l,r.initFromNode(a,w),V(r.styleAttrs,p[0].styleAttrs),p.unshift(r)):F(w,"Parent of <style> element is not <styling> or <region> at ("+
this.line+","+this.column+")");else if("initial"===a.local)if(p[0]instanceof d){g=new z;g.initFromNode(a,w);for(r in g.styleAttrs)m.head.styling.initials[r]=g.styleAttrs[r];p.unshift(g)}else F(w,"Parent of <initial> element is not <styling> at ("+this.line+","+this.column+")");else if("layout"===a.local)p[0]instanceof b||F(w,"Parent of <layout> element is not <head> at "+this.line+","+this.column+")"),p.unshift(m.head.layout);else if("region"===a.local)p[0]instanceof Q||F(w,"Parent of <region> element is not <layout> at "+
this.line+","+this.column+")"),r=new J,r.initFromNode(m,a,w),!r.id||r.id in m.head.layout.regions?K(w,"Ignoring <region> with duplicate or missing @id at "+this.line+","+this.column+")"):m.head.layout.regions[r.id]=r,p.unshift(r);else if("body"===a.local)p[0]instanceof h||F(w,"Parent of <body> element is not <tt> at "+this.line+","+this.column+")"),null!==m.body&&F(w,"Second <body> element at "+this.line+","+this.column+")"),r=new v,r.initFromNode(m,a,w),m.body=r,p.unshift(r);else if("div"===a.local){p[0]instanceof
B||p[0]instanceof v||F(w,"Parent of <div> element is not <body> or <div> at "+this.line+","+this.column+")");r=new B;r.initFromNode(m,p[0],a,w);if(g=r.styleAttrs[k.byName.backgroundImage.qname])r.contents.push(new R(g)),delete r.styleAttrs[k.byName.backgroundImage.qname];p[0].contents.push(r);p.unshift(r)}else"image"===a.local?(p[0]instanceof B||F(w,"Parent of <image> element is not <div> at "+this.line+","+this.column+")"),r=new R,r.initFromNode(m,p[0],a,w),p[0].contents.push(r),p.unshift(r)):"p"===
a.local?(p[0]instanceof B||F(w,"Parent of <p> element is not <div> at "+this.line+","+this.column+")"),r=new P,r.initFromNode(m,p[0],a,w),p[0].contents.push(r),p.unshift(r)):"span"===a.local?(p[0]instanceof G||p[0]instanceof P||F(w,"Parent of <span> element is not <span> or <p> at "+this.line+","+this.column+")"),r=new G,r.initFromNode(m,p[0],a,A[0],w),p[0].contents.push(r),p.unshift(r)):"br"===a.local?(p[0]instanceof G||p[0]instanceof P||F(w,"Parent of <br> element is not <span> or <p> at "+this.line+
","+this.column+")"),r=new M,r.initFromNode(m,p[0],a,w),p[0].contents.push(r),p.unshift(r)):"set"===a.local?(p[0]instanceof G||p[0]instanceof P||p[0]instanceof B||p[0]instanceof v||p[0]instanceof J||p[0]instanceof M||F(w,"Parent of <set> element is not a content element or a region at "+this.line+","+this.column+")"),r=new W,r.initFromNode(m,p[0],a,w),p[0].sets.push(r),p.unshift(r)):p.unshift(new E(a));else p.unshift(new E(a));if(p[0]instanceof E)if(a.uri===e.ns_tt&&"metadata"===a.local)n++;else if(0<
...
c[c.length-1].rbc.push(d):"span"===d.localName&&d.style.textEmphasisStyle&&"none"!==d.style.textEmphasisStyle&&0<c.length&&c[c.length-1].te.push(d)),d=d.nextSibling}function c(b,a){this.qname=b;this.map=a}f.render=function(b,a,c,e,f,h,g,E,k){e=e||a.clientHeight;f=f||a.clientWidth;if(null!==b.aspectRatio){var d=e*b.aspectRatio;d>f?e=Math.round(f/b.aspectRatio):f=d}d=document.createElement("div");d.style.position="relative";d.style.width=f+"px";d.style.height=e+"px";d.style.margin="auto";d.style.top=
0;d.style.bottom=0;d.style.left=0;d.style.right=0;d.style.zIndex=0;c={h:e,w:f,regionH:null,regionW:null,imgResolver:c,displayForcedOnlyMode:h||!1,isd:b,errorHandler:g,previousISDState:E,enableRollUp:k||!1,currentISDState:{},flg:null,lp:null,mra:null,ipd:null,bpd:null,ruby:null,textEmphasis:null,rubyReserve:null};a.appendChild(d);for(var l in b.contents)t(c,d,b.contents[l]);return c.currentISDState};var E=[new c("http://www.w3.org/ns/ttml#styling backgroundColor",function(b,a,c,e){0!==e[3]&&(a.style.backgroundColor=
...
"horizontal-tb";else if("rltb"===e||"rl"===e)b.writingMode="horizontal-tb";else if("tblr"===e)b.writingMode="vertical-lr";else if("tbrl"===e||"tb"===e)b.writingMode="vertical-rl";a.style.writingMode=b.writingMode}),new c("http://www.w3.org/ns/ttml#styling zIndex",function(b,a,c,e){a.style.zIndex=e}),new c("http://www.w3.org/ns/ttml/profile/imsc1#styling forcedDisplay",function(b,a,c,e){b.displayForcedOnlyMode&&!1===e&&(a.style.visibility="hidden")})],h;for(h in E);})("undefined"===typeof n?this.imscHTML=
{}:n,"undefined"===typeof imscNames?g("./names"):imscNames,"undefined"===typeof imscStyles?g("./styles"):imscStyles,"undefined"===typeof imscUtils?g("./utils"):imscUtils)},{"./names":5,"./styles":6,"./utils":7}],3:[function(g,q,n){(function(f,g,e,k){function t(b,c,f,g,q,H,A,m,I){if(c<A.begin||c>=A.end)return null;H="regionID"in A&&""!==A.regionID?A.regionID:H;if(null!==q&&H!==f.id&&(!("contents"in A)||"contents"in A&&0===A.contents.length||""!==H))return null;var d=new E(A);for(l in A.sets)c<A.sets[l].begin||
...
"image"===d.kind||"contents"in d&&0<d.contents.length||"span"===d.kind&&null!==d.text||"region"===d.kind&&"always"===d.styleAttrs[e.byName.showBackground.qname]?{region_id:H,element:d}:null}function n(b,a){if("contents"in b)for(var c in b.contents)n(b.contents[c],a);else"span"!==b.kind&&"br"!==b.kind||a.push(b)}function a(b){if("br"===b.kind)return!1;if("text"in b)return 0===b.text.length;if("contents"in b){for(var c=b.contents.length;c--;)a(b.contents[c])&&b.contents.splice(c,1);return 0===b.contents.length}}
function c(a){this.contents=[];this.aspectRatio=a.aspectRatio}function E(a){this.kind=a.kind||"region";a.id&&(this.id=a.id);this.styleAttrs={};for(var b in a.styleAttrs)this.styleAttrs[b]=a.styleAttrs[b];"src"in a&&(this.src=a.src);"type"in a&&(this.type=a.type);if("text"in a)this.text=a.text;else if("region"===this.kind||"contents"in a)this.contents=[];"space"in a&&(this.space=a.space)}f.generateISD=function(a,d,e){function b(a,c){function d(b){return!(a<b.begin||a>=b.end)}if(c.contents){var e={},
f;for(f in c)e[f]=c[f];e.contents=[];c.contents.filter(d).forEach(function(c){c=b(a,c);c.regionID&&E.add(c.regionID);null!==c&&e.contents.push(c)});return e}return c}var f=new c(a),h={},g={},E=new Set;g=b(d,a.body);0===E.size&&a.head.layout.regions.hasOwnProperty("")&&E.add("");E.forEach(function(b){b=t(a,d,a.head.layout.regions[b],g,null,"",a.head.layout.regions[b],e,h);null!==b&&f.contents.push(b.element)});return f};var h=[e.byName.color.qname,e.byName.textCombine.qname,e.byName.textDecoration.qname,
e.byName.textEmphasis.qname,e.byName.textOutline.qname,e.byName.textShadow.qname]})("undefined"===typeof n?this.imscISD={}:n,"undefined"===typeof imscNames?g("./names"):imscNames,"undefined"===typeof imscStyles?g("./styles"):imscStyles,"undefined"===typeof imscUtils?g("./utils"):imscUtils)},{"./names":5,"./styles":6,"./utils":7}],4:[function(g,q,n){n.generateISD=g("./isd").generateISD;n.fromXML=g("./doc").fromXML;n.renderHTML=g("./html").render},{"./doc":1,"./html":2,"./isd":3}],5:[function(g,q,n){g=
"undefined"===typeof n?this.imscNames={}:n;g.ns_tt="http://www.w3.org/ns/ttml";g.ns_tts="http://www.w3.org/ns/ttml#styling";g.ns_ttp="http://www.w3.org/ns/ttml#parameter";g.ns_xml="http://www.w3.org/XML/1998/namespace";g.ns_itts="http://www.w3.org/ns/ttml/profile/imsc1#styling";g.ns_ittp="http://www.w3.org/ns/ttml/profile/imsc1#parameter";g.ns_smpte="http://www.smpte-ra.org/schemas/2052-1/2010/smpte-tt";g.ns_ebutts="urn:ebu:tt:style";g.ttaf_map={"http://www.w3.org/2006/10/ttaf1":g.ns_tt,"http://www.w3.org/2006/10/ttaf1#style":g.ns_tts,
"http://www.w3.org/2006/10/ttaf1#parameter":g.ns_ttp}},{}],6:[function(g,q,n){(function(f,g,e){function k(a,c,e,f,b,d,g,k){this.name=c;this.ns=a;this.qname=a+" "+c;this.inherit=b;this.animatable=d;this.initial=e;this.applies=f;this.parse=g;this.compute=k}f.all=[new k(g.ns_tts,"backgroundColor","transparent",["body","div","p","region","span"],!1,!0,e.parseColor,null),new k(g.ns_tts,"color","white",["span"],!0,!0,e.parseColor,null),new k(g.ns_tts,"direction","ltr",["p","span"],!0,!0,function(a){return a},
null),new k(g.ns_tts,"display","auto",["body","div","p","region","span"],!1,!0,function(a){return a},null),new k(g.ns_tts,"displayAlign","before",["region"],!1,!0,function(a){return a},null),new k(g.ns_tts,"extent","auto",["tt","region"],!1,!0,function(a){if("auto"===a)return a;var c=a.split(" ");if(2!==c.length)return null;a=e.parseLength(c[0]);return(c=e.parseLength(c[1]))&&a?{h:c,w:a}:null},function(a,c,f,g,b){if("auto"===g)c=new e.ComputedLength(0,1);else if(c=e.toComputedLength(g.h.value,g.h.unit,
null,a.dimensions.h,null,a.pxLength.h),null===c)return null;if("auto"===g)a=new e.ComputedLength(1,0);else if(a=e.toComputedLength(g.w.value,g.w.unit,null,a.dimensions.w,null,a.pxLength.w),null===a)return null;return{h:c,w:a}}),new k(g.ns_tts,"fontFamily","default",["span"],!0,!0,function(a){a=a.split(",");var c=[],e;for(e in a)"'"!==a[e].charAt(0)&&'"'!==a[e].charAt(0)?"default"===a[e]?c.push("monospaceSerif"):c.push(a[e]):c.push(a[e]);return c},null),new k(g.ns_tts,"shear","0%",["p"],!0,!0,e.parseLength,
function(a,c,e,f){if("%"===f.unit)a=100<Math.abs(f.value)?100*Math.sign(f.value):f.value;else return null;return a}),new k(g.ns_tts,"fontSize","1c",["span"],!0,!0,e.parseLength,function(a,c,g,h,b){return e.toComputedLength(h.value,h.unit,null!==c?c.styleAttrs[f.byName.fontSize.qname]:a.cellLength.h,null!==c?c.styleAttrs[f.byName.fontSize.qname]:a.cellLength.h,a.cellLength.h,a.pxLength.h)}),new k(g.ns_tts,"fontStyle","normal",["span"],!0,!0,function(a){return a},null),new k(g.ns_tts,"fontWeight","normal",
["span"],!0,!0,function(a){return a},null),new k(g.ns_tts,"lineHeight","normal",["p"],!0,!0,function(a){return"normal"===a?a:e.parseLength(a)},function(a,c,g,h,b){if("normal"===h)a=h;else if(a=e.toComputedLength(h.value,h.unit,g.styleAttrs[f.byName.fontSize.qname],g.styleAttrs[f.byName.fontSize.qname],a.cellLength.h,a.pxLength.h),null===a)return null;return a}),new k(g.ns_tts,"opacity",1,["region"],!1,!0,parseFloat,null),new k(g.ns_tts,"origin","auto",["region"],!1,!0,function(a){if("auto"===a)return a;
var c=a.split(" ");if(2!==c.length)return null;a=e.parseLength(c[0]);return(c=e.parseLength(c[1]))&&a?{h:c,w:a}:null},function(a,c,f,g,b){if("auto"===g)c=new e.ComputedLength(0,0);else if(c=e.toComputedLength(g.h.value,g.h.unit,null,a.dimensions.h,null,a.pxLength.h),null===c)return null;if("auto"===g)a=new e.ComputedLength(0,0);else if(a=e.toComputedLength(g.w.value,g.w.unit,null,a.dimensions.w,null,a.pxLength.w),null===a)return null;return{h:c,w:a}}),new k(g.ns_tts,"overflow","hidden",["region"],
!1,!0,function(a){return a},null),new k(g.ns_tts,"padding","0px",["region"],!1,!0,function(a){a=a.split(" ");if(4<a.length)return null;var c=[],f;for(f in a){var g=e.parseLength(a[f]);if(!g)return null;c.push(g)}return c},function(a,c,g,h,b){if(1===h.length)c=[h[0],h[0],h[0],h[0]];else if(2===h.length)c=[h[0],h[1],h[0],h[1]];else if(3===h.length)c=[h[0],h[1],h[2],h[1]];else if(4===h.length)c=[h[0],h[1],h[2],h[3]];else return null;h=g.styleAttrs[f.byName.writingMode.qname];if("lrtb"===h||"lr"===h)c=
[c[0],c[3],c[2],c[1]];else if("rltb"===h||"rl"===h)c=[c[0],c[1],c[2],c[3]];else if("tblr"===h)c=[c[3],c[0],c[1],c[2]];else if("tbrl"===h||"tb"===h)c=[c[3],c[2],c[1],c[0]];else return null;h=[];for(var d in c)if(0===c[d].value)h[d]=new e.ComputedLength(0,0);else if(h[d]=e.toComputedLength(c[d].value,c[d].unit,g.styleAttrs[f.byName.fontSize.qname],"0"===d||"2"===d?g.styleAttrs[f.byName.extent.qname].h:g.styleAttrs[f.byName.extent.qname].w,"0"===d||"2"===d?a.cellLength.h:a.cellLength.w,"0"===d||"2"===
d?a.pxLength.h:a.pxLength.w),null===h[d])return null;return h}),new k(g.ns_tts,"position","top left",["region"],!1,!0,function(a){return e.parsePosition(a)},function(a,c,g,h){c=e.toComputedLength(h.v.offset.value,h.v.offset.unit,null,new e.ComputedLength(-g.styleAttrs[f.byName.extent.qname].h.rw,a.dimensions.h.rh-g.styleAttrs[f.byName.extent.qname].h.rh),null,a.pxLength.h);if(null===c)return null;"bottom"===h.v.edge&&(c=new e.ComputedLength(-c.rw-g.styleAttrs[f.byName.extent.qname].h.rw,a.dimensions.h.rh-
c.rh-g.styleAttrs[f.byName.extent.qname].h.rh));var b=e.toComputedLength(h.h.offset.value,h.h.offset.unit,null,new e.ComputedLength(a.dimensions.w.rw-g.styleAttrs[f.byName.extent.qname].w.rw,-g.styleAttrs[f.byName.extent.qname].w.rh),null,a.pxLength.w);if(null===c)return null;"right"===h.h.edge&&(b=new e.ComputedLength(a.dimensions.w.rw-b.rw-g.styleAttrs[f.byName.extent.qname].w.rw,-b.rh-g.styleAttrs[f.byName.extent.qname].w.rh));return{h:c,w:b}}),new k(g.ns_tts,"ruby","none",["span"],!1,!0,function(a){return a},
null),new k(g.ns_tts,"rubyAlign","center",["span"],!0,!0,function(a){return"center"!==a&&"spaceAround"!==a?null:a},null),new k(g.ns_tts,"rubyPosition","outside",["span"],!0,!0,function(a){return a},null),new k(g.ns_tts,"rubyReserve","none",["p"],!0,!0,function(a){var c=a.split(" ");a=[null,null];if(0===c.length||2<c.length||"none"!==c[0]&&"both"!==c[0]&&"after"!==c[0]&&"before"!==c[0]&&"outside"!==c[0])return null;a[0]=c[0];if(2===c.length&&"none"!==c[0])if(c=e.parseLength(c[1]))a[1]=c;else return null;
return a},function(a,c,g,h,b){if("none"===h[0])return h;a=null===h[1]?new e.ComputedLength(.5*g.styleAttrs[f.byName.fontSize.qname].rw,.5*g.styleAttrs[f.byName.fontSize.qname].rh):e.toComputedLength(h[1].value,h[1].unit,g.styleAttrs[f.byName.fontSize.qname],g.styleAttrs[f.byName.fontSize.qname],a.cellLength.h,a.pxLength.h);return null===a?null:[h[0],a]}),new k(g.ns_tts,"showBackground","whenActive",["region"],!1,!0,function(a){return a},null),new k(g.ns_tts,"textAlign","start",["p"],!0,!0,function(a){return a},
