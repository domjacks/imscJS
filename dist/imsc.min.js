...
c.explicit_dur:null!==c.explicit_end&&null===c.explicit_dur?q+c.explicit_end:b;delete c.explicit_begin;delete c.explicit_dur;delete c.explicit_end;a._registerEvent(c)}function J(a){this.node=a}function e(){this.events=[];this.head=new a;this.body=null}function a(){this.styling=new c;this.layout=new t}function c(){this.styles={};this.initials={}}function f(){this.styleRefs=this.styleAttrs=this.id=null}function q(){this.styleAttrs=null}function t(){this.regions={}}function R(a,c){this.kind="image";
this.src=a;this.type=c}function n(a){this.id=a}function A(a){this.regionID=a}function H(a){this.styleAttrs=a}function u(a){this.sets=a}function I(a){this.contents=a}function p(a,c,b){this.explicit_begin=a;this.explicit_end=c;this.explicit_dur=b}function v(){this.kind="body"}function O(){this.kind="div"}function r(){this.kind="p"}function E(){this.kind="span"}function z(){this.kind="span"}function P(){this.kind="br"}function K(){}function W(){}function y(a){var c=null;a&&(a=a.attributes["xml:id"]||
...
a[b])}function M(a,c){if(a&&a.warn&&a.warn(c))throw c;}function L(a,c){if(a&&a.error&&a.error(c))throw c;}function C(a,c){a&&a.fatal&&a.fatal(c);throw c;}function Z(a,c){for(var b=0,f=a.length-1,d;b<=f;){d=Math.floor((b+f)/2);var q=a[d];if(q<c)b=d+1;else if(q>c)f=d-1;else return{found:!0,index:d}}return{found:!1,index:b}}x.fromXML=function(G,w,D){var u=g.parser(!0,{xmlns:!0}),m=[],n=[],x=[],A=0,h=null;u.onclosetag=function(a){if(m[0]instanceof c)for(var b in m[0].styles)X(m[0],m[0].styles[b],w);else if(m[0]instanceof
r||m[0]instanceof E){if(1<m[0].contents.length){a=[m[0].contents[0]];for(b=1;b<m[0].contents.length;b++)m[0].contents[b]instanceof z&&a[a.length-1]instanceof z?a[a.length-1].text+=m[0].contents[b].text:a.push(m[0].contents[b]);m[0].contents=a}m[0]instanceof E&&1===m[0].contents.length&&m[0].contents[0]instanceof z&&(m[0].text=m[0].contents[0].text,delete m[0].contents)}else if(m[0]instanceof J)if(m[0].node.uri===k.ns_tt&&"metadata"===m[0].node.local)A--;else if(0<A&&D&&"onCloseTag"in D)D.onCloseTag();
x.shift();n.shift();m.shift()};u.ontext=function(a){if(void 0!==m[0])if(m[0]instanceof E||m[0]instanceof r){if(m[0]instanceof E){var c=m[0].styleAttrs[l.byName.ruby.qname];if("container"===c||"textContainer"===c||"baseContainer"===c)return}c=new z;c.initFromText(h,m[0],a,x[0],w);m[0].contents.push(c)}else if(m[0]instanceof J&&0<A&&D&&"onText"in D)D.onText(a)};u.onopentag=function(b){function d(a){k.ttaf_map[a.uri]&&(a.uri=k.ttaf_map[a.uri])}var G=b.attributes["xml:space"];G?x.unshift(G.value):0===
x.length?x.unshift("default"):x.unshift(x[0]);(G=b.attributes["xml:lang"])?n.unshift(G.value):0===n.length?n.unshift(""):n.unshift(n[0]);d(b);if(b.attributes)for(var u in b.attributes)b.attributes.hasOwnProperty(u)&&d(b.attributes[u]);if(b.uri===k.ns_tt)if("tt"===b.local)null!==h&&C(w,"Two <tt> elements at ("+this.line+","+this.column+")"),h=new e,h.initFromNode(b,w),m.unshift(h);else if("head"===b.local)m[0]instanceof e||C(w,"Parent of <head> element is not <tt> at ("+this.line+","+this.column+")"),
...
b.local?(m[0]instanceof O||C(w,"Parent of <p> element is not <div> at "+this.line+","+this.column+")"),g=new r,g.initFromNode(h,m[0],b,w),m[0].contents.push(g),m.unshift(g)):"span"===b.local?(m[0]instanceof E||m[0]instanceof r||C(w,"Parent of <span> element is not <span> or <p> at "+this.line+","+this.column+")"),g=new E,g.initFromNode(h,m[0],b,x[0],w),m[0].contents.push(g),m.unshift(g)):"br"===b.local?(m[0]instanceof E||m[0]instanceof r||C(w,"Parent of <br> element is not <span> or <p> at "+this.line+
","+this.column+")"),g=new P,g.initFromNode(h,m[0],b,w),m[0].contents.push(g),m.unshift(g)):"set"===b.local?(m[0]instanceof E||m[0]instanceof r||m[0]instanceof O||m[0]instanceof v||m[0]instanceof K||m[0]instanceof P||C(w,"Parent of <set> element is not a content element or a region at "+this.line+","+this.column+")"),g=new W,g.initFromNode(h,m[0],b,w),m[0].sets.push(g),m.unshift(g)):m.unshift(new J(b));else m.unshift(new J(b));if(m[0]instanceof J)if(b.uri===k.ns_tt&&"metadata"===b.local)A++;else if(0<
A&&D&&"onOpenTag"in D){g=[];for(var Q in b.attributes)g[b.attributes[Q].uri+" "+b.attributes[Q].local]={uri:b.attributes[Q].uri,local:b.attributes[Q].local,value:b.attributes[Q].value};D.onOpenTag(b.uri,b.local,g)}};u.write(G).close();delete h.head.styling.styles;G=!1;for(var p in h.head.layout.regions){G=!0;break}G||(p=K.prototype.createDefaultRegion(h,w),h.head.layout.regions[p.id]=p);for(var H in h.head.layout.regions)d(h,h.head.layout.regions[H],null,null);h.body&&d(h,h.body,null,null);h.body&&
...
b.attributes?b.attributes.type.value:null)||L(f,"Invalid image@type attribute");H.prototype.initFromNode.call(this,a,c,b,f);p.prototype.initFromNode.call(this,a,c,b,f);u.prototype.initFromNode.call(this,a,c,b,f);A.prototype.initFromNode.call(this,a,c,b,f)};n.prototype.initFromNode=function(a,c,b,f){this.id=y(b)};A.prototype.initFromNode=function(a,c,b,f){this.regionID=b&&"region"in b.attributes?b.attributes.region.value:""};H.prototype.initFromNode=function(a,b,c,f){this.styleAttrs=T(c,f);null!==
a.head&&null!==a.head.styling&&Y(a.head.styling,S(c),this.styleAttrs,f)};u.prototype.initFromNode=function(a,c,b,f){this.sets=[]};I.prototype.initFromNode=function(a,c,b,f){this.contents=[]};p.prototype.initFromNode=function(a,c,b,f){c=null;b&&"begin"in b.attributes&&(c=U(a.tickRate,a.effectiveFrameRate,b.attributes.begin.value),null===c&&M(f,"Malformed begin value "+b.attributes.begin.value+" (using 0)"));var d=null;b&&"dur"in b.attributes&&(d=U(a.tickRate,a.effectiveFrameRate,b.attributes.dur.value),
null===d&&M(f,"Malformed dur value "+b.attributes.dur.value+" (ignoring)"));var q=null;b&&"end"in b.attributes&&(q=U(a.tickRate,a.effectiveFrameRate,b.attributes.end.value),null===q&&M(f,"Malformed end value (ignoring)"));this.explicit_begin=c;this.explicit_end=q;this.explicit_dur=d;(a=b&&"timeContainer"in b.attributes?b.attributes.timeContainer.value:null)&&"par"!==a?"seq"===a?f="seq":(L(f,"Illegal value of timeContainer (assuming 'par')"),f="par"):f="par";this.timeContainer=f};v.prototype.initFromNode=
function(a,b,c){H.prototype.initFromNode.call(this,a,null,b,c);p.prototype.initFromNode.call(this,a,null,b,c);u.prototype.initFromNode.call(this,a,null,b,c);A.prototype.initFromNode.call(this,a,null,b,c);I.prototype.initFromNode.call(this,a,null,b,c)};O.prototype.initFromNode=function(a,b,c,f){H.prototype.initFromNode.call(this,a,b,c,f);p.prototype.initFromNode.call(this,a,b,c,f);u.prototype.initFromNode.call(this,a,b,c,f);A.prototype.initFromNode.call(this,a,b,c,f);I.prototype.initFromNode.call(this,
a,b,c,f)};r.prototype.initFromNode=function(a,b,c,f){H.prototype.initFromNode.call(this,a,b,c,f);p.prototype.initFromNode.call(this,a,b,c,f);u.prototype.initFromNode.call(this,a,b,c,f);A.prototype.initFromNode.call(this,a,b,c,f);I.prototype.initFromNode.call(this,a,b,c,f)};E.prototype.initFromNode=function(a,b,c,f,d){H.prototype.initFromNode.call(this,a,b,c,d);p.prototype.initFromNode.call(this,a,b,c,d);u.prototype.initFromNode.call(this,a,b,c,d);A.prototype.initFromNode.call(this,a,b,c,d);I.prototype.initFromNode.call(this,
a,b,c,d);this.space=f};z.prototype.initFromText=function(a,b,c,f,d){p.prototype.initFromNode.call(this,a,b,null,d);this.text=c;this.space=f};P.prototype.initFromNode=function(a,b,c,f){A.prototype.initFromNode.call(this,a,b,c,f);p.prototype.initFromNode.call(this,a,b,c,f)};K.prototype.createDefaultRegion=function(a,b){var c=new K;c.id="";H.prototype.initFromNode.call(c,a,null,{name:"region",attributes:{"tts:displayAlign":{name:"tts:displayAlign",value:"after",prefix:"tts",local:"displayAlign",uri:"http://www.w3.org/ns/ttml#styling"},
...
v.rw,.5*v.rh));for(var z in k.all)(t=k.all[z],t.qname in f.styleAttrs||t.qname===k.byName.position.qname&&k.byName.origin.qname in f.styleAttrs||t.qname===k.byName.origin.qname&&k.byName.position.qname in f.styleAttrs||(p=a.head.styling.initials[t.qname]||t.initial,"region"!==f.kind&&(!1!==t.inherit||null===p)))||(f.styleAttrs[t.qname]=t.parse(p),q[t.qname]=!0);for(var P in k.all)if(z=k.all[P],z.qname in q&&null!==z.compute)if(t=z.compute(a,h,f,f.styleAttrs[z.qname],H),null!==t)f.styleAttrs[z.qname]=
t;else if(f.styleAttrs[z.qname]=z.compute(a,h,f,z.parse(z.initial),H),z="Style '"+z.qname+"' on element '"+f.kind+"' cannot be computed",A&&A.error&&A.error(z))throw z;if("none"===f.styleAttrs[k.byName.display.qname])return null;if(null===h)var K=null===g?[]:[g];else"contents"in n&&(K=n.contents);for(var R in K)h=x(a,c,d,g,f,r,K[R],A,H),null!==h&&f.contents.push(h.element);for(var y in f.styleAttrs)a=!1,"span"===f.kind&&(c=f.styleAttrs[k.byName.ruby.qname],(a=("container"===c||"textContainer"===c||
...
function d(a){this.contents=[];this.aspectRatio=a.aspectRatio}function J(a){this.kind=a.kind||"region";a.id&&(this.id=a.id);this.styleAttrs={};for(var b in a.styleAttrs)this.styleAttrs[b]=a.styleAttrs[b];"src"in a&&(this.src=a.src);"type"in a&&(this.type=a.type);if("text"in a)this.text=a.text;else if("region"===this.kind||"contents"in a)this.contents=[];"space"in a&&(this.space=a.space)}g.generateISD=function(a,b,e){var c=new d(a),f={},g;for(g in a.head.layout.regions){var h=x(a,b,a.head.layout.regions[g],
...
4:[function(g,r,h){h.generateISD=g("./isd").generateISD;h.fromXML=g("./doc").fromXML;h.renderHTML=g("./html").render},{"./doc":1,"./html":2,"./isd":3}],5:[function(g,r,h){g="undefined"===typeof h?this.imscNames={}:h;g.ns_tt="http://www.w3.org/ns/ttml";g.ns_tts="http://www.w3.org/ns/ttml#styling";g.ns_ttp="http://www.w3.org/ns/ttml#parameter";g.ns_xml="http://www.w3.org/XML/1998/namespace";g.ns_itts="http://www.w3.org/ns/ttml/profile/imsc1#styling";g.ns_ittp="http://www.w3.org/ns/ttml/profile/imsc1#parameter";
g.ns_smpte="http://www.smpte-ra.org/schemas/2052-1/2010/smpte-tt";g.ns_ebutts="urn:ebu:tt:style";g.ttaf_map={"http://www.w3.org/2006/10/ttaf1":g.ns_tt,"http://www.w3.org/2006/10/ttaf1#style":g.ns_tts,"http://www.w3.org/2006/10/ttaf1#parameter":g.ns_ttp}},{}],6:[function(g,r,h){(function(g,h,k){function l(b,d,g,e,a,c,f,h){this.name=d;this.ns=b;this.qname=b+" "+d;this.inherit=a;this.animatable=c;this.initial=g;this.applies=e;this.parse=f;this.compute=h}g.all=[new l(h.ns_tts,"backgroundColor","transparent",
["body","div","p","region","span"],!1,!0,k.parseColor,null),new l(h.ns_tts,"color","white",["span"],!0,!0,k.parseColor,null),new l(h.ns_tts,"direction","ltr",["p","span"],!0,!0,function(b){return b},null),new l(h.ns_tts,"display","auto",["body","div","p","region","span"],!1,!0,function(b){return b},null),new l(h.ns_tts,"displayAlign","before",["region"],!1,!0,function(b){return b},null),new l(h.ns_tts,"extent","auto",["tt","region"],!1,!0,function(b){if("auto"===b)return b;var d=b.split(" ");if(2!==
d.length)return null;b=k.parseLength(d[0]);return(d=k.parseLength(d[1]))&&b?{h:d,w:b}:null},function(b,d,g,e,a){if("auto"===e)d=new k.ComputedLength(0,1);else if(d=k.toComputedLength(e.h.value,e.h.unit,null,b.dimensions.h,null,b.pxLength.h),null===d)return null;if("auto"===e)b=new k.ComputedLength(1,0);else if(b=k.toComputedLength(e.w.value,e.w.unit,null,b.dimensions.w,null,b.pxLength.w),null===b)return null;return{h:d,w:b}}),new l(h.ns_tts,"fontFamily","default",["span"],!0,!0,function(b){b=b.split(",");
var d=[],g;for(g in b)"'"!==b[g].charAt(0)&&'"'!==b[g].charAt(0)?"default"===b[g]?d.push("monospaceSerif"):d.push(b[g]):d.push(b[g]);return d},null),new l(h.ns_tts,"shear","0%",["p"],!0,!0,k.parseLength,function(b,d,g,e){if("%"===e.unit)b=100<Math.abs(e.value)?100*Math.sign(e.value):e.value;else return null;return b}),new l(h.ns_tts,"fontSize","1c",["span"],!0,!0,k.parseLength,function(b,d,h,e,a){return k.toComputedLength(e.value,e.unit,null!==d?d.styleAttrs[g.byName.fontSize.qname]:b.cellLength.h,
null!==d?d.styleAttrs[g.byName.fontSize.qname]:b.cellLength.h,b.cellLength.h,b.pxLength.h)}),new l(h.ns_tts,"fontStyle","normal",["span"],!0,!0,function(b){return b},null),new l(h.ns_tts,"fontWeight","normal",["span"],!0,!0,function(b){return b},null),new l(h.ns_tts,"lineHeight","normal",["p"],!0,!0,function(b){return"normal"===b?b:k.parseLength(b)},function(b,d,h,e,a){if("normal"===e)b=e;else if(b=k.toComputedLength(e.value,e.unit,h.styleAttrs[g.byName.fontSize.qname],h.styleAttrs[g.byName.fontSize.qname],
b.cellLength.h,b.pxLength.h),null===b)return null;return b}),new l(h.ns_tts,"opacity",1,["region"],!1,!0,parseFloat,null),new l(h.ns_tts,"origin","auto",["region"],!1,!0,function(b){if("auto"===b)return b;var d=b.split(" ");if(2!==d.length)return null;b=k.parseLength(d[0]);return(d=k.parseLength(d[1]))&&b?{h:d,w:b}:null},function(b,d,g,e,a){if("auto"===e)d=new k.ComputedLength(0,0);else if(d=k.toComputedLength(e.h.value,e.h.unit,null,b.dimensions.h,null,b.pxLength.h),null===d)return null;if("auto"===
e)b=new k.ComputedLength(0,0);else if(b=k.toComputedLength(e.w.value,e.w.unit,null,b.dimensions.w,null,b.pxLength.w),null===b)return null;return{h:d,w:b}}),new l(h.ns_tts,"overflow","hidden",["region"],!1,!0,function(b){return b},null),new l(h.ns_tts,"padding","0px",["region"],!1,!0,function(b){b=b.split(" ");if(4<b.length)return null;var d=[],g;for(g in b){var e=k.parseLength(b[g]);if(!e)return null;d.push(e)}return d},function(b,d,h,e,a){if(1===e.length)d=[e[0],e[0],e[0],e[0]];else if(2===e.length)d=
[e[0],e[1],e[0],e[1]];else if(3===e.length)d=[e[0],e[1],e[2],e[1]];else if(4===e.length)d=[e[0],e[1],e[2],e[3]];else return null;e=h.styleAttrs[g.byName.writingMode.qname];if("lrtb"===e||"lr"===e)d=[d[0],d[3],d[2],d[1]];else if("rltb"===e||"rl"===e)d=[d[0],d[1],d[2],d[3]];else if("tblr"===e)d=[d[3],d[0],d[1],d[2]];else if("tbrl"===e||"tb"===e)d=[d[3],d[2],d[1],d[0]];else return null;e=[];for(var c in d)if(0===d[c].value)e[c]=new k.ComputedLength(0,0);else if(e[c]=k.toComputedLength(d[c].value,d[c].unit,
h.styleAttrs[g.byName.fontSize.qname],"0"===c||"2"===c?h.styleAttrs[g.byName.extent.qname].h:h.styleAttrs[g.byName.extent.qname].w,"0"===c||"2"===c?b.cellLength.h:b.cellLength.w,"0"===c||"2"===c?b.pxLength.h:b.pxLength.w),null===e[c])return null;return e}),new l(h.ns_tts,"position","top left",["region"],!1,!0,function(b){return k.parsePosition(b)},function(b,d,h,e){d=k.toComputedLength(e.v.offset.value,e.v.offset.unit,null,new k.ComputedLength(-h.styleAttrs[g.byName.extent.qname].h.rw,b.dimensions.h.rh-
h.styleAttrs[g.byName.extent.qname].h.rh),null,b.pxLength.h);if(null===d)return null;"bottom"===e.v.edge&&(d=new k.ComputedLength(-d.rw-h.styleAttrs[g.byName.extent.qname].h.rw,b.dimensions.h.rh-d.rh-h.styleAttrs[g.byName.extent.qname].h.rh));var a=k.toComputedLength(e.h.offset.value,e.h.offset.unit,null,new k.ComputedLength(b.dimensions.w.rw-h.styleAttrs[g.byName.extent.qname].w.rw,-h.styleAttrs[g.byName.extent.qname].w.rh),null,b.pxLength.w);if(null===d)return null;"right"===e.h.edge&&(a=new k.ComputedLength(b.dimensions.w.rw-
a.rw-h.styleAttrs[g.byName.extent.qname].w.rw,-a.rh-h.styleAttrs[g.byName.extent.qname].w.rh));return{h:d,w:a}}),new l(h.ns_tts,"ruby","none",["span"],!1,!0,function(b){return b},null),new l(h.ns_tts,"rubyAlign","center",["span"],!0,!0,function(b){return"center"!==b&&"spaceAround"!==b?null:b},null),new l(h.ns_tts,"rubyPosition","outside",["span"],!0,!0,function(b){return b},null),new l(h.ns_tts,"rubyReserve","none",["p"],!0,!0,function(b){var d=b.split(" ");b=[null,null];if(0===d.length||2<d.length||
"none"!==d[0]&&"both"!==d[0]&&"after"!==d[0]&&"before"!==d[0]&&"outside"!==d[0])return null;b[0]=d[0];if(2===d.length&&"none"!==d[0])if(d=k.parseLength(d[1]))b[1]=d;else return null;return b},function(b,d,h,e,a){if("none"===e[0])return e;b=null===e[1]?new k.ComputedLength(.5*h.styleAttrs[g.byName.fontSize.qname].rw,.5*h.styleAttrs[g.byName.fontSize.qname].rh):k.toComputedLength(e[1].value,e[1].unit,h.styleAttrs[g.byName.fontSize.qname],h.styleAttrs[g.byName.fontSize.qname],b.cellLength.h,b.pxLength.h);
return null===b?null:[e[0],b]}),new l(h.ns_tts,"showBackground","whenActive",["region"],!1,!0,function(b){return b},null),new l(h.ns_tts,"textAlign","start",["p"],!0,!0,function(b){return b},function(b,d,g,e,a){return"left"===e?"start":"right"===e?"end":e}),new l(h.ns_tts,"textCombine","none",["span"],!0,!0,function(b){b=b.split(" ");return 1!==b.length||"none"!==b[0]&&"all"!==b[0]?null:[b[0]]},null),new l(h.ns_tts,"textDecoration","none",["span"],!0,!0,function(b){return b.split(" ")},null),new l(h.ns_tts,
...
d.style="auto":(d.symbol=d.symbol||"circle",d.style=d.style||"filled");d.position=d.position||"outside";d.color=d.color||"current";return d},null),new l(h.ns_tts,"textOutline","none",["span"],!0,!0,function(b){if("none"===b)return b;var d={};b=b.split(" ");if(0===b.length||2<b.length)return null;var g=k.parseColor(b[0]);d.color=g;null!==g&&b.shift();if(1!==b.length)return null;b=k.parseLength(b[0]);if(!b)return null;d.thickness=b;return d},function(b,d,h,e,a){if("none"===e)return e;d={};d.color=null===
e.color?h.styleAttrs[g.byName.color.qname]:e.color;d.thickness=k.toComputedLength(e.thickness.value,e.thickness.unit,h.styleAttrs[g.byName.fontSize.qname],h.styleAttrs[g.byName.fontSize.qname],b.cellLength.h,b.pxLength.h);return null===d.thickness?null:d}),new l(h.ns_tts,"textShadow","none",["span"],!0,!0,k.parseTextShadow,function(b,d,h,e){if("none"===e)return e;d=[];for(var a in e){var c={};c.x_off=k.toComputedLength(e[a][0].value,e[a][0].unit,null,h.styleAttrs[g.byName.fontSize.qname],null,b.pxLength.w);
if(null===c.x_off)return null;c.y_off=k.toComputedLength(e[a][1].value,e[a][1].unit,null,h.styleAttrs[g.byName.fontSize.qname],null,b.pxLength.h);if(null===c.y_off)return null;if(null===e[a][2])c.b_radius=0;else if(c.b_radius=k.toComputedLength(e[a][2].value,e[a][2].unit,null,h.styleAttrs[g.byName.fontSize.qname],null,b.pxLength.h),null===c.b_radius)return null;c.color=null===e[a][3]?h.styleAttrs[g.byName.color.qname]:e[a][3];d.push(c)}return d}),new l(h.ns_tts,"unicodeBidi","normal",["span","p"],
!1,!0,function(b){return b},null),new l(h.ns_tts,"visibility","visible",["body","div","p","region","span"],!0,!0,function(b){return b},null),new l(h.ns_tts,"wrapOption","wrap",["span"],!0,!0,function(b){return b},null),new l(h.ns_tts,"writingMode","lrtb",["region"],!1,!0,function(b){return b},null),new l(h.ns_tts,"zIndex","auto",["region"],!1,!0,function(b){"auto"!==b&&(b=parseInt(b),isNaN(b)&&(b=null));return b},null),new l(h.ns_ebutts,"linePadding","0c",["p"],!0,!1,k.parseLength,function(b,d,g,
e,a){return k.toComputedLength(e.value,e.unit,null,null,b.cellLength.w,null)}),new l(h.ns_ebutts,"multiRowAlign","auto",["p"],!0,!1,function(b){return b},null),new l(h.ns_smpte,"backgroundImage",null,["div"],!1,!1,function(b){return b},null),new l(h.ns_itts,"forcedDisplay","false",["body","div","p","region","span"],!0,!0,function(b){return"true"===b?!0:!1},null),new l(h.ns_itts,"fillLineGap","true",["p"],!0,!0,function(b){return"true"===b?!0:!1},null)];g.byQName={};for(var x in g.all)g.byQName[g.all[x].qname]=
g.all[x];g.byName={};for(var r in g.all)g.byName[g.all[r].name]=g.all[r]})("undefined"===typeof h?this.imscStyles={}:h,"undefined"===typeof imscNames?g("./names"):imscNames,"undefined"===typeof imscUtils?g("./utils"):imscUtils)},{"./names":5,"./utils":7}],7:[function(g,r,h){(function(g){var h=/#([0-9a-fA-F]{2})([0-9a-fA-F]{2})([0-9a-fA-F]{2})([0-9a-fA-F]{2})?/,k=/rgb\(\s*(\d+)\s*,\s*(\d+)\s*,\s*(\d+)\s*\)/,l=/rgba\(\s*(\d+),\s*(\d+)\s*,\s*(\d+)\s*,\s*(\d+)\s*\)/,r={transparent:[0,0,0,0],black:[0,
0,0,255],silver:[192,192,192,255],gray:[128,128,128,255],white:[255,255,255,255],maroon:[128,0,0,255],red:[255,0,0,255],purple:[128,0,128,255],fuchsia:[255,0,255,255],magenta:[255,0,255,255],green:[0,128,0,255],lime:[0,255,0,255],olive:[128,128,0,255],yellow:[255,255,0,255],navy:[0,0,128,255],blue:[0,0,255,255],teal:[0,128,128,255],aqua:[0,255,255,255],cyan:[0,255,255,255]};g.parseColor=function(b){var d,g=null,e=r[b.toLowerCase()];void 0!==e?g=e:null!==(d=h.exec(b))?g=[parseInt(d[1],16),parseInt(d[2],
16),parseInt(d[3],16),void 0!==d[4]?parseInt(d[4],16):255]:null!==(d=k.exec(b))?g=[parseInt(d[1]),parseInt(d[2]),parseInt(d[3]),255]:null!==(d=l.exec(b))&&(g=[parseInt(d[1]),parseInt(d[2]),parseInt(d[3]),parseInt(d[4])]);return g};var x=/^((?:\+|\-)?\d*(?:\.\d+)?)(px|em|c|%|rh|rw)$/;g.parseLength=function(b){var d,g=null;null!==(d=x.exec(b))&&(g={value:parseFloat(d[1]),unit:d[2]});return g};g.parseTextShadow=function(b){b=b.split(",");var d=[],h;for(h in b){var e=b[h].split(" ");if(1===e.length&&
"none"===e[0])return"none";if(1<e.length&&5>e.length){var a=[null,null,null,null],c=g.parseLength(e.shift());if(null===c)return null;a[0]=c;c=g.parseLength(e.shift());if(null===c)return null;a[1]=c;if(0!==e.length&&(c=g.parseLength(e[0]),null!==c&&(a[2]=c,e.shift()),0!==e.length)){e=g.parseColor(e[0]);if(null===e)return null;a[3]=e}d.push(a)}}return d};g.parsePosition=function(b){b=b.split(" ");var d=function(a){return"center"===a||"left"===a||"top"===a||"bottom"===a||"right"===a};if(4<b.length)return null;
for(var h in b)if(!d(b[h])){var e=g.parseLength(b[h]);if(null===e)return null;b[h]=e}h={h:{edge:"left",offset:{value:50,unit:"%"}},v:{edge:"top",offset:{value:50,unit:"%"}}};for(e=0;e<b.length;){var a=b[e++];if(d(a)){var c={value:0,unit:"%"};2!==b.length&&e<b.length&&!d(b[e])&&(c=b[e++]);"right"===a?(h.h.edge=a,h.h.offset=c):"bottom"===a?(h.v.edge=a,h.v.offset=c):"left"===a?h.h.offset=c:"top"===a&&(h.v.offset=c)}else if(1===b.length||2===b.length)1===e?h.h.offset=a:h.v.offset=a;else return null}return h};
g.ComputedLength=function(b,d){this.rw=b;this.rh=d};g.ComputedLength.prototype.toUsedLength=function(b,d){return b*this.rw+d*this.rh};g.ComputedLength.prototype.isZero=function(){return 0===this.rw&&0===this.rh};g.toComputedLength=function(b,d,h,e,a,c){return"%"===d&&e?new g.ComputedLength(e.rw*b/100,e.rh*b/100):"em"===d&&h?new g.ComputedLength(h.rw*b,h.rh*b):"c"===d&&a?new g.ComputedLength(b*a.rw,b*a.rh):"px"===d&&c?new g.ComputedLength(b*c.rw,b*c.rh):"rh"===d?new g.ComputedLength(0,b/100):"rw"===
d?new g.ComputedLength(b/100,0):null}})("undefined"===typeof h?this.imscUtils={}:h)},{}]},{},[4])(4)});
