...
(function(g){"object"===typeof exports&&"undefined"!==typeof module?module.exports=g():"function"===typeof define&&define.amd?define([],g):("undefined"!==typeof window?window:"undefined"!==typeof global?global:"undefined"!==typeof self?self:this).imsc=g()})(function(){return function(){function g(q,n,f){function t(k,I){if(!n[k]){if(!q[k]){var a="function"==typeof require&&require;if(!I&&a)return a(k,!0);if(e)return e(k,!0);I=Error("Cannot find module '"+k+"'");throw I.code="MODULE_NOT_FOUND",I;}I=
n[k]={exports:{}};q[k][0].call(I.exports,function(a){return t(q[k][1][a]||a)},I,I.exports,g,q,n,f)}return n[k].exports}for(var e="function"==typeof require&&require,k=0;k<f.length;k++)t(f[k]);return t}return g}()({1:[function(g,q,n){(function(f,g,e,k,n){function t(b,a){var d=b.styleAttrs&&b.styleAttrs["http://www.w3.org/ns/ttml#styling backgroundColor"];if("span"===b.kind)!d&&a&&(b.styleAttrs||(b.styleAttrs={}),b.styleAttrs["http://www.w3.org/ns/ttml#styling backgroundColor"]=a);else if(d&&delete b.styleAttrs["http://www.w3.org/ns/ttml#styling backgroundColor"],
...
a.explicit_dur:null!==a.explicit_end&&null===a.explicit_dur?r+a.explicit_end:d;delete a.explicit_begin;delete a.explicit_dur;delete a.explicit_end;b._registerEvent(a)}function F(b){this.node=b}function h(){this.events=[];this.head=new b;this.body=null}function b(){this.styling=new d;this.layout=new U}function d(){this.styles={};this.initials={}}function l(){this.styleRefs=this.styleAttrs=this.id=null}function z(){this.styleAttrs=null}function U(){this.regions={}}function L(b,a){this.kind="image";
this.src=b;this.type=a}function A(b){this.id=b}function m(b){this.regionID=b}function q(b){this.styleAttrs=b}function x(b){this.sets=b}function H(b){this.contents=b}function u(b,a,d){this.explicit_begin=b;this.explicit_end=a;this.explicit_dur=d}function v(){this.kind="body"}function B(){this.kind="div"}function P(){this.kind="p"}function G(){this.kind="span"}function C(){this.kind="span"}function N(){this.kind="br"}function J(){}function V(){}function y(b){var a=null;b&&(b=b.attributes["xml:id"]||
b.attributes.id)&&(a=b.value||null);return a}function Q(b){return b&&"style"in b.attributes?b.attributes.style.value.split(" "):[]}function R(b,a){var d={};if(null!==b)for(var c in b.attributes){var e=b.attributes[c].uri+" "+b.attributes[c].local,l=k.byQName[e];if(void 0!==l){var z=l.parse(b.attributes[c].value);null!==z?(d[e]=z,l===k.byName.zIndex&&M(a,"zIndex attribute present but not used by IMSC1 since regions do not overlap")):K(a,"Cannot parse styling attribute "+e+" --\x3e "+b.attributes[c].value)}}return d}
function O(b,a,d){for(var c in b.attributes)if(b.attributes[c].uri===a&&b.attributes[c].local===d)return b.attributes[c].value;return null}function aa(b,a){b=O(b,e.ns_tts,"extent");if(null===b)return null;var d=b.split(" ");if(2!==d.length)return M(a,"Malformed extent (ignoring)"),null;b=n.parseLength(d[0]);d=n.parseLength(d[1]);return d&&b?{h:d,w:b}:(M(a,"Malformed extent values (ignoring)"),null)}function S(b,a,d){var c=/^(\d{2,}):(\d\d):(\d\d(?:\.\d+)?)$/,e=/^(\d{2,}):(\d\d):(\d\d):(\d{2,})$/,
...
null!==(g=e.exec(d))&&null!==a&&(D=3600*parseInt(g[1])+60*parseInt(g[2])+parseInt(g[3])+(null===g[4]?0:parseInt(g[4])/a));return D}function W(b,a,d){for(;0<a.styleRefs.length;){var c=a.styleRefs.pop();c in b.styles?(W(b,b.styles[c],d),T(b.styles[c].styleAttrs,a.styleAttrs)):K(d,"Non-existant style id referenced")}}function X(b,a,d,c){for(var e=a.length-1;0<=e;e--){var l=a[e];l in b.styles?T(b.styles[l].styleAttrs,d):K(c,"Non-existant style id referenced")}}function T(b,a){for(var d in b)d in a||(a[d]=
b[d])}function M(b,a){if(b&&b.warn&&b.warn(a))throw a;}function K(b,a){if(b&&b.error&&b.error(a))throw a;}function E(b,a){b&&b.fatal&&b.fatal(a);throw a;}function Y(b,a){for(var d=0,c=b.length-1,e;d<=c;){e=Math.floor((d+c)/2);var l=b[e];if(l<a)d=e+1;else if(l>a)c=e-1;else return{found:!0,index:e}}return{found:!1,index:d}}f.fromXML=function(f,w,D){var r=g.parser(!0,{xmlns:!0}),p=[],x=[],A=[],n=0,m=null;r.onclosetag=function(b){if(p[0]instanceof d)for(var a in p[0].styles)W(p[0],p[0].styles[a],w);else if(p[0]instanceof
...
B||p[0]instanceof v||E(w,"Parent of <div> element is not <body> or <div> at "+this.line+","+this.column+")");r=new B;r.initFromNode(m,p[0],a,w);if(g=r.styleAttrs[k.byName.backgroundImage.qname])r.contents.push(new L(g)),delete r.styleAttrs[k.byName.backgroundImage.qname];p[0].contents.push(r);p.unshift(r)}else"image"===a.local?(p[0]instanceof B||E(w,"Parent of <image> element is not <div> at "+this.line+","+this.column+")"),r=new L,r.initFromNode(m,p[0],a,w),p[0].contents.push(r),p.unshift(r)):"p"===
...
","+this.column+")"),r=new N,r.initFromNode(m,p[0],a,w),p[0].contents.push(r),p.unshift(r)):"set"===a.local?(p[0]instanceof G||p[0]instanceof P||p[0]instanceof B||p[0]instanceof v||p[0]instanceof J||p[0]instanceof N||E(w,"Parent of <set> element is not a content element or a region at "+this.line+","+this.column+")"),r=new V,r.initFromNode(m,p[0],a,w),p[0].sets.push(r),p.unshift(r)):p.unshift(new F(a));else p.unshift(new F(a));if(p[0]instanceof F)if(a.uri===e.ns_tt&&"metadata"===a.local)n++;else if(0<
n&&D&&"onOpenTag"in D){r=[];for(var t in a.attributes)r[a.attributes[t].uri+" "+a.attributes[t].local]={uri:a.attributes[t].uri,local:a.attributes[t].local,value:a.attributes[t].value};D.onOpenTag(a.uri,a.local,r)}};r.write(f).close();delete m.head.styling.styles;f=!1;for(var q in m.head.layout.regions){f=!0;break}f||(q=J.prototype.createDefaultRegion(m,w),m.head.layout.regions[q.id]=q);for(var u in m.head.layout.regions)c(m,m.head.layout.regions[u],null,null);m.body&&c(m,m.body,null,null);m.body&&
a(m.body);m.body&&t(m.body);return m};h.prototype.initFromNode=function(b,a){var d=O(b,e.ns_ttp,"cellResolution"),c=15;var l=32;null!==d&&(d=/(\d+) (\d+)/.exec(d),null!==d?(l=parseInt(d[1]),c=parseInt(d[2])):M(a,"Malformed cellResolution value (using initial value instead)"));this.cellLength={h:new n.ComputedLength(0,1/c),w:new n.ComputedLength(1/l,0)};c=O(b,e.ns_ttp,"frameRate");d=30;null!==c&&(l=/(\d+)/.exec(c),null!==l?d=parseInt(l[1]):M(a,"Malformed frame rate attribute (using initial value instead)"));
l=O(b,e.ns_ttp,"frameRateMultiplier");var z=1;null!==l&&(l=/(\d+) (\d+)/.exec(l),null!==l?z=parseInt(l[1])/parseInt(l[2]):M(a,"Malformed frame rate multiplier attribute (using initial value instead)"));d*=z;z=1;l=O(b,e.ns_ttp,"tickRate");null===l?null!==c&&(z=d):(l=/(\d+)/.exec(l),null!==l?z=parseInt(l[1]):M(a,"Malformed tick rate attribute (using initial value instead)"));this.effectiveFrameRate=d;this.tickRate=z;l=O(b,e.ns_ittp,"aspectRatio");null===l&&(l=O(b,e.ns_ttp,"displayAspectRatio"));c=null;
...
b.w.value,0)});this.dimensions={h:new n.ComputedLength(0,1),w:new n.ComputedLength(1,0)}};h.prototype._registerEvent=function(b){if(!(b.end<=b.begin)){var a=Y(this.events,b.begin);a.found||this.events.splice(a.index,0,b.begin);b.end!==Number.POSITIVE_INFINITY&&(a=Y(this.events,b.end),a.found||this.events.splice(a.index,0,b.end))}};h.prototype.getMediaTimeRange=function(){return[this.events[0],this.events[this.events.length-1]]};h.prototype.getMediaTimeEvents=function(){return this.events};l.prototype.initFromNode=
function(b,a){this.id=y(b);this.styleAttrs=R(b,a);this.styleRefs=Q(b)};z.prototype.initFromNode=function(b,a){this.styleAttrs={};for(var d in b.attributes)if(b.attributes[d].uri===e.ns_itts||b.attributes[d].uri===e.ns_ebutts||b.attributes[d].uri===e.ns_tts)this.styleAttrs[b.attributes[d].uri+" "+b.attributes[d].local]=b.attributes[d].value};L.prototype.initFromNode=function(b,a,d,c){(this.src="src"in d.attributes?d.attributes.src.value:null)||K(c,"Invalid image@src attribute");(this.type="type"in
d.attributes?d.attributes.type.value:null)||K(c,"Invalid image@type attribute");q.prototype.initFromNode.call(this,b,a,d,c);u.prototype.initFromNode.call(this,b,a,d,c);x.prototype.initFromNode.call(this,b,a,d,c);m.prototype.initFromNode.call(this,b,a,d,c)};A.prototype.initFromNode=function(b,a,d,c){this.id=y(d)};m.prototype.initFromNode=function(b,a,d,c){this.regionID=d&&"region"in d.attributes?d.attributes.region.value:""};q.prototype.initFromNode=function(b,a,d,c){this.styleAttrs=R(d,c);null!==
b.head&&null!==b.head.styling&&X(b.head.styling,Q(d),this.styleAttrs,c)};x.prototype.initFromNode=function(b,a,d,c){this.sets=[]};H.prototype.initFromNode=function(b,a,d,c){this.contents=[]};u.prototype.initFromNode=function(b,a,d,c){a=null;d&&"begin"in d.attributes&&(a=S(b.tickRate,b.effectiveFrameRate,d.attributes.begin.value),null===a&&M(c,"Malformed begin value "+d.attributes.begin.value+" (using 0)"));var l=null;d&&"dur"in d.attributes&&(l=S(b.tickRate,b.effectiveFrameRate,d.attributes.dur.value),
null===l&&M(c,"Malformed dur value "+d.attributes.dur.value+" (ignoring)"));var e=null;d&&"end"in d.attributes&&(e=S(b.tickRate,b.effectiveFrameRate,d.attributes.end.value),null===e&&M(c,"Malformed end value (ignoring)"));this.explicit_begin=a;this.explicit_end=e;this.explicit_dur=l;(b=d&&"timeContainer"in d.attributes?d.attributes.timeContainer.value:null)&&"par"!==b?"seq"===b?c="seq":(K(c,"Illegal value of timeContainer (assuming 'par')"),c="par"):c="par";this.timeContainer=c};v.prototype.initFromNode=
function(b,a,d){q.prototype.initFromNode.call(this,b,null,a,d);u.prototype.initFromNode.call(this,b,null,a,d);x.prototype.initFromNode.call(this,b,null,a,d);m.prototype.initFromNode.call(this,b,null,a,d);H.prototype.initFromNode.call(this,b,null,a,d)};B.prototype.initFromNode=function(b,a,d,c){q.prototype.initFromNode.call(this,b,a,d,c);u.prototype.initFromNode.call(this,b,a,d,c);x.prototype.initFromNode.call(this,b,a,d,c);m.prototype.initFromNode.call(this,b,a,d,c);H.prototype.initFromNode.call(this,
b,a,d,c)};P.prototype.initFromNode=function(b,a,d,c){q.prototype.initFromNode.call(this,b,a,d,c);u.prototype.initFromNode.call(this,b,a,d,c);x.prototype.initFromNode.call(this,b,a,d,c);m.prototype.initFromNode.call(this,b,a,d,c);H.prototype.initFromNode.call(this,b,a,d,c)};G.prototype.initFromNode=function(b,a,d,c,l){q.prototype.initFromNode.call(this,b,a,d,l);u.prototype.initFromNode.call(this,b,a,d,l);x.prototype.initFromNode.call(this,b,a,d,l);m.prototype.initFromNode.call(this,b,a,d,l);H.prototype.initFromNode.call(this,
b,a,d,l);this.space=c};C.prototype.initFromText=function(b,a,d,c,l){u.prototype.initFromNode.call(this,b,a,null,l);this.text=d;this.space=c};N.prototype.initFromNode=function(b,a,d,c){m.prototype.initFromNode.call(this,b,a,d,c);u.prototype.initFromNode.call(this,b,a,d,c)};J.prototype.createDefaultRegion=function(b,a){var d=new J;d.id="";q.prototype.initFromNode.call(d,b,null,{name:"region",attributes:{"tts:displayAlign":{name:"tts:displayAlign",value:"after",prefix:"tts",local:"displayAlign",uri:"http://www.w3.org/ns/ttml#styling"},
...
{}:n,"undefined"===typeof imscNames?g("./names"):imscNames,"undefined"===typeof imscStyles?g("./styles"):imscStyles,"undefined"===typeof imscUtils?g("./utils"):imscUtils)},{"./names":5,"./styles":6,"./utils":7}],3:[function(g,q,n){(function(f,g,e,k){function t(b,c,f,g,q,L,A,m,I){if(c<A.begin||c>=A.end)return null;L="regionID"in A&&""!==A.regionID?A.regionID:L;if(null!==q&&L!==f.id&&(!("contents"in A)||"contents"in A&&0===A.contents.length||""!==L))return null;var d=new F(A);for(l in A.sets)c<A.sets[l].begin||
...
v.rw,.5*v.rh));for(var C in e.all)(B=e.all[C],B.qname in d.styleAttrs||B.qname===e.byName.position.qname&&e.byName.origin.qname in d.styleAttrs||B.qname===e.byName.origin.qname&&e.byName.position.qname in d.styleAttrs||(u=b.head.styling.initials[B.qname]||B.initial,"region"!==d.kind&&(!1!==B.inherit||null===u)))||(d.styleAttrs[B.qname]=B.parse(u),l[B.qname]=!0);for(var N in e.all)if(C=e.all[N],C.qname in l&&null!==C.compute)if(B=C.compute(b,q,d,d.styleAttrs[C.qname],I),null!==B)d.styleAttrs[C.qname]=
B;else if(d.styleAttrs[C.qname]=C.compute(b,q,d,C.parse(C.initial),I),C="Style '"+C.qname+"' on element '"+d.kind+"' cannot be computed",m&&m.error&&m.error(C))throw C;if("none"===d.styleAttrs[e.byName.display.qname])return null;if(null===q)var J=null===g?[]:[g];else"contents"in A&&(J=A.contents);for(var Z in J)q=t(b,c,f,g,d,L,J[Z],m,I),null!==q&&d.contents.push(q.element);for(var y in d.styleAttrs)b=!1,"span"===d.kind&&(c=d.styleAttrs[e.byName.ruby.qname],(b=("container"===c||"textContainer"===c||
...
"image"===d.kind||"contents"in d&&0<d.contents.length||"span"===d.kind&&null!==d.text||"region"===d.kind&&"always"===d.styleAttrs[e.byName.showBackground.qname]?{region_id:L,element:d}:null}function n(b,a){if("contents"in b)for(var c in b.contents)n(b.contents[c],a);else"span"!==b.kind&&"br"!==b.kind||a.push(b)}function a(b){if("br"===b.kind)return!1;if("text"in b)return 0===b.text.length;if("contents"in b){for(var c=b.contents.length;c--;)a(b.contents[c])&&b.contents.splice(c,1);return 0===b.contents.length}}
function c(a){this.contents=[];this.aspectRatio=a.aspectRatio}function F(a){this.kind=a.kind||"region";a.id&&(this.id=a.id);this.styleAttrs={};for(var b in a.styleAttrs)this.styleAttrs[b]=a.styleAttrs[b];"src"in a&&(this.src=a.src);"type"in a&&(this.type=a.type);if("text"in a)this.text=a.text;else if("region"===this.kind||"contents"in a)this.contents=[];"space"in a&&(this.space=a.space)}f.generateISD=function(a,d,e){var b=new c(a),f={},h={},g=new Set;for(l in a.body)h[l]=a.body[l];h.contents=[];a.body.contents.forEach(function(a,
b){var c=a.contents.filter(function(a){return d<a.begin||d>=a.end?!1:(a.regionID&&g.add(a.regionID),!0)}),e={},f;for(f in a)e[f]=a[f];e.contents=c;h.contents[b]=e});0===g.length&&a.head.layout.regions[""]&&g.add("");for(var F in g){var l=t(a,d,a.head.layout.regions[g[F]],h,null,"",a.head.layout.regions[g[F]],e,f);null!==l&&b.contents.push(l.element)}return b};var h=[e.byName.color.qname,e.byName.textCombine.qname,e.byName.textDecoration.qname,e.byName.textEmphasis.qname,e.byName.textOutline.qname,
e.byName.textShadow.qname]})("undefined"===typeof n?this.imscISD={}:n,"undefined"===typeof imscNames?g("./names"):imscNames,"undefined"===typeof imscStyles?g("./styles"):imscStyles,"undefined"===typeof imscUtils?g("./utils"):imscUtils)},{"./names":5,"./styles":6,"./utils":7}],4:[function(g,q,n){n.generateISD=g("./isd").generateISD;n.fromXML=g("./doc").fromXML;n.renderHTML=g("./html").render},{"./doc":1,"./html":2,"./isd":3}],5:[function(g,q,n){g="undefined"===typeof n?this.imscNames={}:n;g.ns_tt=
"http://www.w3.org/ns/ttml";g.ns_tts="http://www.w3.org/ns/ttml#styling";g.ns_ttp="http://www.w3.org/ns/ttml#parameter";g.ns_xml="http://www.w3.org/XML/1998/namespace";g.ns_itts="http://www.w3.org/ns/ttml/profile/imsc1#styling";g.ns_ittp="http://www.w3.org/ns/ttml/profile/imsc1#parameter";g.ns_smpte="http://www.smpte-ra.org/schemas/2052-1/2010/smpte-tt";g.ns_ebutts="urn:ebu:tt:style";g.ttaf_map={"http://www.w3.org/2006/10/ttaf1":g.ns_tt,"http://www.w3.org/2006/10/ttaf1#style":g.ns_tts,"http://www.w3.org/2006/10/ttaf1#parameter":g.ns_ttp}},
{}],6:[function(g,q,n){(function(f,g,e){function k(a,c,e,f,b,d,g,k){this.name=c;this.ns=a;this.qname=a+" "+c;this.inherit=b;this.animatable=d;this.initial=e;this.applies=f;this.parse=g;this.compute=k}f.all=[new k(g.ns_tts,"backgroundColor","transparent",["body","div","p","region","span"],!1,!0,e.parseColor,null),new k(g.ns_tts,"color","white",["span"],!0,!0,e.parseColor,null),new k(g.ns_tts,"direction","ltr",["p","span"],!0,!0,function(a){return a},null),new k(g.ns_tts,"display","auto",["body","div",
"p","region","span"],!1,!0,function(a){return a},null),new k(g.ns_tts,"displayAlign","before",["region"],!1,!0,function(a){return a},null),new k(g.ns_tts,"extent","auto",["tt","region"],!1,!0,function(a){if("auto"===a)return a;var c=a.split(" ");if(2!==c.length)return null;a=e.parseLength(c[0]);return(c=e.parseLength(c[1]))&&a?{h:c,w:a}:null},function(a,c,f,g,b){if("auto"===g)c=new e.ComputedLength(0,1);else if(c=e.toComputedLength(g.h.value,g.h.unit,null,a.dimensions.h,null,a.pxLength.h),null===
c)return null;if("auto"===g)a=new e.ComputedLength(1,0);else if(a=e.toComputedLength(g.w.value,g.w.unit,null,a.dimensions.w,null,a.pxLength.w),null===a)return null;return{h:c,w:a}}),new k(g.ns_tts,"fontFamily","default",["span"],!0,!0,function(a){a=a.split(",");var c=[],e;for(e in a)"'"!==a[e].charAt(0)&&'"'!==a[e].charAt(0)?"default"===a[e]?c.push("monospaceSerif"):c.push(a[e]):c.push(a[e]);return c},null),new k(g.ns_tts,"shear","0%",["p"],!0,!0,e.parseLength,function(a,c,e,f){if("%"===f.unit)a=
100<Math.abs(f.value)?100*Math.sign(f.value):f.value;else return null;return a}),new k(g.ns_tts,"fontSize","1c",["span"],!0,!0,e.parseLength,function(a,c,g,h,b){return e.toComputedLength(h.value,h.unit,null!==c?c.styleAttrs[f.byName.fontSize.qname]:a.cellLength.h,null!==c?c.styleAttrs[f.byName.fontSize.qname]:a.cellLength.h,a.cellLength.h,a.pxLength.h)}),new k(g.ns_tts,"fontStyle","normal",["span"],!0,!0,function(a){return a},null),new k(g.ns_tts,"fontWeight","normal",["span"],!0,!0,function(a){return a},
null),new k(g.ns_tts,"lineHeight","normal",["p"],!0,!0,function(a){return"normal"===a?a:e.parseLength(a)},function(a,c,g,h,b){if("normal"===h)a=h;else if(a=e.toComputedLength(h.value,h.unit,g.styleAttrs[f.byName.fontSize.qname],g.styleAttrs[f.byName.fontSize.qname],a.cellLength.h,a.pxLength.h),null===a)return null;return a}),new k(g.ns_tts,"opacity",1,["region"],!1,!0,parseFloat,null),new k(g.ns_tts,"origin","auto",["region"],!1,!0,function(a){if("auto"===a)return a;var c=a.split(" ");if(2!==c.length)return null;
a=e.parseLength(c[0]);return(c=e.parseLength(c[1]))&&a?{h:c,w:a}:null},function(a,c,f,g,b){if("auto"===g)c=new e.ComputedLength(0,0);else if(c=e.toComputedLength(g.h.value,g.h.unit,null,a.dimensions.h,null,a.pxLength.h),null===c)return null;if("auto"===g)a=new e.ComputedLength(0,0);else if(a=e.toComputedLength(g.w.value,g.w.unit,null,a.dimensions.w,null,a.pxLength.w),null===a)return null;return{h:c,w:a}}),new k(g.ns_tts,"overflow","hidden",["region"],!1,!0,function(a){return a},null),new k(g.ns_tts,
"padding","0px",["region"],!1,!0,function(a){a=a.split(" ");if(4<a.length)return null;var c=[],f;for(f in a){var g=e.parseLength(a[f]);if(!g)return null;c.push(g)}return c},function(a,c,g,h,b){if(1===h.length)c=[h[0],h[0],h[0],h[0]];else if(2===h.length)c=[h[0],h[1],h[0],h[1]];else if(3===h.length)c=[h[0],h[1],h[2],h[1]];else if(4===h.length)c=[h[0],h[1],h[2],h[3]];else return null;h=g.styleAttrs[f.byName.writingMode.qname];if("lrtb"===h||"lr"===h)c=[c[0],c[3],c[2],c[1]];else if("rltb"===h||"rl"===
h)c=[c[0],c[1],c[2],c[3]];else if("tblr"===h)c=[c[3],c[0],c[1],c[2]];else if("tbrl"===h||"tb"===h)c=[c[3],c[2],c[1],c[0]];else return null;h=[];for(var d in c)if(0===c[d].value)h[d]=new e.ComputedLength(0,0);else if(h[d]=e.toComputedLength(c[d].value,c[d].unit,g.styleAttrs[f.byName.fontSize.qname],"0"===d||"2"===d?g.styleAttrs[f.byName.extent.qname].h:g.styleAttrs[f.byName.extent.qname].w,"0"===d||"2"===d?a.cellLength.h:a.cellLength.w,"0"===d||"2"===d?a.pxLength.h:a.pxLength.w),null===h[d])return null;
return h}),new k(g.ns_tts,"position","top left",["region"],!1,!0,function(a){return e.parsePosition(a)},function(a,c,g,h){c=e.toComputedLength(h.v.offset.value,h.v.offset.unit,null,new e.ComputedLength(-g.styleAttrs[f.byName.extent.qname].h.rw,a.dimensions.h.rh-g.styleAttrs[f.byName.extent.qname].h.rh),null,a.pxLength.h);if(null===c)return null;"bottom"===h.v.edge&&(c=new e.ComputedLength(-c.rw-g.styleAttrs[f.byName.extent.qname].h.rw,a.dimensions.h.rh-c.rh-g.styleAttrs[f.byName.extent.qname].h.rh));
var b=e.toComputedLength(h.h.offset.value,h.h.offset.unit,null,new e.ComputedLength(a.dimensions.w.rw-g.styleAttrs[f.byName.extent.qname].w.rw,-g.styleAttrs[f.byName.extent.qname].w.rh),null,a.pxLength.w);if(null===c)return null;"right"===h.h.edge&&(b=new e.ComputedLength(a.dimensions.w.rw-b.rw-g.styleAttrs[f.byName.extent.qname].w.rw,-b.rh-g.styleAttrs[f.byName.extent.qname].w.rh));return{h:c,w:b}}),new k(g.ns_tts,"ruby","none",["span"],!1,!0,function(a){return a},null),new k(g.ns_tts,"rubyAlign",
"center",["span"],!0,!0,function(a){return"center"!==a&&"spaceAround"!==a?null:a},null),new k(g.ns_tts,"rubyPosition","outside",["span"],!0,!0,function(a){return a},null),new k(g.ns_tts,"rubyReserve","none",["p"],!0,!0,function(a){var c=a.split(" ");a=[null,null];if(0===c.length||2<c.length||"none"!==c[0]&&"both"!==c[0]&&"after"!==c[0]&&"before"!==c[0]&&"outside"!==c[0])return null;a[0]=c[0];if(2===c.length&&"none"!==c[0])if(c=e.parseLength(c[1]))a[1]=c;else return null;return a},function(a,c,g,h,
b){if("none"===h[0])return h;a=null===h[1]?new e.ComputedLength(.5*g.styleAttrs[f.byName.fontSize.qname].rw,.5*g.styleAttrs[f.byName.fontSize.qname].rh):e.toComputedLength(h[1].value,h[1].unit,g.styleAttrs[f.byName.fontSize.qname],g.styleAttrs[f.byName.fontSize.qname],a.cellLength.h,a.pxLength.h);return null===a?null:[h[0],a]}),new k(g.ns_tts,"showBackground","whenActive",["region"],!1,!0,function(a){return a},null),new k(g.ns_tts,"textAlign","start",["p"],!0,!0,function(a){return a},function(a,c,
e,f,b){return"left"===f?"start":"right"===f?"end":f}),new k(g.ns_tts,"textCombine","none",["span"],!0,!0,function(a){a=a.split(" ");return 1!==a.length||"none"!==a[0]&&"all"!==a[0]?null:[a[0]]},null),new k(g.ns_tts,"textDecoration","none",["span"],!0,!0,function(a){return a.split(" ")},null),new k(g.ns_tts,"textEmphasis","none",["span"],!0,!0,function(a){a=a.split(" ");var c={style:null,symbol:null,color:null,position:null},f;for(f in a)if("none"===a[f]||"auto"===a[f])c.style=a[f];else if("filled"===
...
!0,function(a){if("none"===a)return a;var c={};a=a.split(" ");if(0===a.length||2<a.length)return null;var f=e.parseColor(a[0]);c.color=f;null!==f&&a.shift();if(1!==a.length)return null;a=e.parseLength(a[0]);if(!a)return null;c.thickness=a;return c},function(a,c,g,h,b){if("none"===h)return h;c={};c.color=null===h.color?g.styleAttrs[f.byName.color.qname]:h.color;c.thickness=e.toComputedLength(h.thickness.value,h.thickness.unit,g.styleAttrs[f.byName.fontSize.qname],g.styleAttrs[f.byName.fontSize.qname],
a.cellLength.h,a.pxLength.h);return null===c.thickness?null:c}),new k(g.ns_tts,"textShadow","none",["span"],!0,!0,e.parseTextShadow,function(a,c,g,h){if("none"===h)return h;c=[];for(var b in h){var d={};d.x_off=e.toComputedLength(h[b][0].value,h[b][0].unit,null,g.styleAttrs[f.byName.fontSize.qname],null,a.pxLength.w);if(null===d.x_off)return null;d.y_off=e.toComputedLength(h[b][1].value,h[b][1].unit,null,g.styleAttrs[f.byName.fontSize.qname],null,a.pxLength.h);if(null===d.y_off)return null;if(null===
h[b][2])d.b_radius=0;else if(d.b_radius=e.toComputedLength(h[b][2].value,h[b][2].unit,null,g.styleAttrs[f.byName.fontSize.qname],null,a.pxLength.h),null===d.b_radius)return null;d.color=null===h[b][3]?g.styleAttrs[f.byName.color.qname]:h[b][3];c.push(d)}return c}),new k(g.ns_tts,"unicodeBidi","normal",["span","p"],!1,!0,function(a){return a},null),new k(g.ns_tts,"visibility","visible",["body","div","p","region","span"],!0,!0,function(a){return a},null),new k(g.ns_tts,"wrapOption","wrap",["span"],
!0,!0,function(a){return a},null),new k(g.ns_tts,"writingMode","lrtb",["region"],!1,!0,function(a){return a},null),new k(g.ns_tts,"zIndex","auto",["region"],!1,!0,function(a){"auto"!==a&&(a=parseInt(a),isNaN(a)&&(a=null));return a},null),new k(g.ns_ebutts,"linePadding","0c",["p"],!0,!1,e.parseLength,function(a,c,f,g,b){return e.toComputedLength(g.value,g.unit,null,null,a.cellLength.w,null)}),new k(g.ns_ebutts,"multiRowAlign","auto",["p"],!0,!1,function(a){return a},null),new k(g.ns_smpte,"backgroundImage",
null,["div"],!1,!1,function(a){return a},null),new k(g.ns_itts,"forcedDisplay","false",["body","div","p","region","span"],!0,!0,function(a){return"true"===a?!0:!1},null),new k(g.ns_itts,"fillLineGap","true",["p"],!0,!0,function(a){return"true"===a?!0:!1},null)];f.byQName={};for(var n in f.all)f.byQName[f.all[n].qname]=f.all[n];f.byName={};for(var q in f.all)f.byName[f.all[q].name]=f.all[q]})("undefined"===typeof n?this.imscStyles={}:n,"undefined"===typeof imscNames?g("./names"):imscNames,"undefined"===
typeof imscUtils?g("./utils"):imscUtils)},{"./names":5,"./utils":7}],7:[function(g,q,n){(function(f){var g=/#([0-9a-fA-F]{2})([0-9a-fA-F]{2})([0-9a-fA-F]{2})([0-9a-fA-F]{2})?/,e=/rgb\(\s*(\d+)\s*,\s*(\d+)\s*,\s*(\d+)\s*\)/,k=/rgba\(\s*(\d+),\s*(\d+)\s*,\s*(\d+)\s*,\s*(\d+)\s*\)/,n={transparent:[0,0,0,0],black:[0,0,0,255],silver:[192,192,192,255],gray:[128,128,128,255],white:[255,255,255,255],maroon:[128,0,0,255],red:[255,0,0,255],purple:[128,0,128,255],fuchsia:[255,0,255,255],magenta:[255,0,255,255],
...
parseInt(c[3]),parseInt(c[4])]);return f};var q=/^((?:\+|\-)?\d*(?:\.\d+)?)(px|em|c|%|rh|rw)$/;f.parseLength=function(a){var c,e=null;null!==(c=q.exec(a))&&(e={value:parseFloat(c[1]),unit:c[2]});return e};f.parseTextShadow=function(a){a=a.split(",");var c=[],e;for(e in a){var g=a[e].split(" ");if(1===g.length&&"none"===g[0])return"none";if(1<g.length&&5>g.length){var b=[null,null,null,null],d=f.parseLength(g.shift());if(null===d)return null;b[0]=d;d=f.parseLength(g.shift());if(null===d)return null;
b[1]=d;if(0!==g.length&&(d=f.parseLength(g[0]),null!==d&&(b[2]=d,g.shift()),0!==g.length)){g=f.parseColor(g[0]);if(null===g)return null;b[3]=g}c.push(b)}}return c};f.parsePosition=function(a){a=a.split(" ");var c=function(a){return"center"===a||"left"===a||"top"===a||"bottom"===a||"right"===a};if(4<a.length)return null;for(var e in a)if(!c(a[e])){var g=f.parseLength(a[e]);if(null===g)return null;a[e]=g}e={h:{edge:"left",offset:{value:50,unit:"%"}},v:{edge:"top",offset:{value:50,unit:"%"}}};for(g=
0;g<a.length;){var b=a[g++];if(c(b)){var d={value:0,unit:"%"};2!==a.length&&g<a.length&&!c(a[g])&&(d=a[g++]);"right"===b?(e.h.edge=b,e.h.offset=d):"bottom"===b?(e.v.edge=b,e.v.offset=d):"left"===b?e.h.offset=d:"top"===b&&(e.v.offset=d)}else if(1===a.length||2===a.length)1===g?e.h.offset=b:e.v.offset=b;else return null}return e};f.ComputedLength=function(a,c){this.rw=a;this.rh=c};f.ComputedLength.prototype.toUsedLength=function(a,c){return a*this.rw+c*this.rh};f.ComputedLength.prototype.isZero=function(){return 0===
this.rw&&0===this.rh};f.toComputedLength=function(a,c,e,g,b,d){return"%"===c&&g?new f.ComputedLength(g.rw*a/100,g.rh*a/100):"em"===c&&e?new f.ComputedLength(e.rw*a,e.rh*a):"c"===c&&b?new f.ComputedLength(a*b.rw,a*b.rh):"px"===c&&d?new f.ComputedLength(a*d.rw,a*d.rh):"rh"===c?new f.ComputedLength(0,a/100):"rw"===c?new f.ComputedLength(a/100,0):null}})("undefined"===typeof n?this.imscUtils={}:n)},{}]},{},[4])(4)});
