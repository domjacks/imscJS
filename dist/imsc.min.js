...
f;for(f in c)e[f]=c[f];e.contents=[];c.contents.filter(d).forEach(function(c){c=b(a,c);E.add(c.regionID);null!==c&&e.contents.push(c)});return e}return c}var f=new c(a),h={},g={},E=new Set;g=b(d,a.body);0===E.length&&0<a.head.layout.regions.length&&E.add("");E.forEach(function(b){b=t(a,d,a.head.layout.regions[b],g,null,"",a.head.layout.regions[b],e,h);null!==b&&f.contents.push(b.element)});return f};var h=[e.byName.color.qname,e.byName.textCombine.qname,e.byName.textDecoration.qname,e.byName.textEmphasis.qname,
...
{}:n;g.ns_tt="http://www.w3.org/ns/ttml";g.ns_tts="http://www.w3.org/ns/ttml#styling";g.ns_ttp="http://www.w3.org/ns/ttml#parameter";g.ns_xml="http://www.w3.org/XML/1998/namespace";g.ns_itts="http://www.w3.org/ns/ttml/profile/imsc1#styling";g.ns_ittp="http://www.w3.org/ns/ttml/profile/imsc1#parameter";g.ns_smpte="http://www.smpte-ra.org/schemas/2052-1/2010/smpte-tt";g.ns_ebutts="urn:ebu:tt:style";g.ttaf_map={"http://www.w3.org/2006/10/ttaf1":g.ns_tt,"http://www.w3.org/2006/10/ttaf1#style":g.ns_tts,
