...
k.length,t=2<arguments.length&&!0===arguments[2];if(!t&&0===e)return 0;for(var b=!1;;)switch(a){case "ascii":case "latin1":case "binary":return e;case "utf8":case "utf-8":return r(k).length;case "ucs2":case "ucs-2":case "utf16le":case "utf-16le":return 2*e;case "hex":return e>>>1;case "base64":return N.toByteArray(E(k)).length;default:if(b)return t?-1:r(k).length;a=(""+a).toLowerCase();b=!0}}function q(k,a,e){var t=!1;if(void 0===a||0>a)a=0;if(a>this.length)return"";if(void 0===e||e>this.length)e=
...
e);for(var t=[];a<e;){var b=k[a],c=null,f=239<b?4:223<b?3:191<b?2:1;if(a+f<=e)switch(f){case 1:128>b&&(c=b);break;case 2:var I=k[a+1];128===(I&192)&&(b=(b&31)<<6|I&63,127<b&&(c=b));break;case 3:I=k[a+1];var n=k[a+2];128===(I&192)&&128===(n&192)&&(b=(b&15)<<12|(I&63)<<6|n&63,2047<b&&(55296>b||57343<b)&&(c=b));break;case 4:I=k[a+1];n=k[a+2];var h=k[a+3];128===(I&192)&&128===(n&192)&&128===(h&192)&&(b=(b&15)<<18|(I&63)<<12|(n&63)<<6|h&63,65535<b&&1114112>b&&(c=b))}null===c?(c=65533,f=1):65535<c&&(c-=
65536,t.push(c>>>10&1023|55296),c=56320|c&1023);t.push(c);a+=f}k=t.length;if(k<=A)t=String.fromCharCode.apply(String,t);else{e="";for(a=0;a<k;)e+=String.fromCharCode.apply(String,t.slice(a,a+=A));t=e}return t}function C(k,a,e){if(0!==k%1||0>k)throw new RangeError("offset is not uint");if(k+a>e)throw new RangeError("Trying to access beyond buffer length");}function F(k,a,e,b,f,n){if(!c.isBuffer(k))throw new TypeError('"buffer" argument must be a Buffer instance');if(a>f||a<n)throw new RangeError('"value" argument is out of bounds');
if(e+b>k.length)throw new RangeError("Index out of range");}function y(k,a,e,b,c,f){if(e+b>k.length)throw new RangeError("Index out of range");if(0>e)throw new RangeError("Index out of range");}function R(k,a,e,b,c){a=+a;e>>>=0;c||y(k,a,e,4,3.4028234663852886E38,-3.4028234663852886E38);G.write(k,a,e,b,23,4);return e+4}function K(k,a,e,b,c){a=+a;e>>>=0;c||y(k,a,e,8,1.7976931348623157E308,-1.7976931348623157E308);G.write(k,a,e,b,52,8);return e+8}function E(k){k=k.split("=")[0];k=k.trim().replace(W,
"");if(2>k.length)return"";for(;0!==k.length%4;)k+="=";return k}function r(k,a){a=a||Infinity;for(var e,b=k.length,c=null,f=[],I=0;I<b;++I){e=k.charCodeAt(I);if(55295<e&&57344>e){if(!c){if(56319<e){-1<(a-=3)&&f.push(239,191,189);continue}else if(I+1===b){-1<(a-=3)&&f.push(239,191,189);continue}c=e;continue}if(56320>e){-1<(a-=3)&&f.push(239,191,189);c=e;continue}e=(c-55296<<10|e-56320)+65536}else c&&-1<(a-=3)&&f.push(239,191,189);c=null;if(128>e){if(0>--a)break;f.push(e)}else if(2048>e){if(0>(a-=2))break;
...
a.constructor.name===b.name}var N=d("base64-js"),G=d("ieee754");m.Buffer=c;m.SlowBuffer=function(a){+a!=a&&(a=0);return c.alloc(+a)};m.INSPECT_MAX_BYTES=50;m.kMaxLength=2147483647;c.TYPED_ARRAY_SUPPORT=function(){try{var a=new Uint8Array(1);a.__proto__={__proto__:Uint8Array.prototype,foo:function(){return 42}};return 42===a.foo()}catch(I){return!1}}();c.TYPED_ARRAY_SUPPORT||"undefined"===typeof console||"function"!==typeof console.error||console.error("This browser lacks typed array (Uint8Array) support which is required by `buffer` v5.x. Use `buffer` v4.x if you require old browser support.");
...
t||(t="utf8");for(k=!1;;)switch(t){case "hex":a:{b=Number(b)||0;t=this.length-b;e?(e=Number(e),e>t&&(e=t)):e=t;t=a.length;e>t/2&&(e=t/2);for(t=0;t<e;++t){k=parseInt(a.substr(2*t,2),16);if(k!==k){a=t;break a}this[b+t]=k}a=t}return a;case "utf8":case "utf-8":return z(r(a,this.length-b),this,b,e);case "ascii":return z(H(a),this,b,e);case "latin1":case "binary":return z(H(a),this,b,e);case "base64":return z(N.toByteArray(E(a)),this,b,e);case "ucs2":case "ucs-2":case "utf16le":case "utf-16le":t=a;k=this.length-
...
b.length-a,0,d);a-=d;if(0===a){d===n.length?(++f,c.head=e.next?e.next:c.tail=null):(c.head=e,e.data=n.slice(d));break}++f}c.length-=f;c=b}b=c}c=b}return c}function y(a){var b=a._readableState;if(0<b.length)throw Error('"endReadable()" called on non-empty stream');b.endEmitted||(b.ended=!0,E.nextTick(R,b,a))}function R(a,b){a.endEmitted||0!==a.length||(a.endEmitted=!0,b.readable=!1,b.emit("end"))}function K(a,b){for(var c=0,e=a.length;c<e;c++)if(a[c]===b)return c;return-1}var E=d("process-nextick-args");
r.exports=w;var P=d("isarray"),H;w.ReadableState=p;d("events");var z=d("./internal/streams/stream"),L=d("safe-buffer").Buffer,N=g.Uint8Array||function(){};g=Object.create(d("core-util-is"));g.inherits=d("inherits");var G=d("util"),A=void 0;A=G&&G.debuglog?G.debuglog("stream"):function(){};var W=d("./internal/streams/BufferList");G=d("./internal/streams/destroy");var k;g.inherits(w,z);var I=["error","close","destroy","pause","resume"];Object.defineProperty(w.prototype,"destroyed",{get:function(){return void 0===
...
!a._writableState.needDrain||q())}function n(){A("onend");a.end()}function d(b){A("ondata");M=!1;!1!==a.write(b)||M||((1===J.pipesCount&&J.pipes===a||1<J.pipesCount&&-1!==K(J.pipes,a))&&!p&&(A("false write response, pause",g._readableState.awaitDrain),g._readableState.awaitDrain++,M=!0),g.pause())}function h(b){A("onerror",b);T();a.removeListener("error",h);0===a.listeners("error").length&&a.emit("error",b)}function k(){a.removeListener("finish",v);T()}function v(){A("onfinish");a.removeListener("close",
k);T()}function T(){A("unpipe");g.unpipe(a)}var g=this,J=this._readableState;switch(J.pipesCount){case 0:J.pipes=a;break;case 1:J.pipes=[J.pipes,a];break;default:J.pipes.push(a)}J.pipesCount+=1;A("pipe count=%d opts=%j",J.pipesCount,b);b=b&&!1===b.end||a===c.stdout||a===c.stderr?T:n;if(J.endEmitted)E.nextTick(b);else g.once("end",b);a.on("unpipe",e);var q=f(g);a.on("drain",q);var p=!1,M=!1;g.on("data",d);l(a,"error",h);a.once("close",k);a.once("finish",v);a.emit("pipe",g);J.flowing||(A("pipe resume"),
g.resume());return a};w.prototype.unpipe=function(a){var b=this._readableState,c={hasUnpiped:!1};if(0===b.pipesCount)return this;if(1===b.pipesCount){if(a&&a!==b.pipes)return this;a||(a=b.pipes);b.pipes=null;b.pipesCount=0;b.flowing=!1;a&&a.emit("unpipe",this,c);return this}if(!a){a=b.pipes;var f=b.pipesCount;b.pipes=null;b.pipesCount=0;b.flowing=!1;for(b=0;b<f;b++)a[b].emit("unpipe",this,c);return this}f=K(b.pipes,a);if(-1===f)return this;b.pipes.splice(f,1);--b.pipesCount;1===b.pipesCount&&(b.pipes=
...
var n=d("process-nextick-args");r.exports=b;var C=!c.browser&&-1<["v0.10","v0.9."].indexOf(c.version.slice(0,5))?l:n.nextTick,F;b.WritableState=m;c=Object.create(d("core-util-is"));c.inherits=d("inherits");var y={deprecate:d("util-deprecate")},R=d("./internal/streams/stream"),K=d("safe-buffer").Buffer,E=g.Uint8Array||function(){};g=d("./internal/streams/destroy");c.inherits(b,R);m.prototype.getBuffer=function(){for(var a=this.bufferedRequest,b=[];a;)b.push(a),a=a.next;return b};(function(){try{Object.defineProperty(m.prototype,
"buffer",{get:y.deprecate(function(){return this.getBuffer()},"_writableState.buffer is deprecated. Use _writableState.getBuffer instead.","DEP0003")})}catch(H){}})();if("function"===typeof Symbol&&Symbol.hasInstance&&"function"===typeof Function.prototype[Symbol.hasInstance]){var P=Function.prototype[Symbol.hasInstance];Object.defineProperty(b,Symbol.hasInstance,{value:function(a){return P.call(this,a)?!0:this!==b?!1:a&&a._writableState instanceof m}})}else P=function(a){return a instanceof this};
b.prototype.pipe=function(){this.emit("error",Error("Cannot pipe, not readable"))};b.prototype.write=function(a,b,c){var f=this._writableState,d=!1,g;if(g=!f.objectMode)g=a,g=K.isBuffer(g)||g instanceof E;g&&!K.isBuffer(a)&&(a=K.from(a));"function"===typeof b&&(c=b,b=null);g?b="buffer":b||(b=f.defaultEncoding);"function"!==typeof c&&(c=w);if(f.ended)f=c,c=Error("write after end"),this.emit("error",c),n.nextTick(f,c);else{var v;if(!(v=g)){v=a;var k=c,l=!0,e=!1;null===v?e=new TypeError("May not write null values to stream"):
"string"===typeof v||void 0===v||f.objectMode||(e=new TypeError("Invalid non-string/buffer chunk"));e&&(this.emit("error",e),n.nextTick(k,e),l=!1);v=l}v&&(f.pendingcb++,d=g,d||(g=a,f.objectMode||!1===f.decodeStrings||"string"!==typeof g||(g=K.from(g,b)),a!==g&&(d=!0,b="buffer",a=g)),v=f.objectMode?1:a.length,f.length+=v,g=f.length<f.highWaterMark,g||(f.needDrain=!0),f.writing||f.corked?(v=f.lastBufferedRequest,f.lastBufferedRequest={chunk:a,encoding:b,isBuf:d,callback:c,next:null},v?v.next=f.lastBufferedRequest:
...
"\n"===e?(this.line++,this.column=0):this.column++);switch(this.state){case u.BEGIN:this.state=u.BEGIN_WHITESPACE;if("\ufeff"===e)continue;R(this,e);continue;case u.BEGIN_WHITESPACE:R(this,e);continue;case u.TEXT:if(this.sawRoot&&!this.closedRoot){for(var v=d-1;e&&"<"!==e&&"&"!==e;)(e=K(c,d++))&&this.trackPosition&&(this.position++,"\n"===e?(this.line++,this.column=0):this.column++);this.textNode+=c.substring(v,d-1)}"<"!==e||this.sawRoot&&this.closedRoot&&!this.strict?(r(z,e)||this.sawRoot&&!this.closedRoot||
...
else if(r(z,e))continue;else r(V,e)?this.tagName=e:this.script?(this.script+="</"+e,this.state=u.SCRIPT):f(this,"Invalid tagname in closing tag.");continue;case u.CLOSE_TAG_SAW_WHITE:if(r(z,e))continue;">"===e?F(this):f(this,"Invalid characters in closing tag");continue;case u.TEXT_ENTITY:case u.ATTRIB_VALUE_ENTITY_Q:case u.ATTRIB_VALUE_ENTITY_U:switch(this.state){case u.TEXT_ENTITY:var M=u.TEXT;var S="textNode";break;case u.ATTRIB_VALUE_ENTITY_Q:M=u.ATTRIB_VALUE_QUOTED;S="attribValue";break;case u.ATTRIB_VALUE_ENTITY_U:M=
u.ATTRIB_VALUE_UNQUOTED,S="attribValue"}";"===e?(this[S]+=y(this),this.entity="",this.state=M):r(this.entity.length?Y:aa,e)?this.entity+=e:(f(this,"Invalid character in entity name"),this[S]+="&"+this.entity+e,this.entity="",this.state=M);continue;default:throw Error(this,"Unknown state: "+this.state);}}if(this.position>=this.bufferCheckPosition){c=Math.max(g.MAX_BUFFER_LENGTH,10);e=d=0;for(M=E.length;e<M;e++){S=this[E[e]].length;if(S>c)switch(E[e]){case "textNode":h(this);break;case "cdata":b(this,
"oncdata",this.cdata);this.cdata="";break;case "script":b(this,"onscript",this.script);this.script="";break;default:q(this,"Max buffer length exceeded: "+E[e])}d=Math.max(d,S)}this.bufferCheckPosition=g.MAX_BUFFER_LENGTH-d+this.position}return this},resume:function(){this.error=null;return this},close:function(){return this.write(null)},flush:function(){h(this);""!==this.cdata&&(b(this,"oncdata",this.cdata),this.cdata="");""!==this.script&&(b(this,"onscript",this.script),this.script="")}};try{var P=
d("stream").Stream}catch(T){P=function(){}}var H=g.EVENTS.filter(function(a){return"error"!==a&&"end"!==a});p.prototype=Object.create(P.prototype,{constructor:{value:p}});p.prototype.write=function(a){"function"===typeof c&&"function"===typeof c.isBuffer&&c.isBuffer(a)&&(this._decoder||(this._decoder=new (d("string_decoder").StringDecoder)("utf8")),a=this._decoder.write(a));this._parser.write(a.toString());this.emit("data",a);return!0};p.prototype.end=function(a){a&&a.length&&this.write(a);this._parser.end();
return!0};p.prototype.on=function(a,b){var c=this;c._parser["on"+a]||-1===H.indexOf(a)||(c._parser["on"+a]=function(){var b=1===arguments.length?[arguments[0]]:Array.apply(null,arguments);b.splice(0,0,a);c.emit.apply(c,b)});return P.prototype.on.call(c,a,b)};var z="\r\n\t ",L="0124356789",N="abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ",G="'\"",A=z+">",W="[CDATA[",k="DOCTYPE",I="http://www.w3.org/XML/1998/namespace",e="http://www.w3.org/2000/xmlns/",t={xml:I,xmlns:e};z=m(z);L=m(L);N=m(N);
...
this.src=a;this.type=b}function y(a){this.id=a}function w(a){this.regionID=a}function K(a){this.styleAttrs=a}function E(a){this.sets=a}function P(a){this.contents=a}function H(a,b,c){this.explicit_begin=a;this.explicit_end=b;this.explicit_dur=c}function z(){this.kind="body"}function L(){this.kind="div"}function N(){this.kind="p"}function G(){this.kind="span"}function A(){this.kind="span"}function W(){this.kind="br"}function k(){}function I(){}function e(a){var b=null;a&&(a=a.attributes["xml:id"]||
...
null!==(k=e.exec(c))&&null!==b&&(l=3600*parseInt(k[1])+60*parseInt(k[2])+parseInt(k[3])+(null===k[4]?0:parseInt(k[4])/b));return l}function u(a,b,c){for(;0<b.styleRefs.length;){var f=b.styleRefs.pop();f in a.styles?(u(a,a.styles[f],c),T(a.styles[f].styleAttrs,b.styleAttrs)):J(c,"Non-existant style id referenced")}}function X(a,b,c,f){for(var e=b.length-1;0<=e;e--){var d=b[e];d in a.styles?T(a.styles[d].styleAttrs,c):J(f,"Non-existant style id referenced")}}function T(a,b){for(var c in a)c in b||(b[c]=
a[c])}function U(a,b){if(a&&a.warn&&a.warn(b))throw b;}function J(a,b){if(a&&a.error&&a.error(b))throw b;}function O(a,b){a&&a.fatal&&a.fatal(b);throw b;}function ba(a,b){for(var c=0,f=a.length-1,e;c<=f;){e=Math.floor((c+f)/2);var d=a[e];if(d<b)c=e+1;else if(d>b)f=e-1;else return{found:!0,index:e}}return{found:!1,index:c}}c.fromXML=function(c,e,m){var t=d.parser(!0,{xmlns:!0}),x=[],E=[],M=[],Z=0,y=null;t.onclosetag=function(a){if(x[0]instanceof f)for(var b in x[0].styles)u(x[0],x[0].styles[b],e);
else if(x[0]instanceof N||x[0]instanceof G){if(1<x[0].contents.length){a=[x[0].contents[0]];for(b=1;b<x[0].contents.length;b++)x[0].contents[b]instanceof A&&a[a.length-1]instanceof A?a[a.length-1].text+=x[0].contents[b].text:a.push(x[0].contents[b]);x[0].contents=a}x[0]instanceof G&&1===x[0].contents.length&&x[0].contents[0]instanceof A&&(x[0].text=x[0].contents[0].text,delete x[0].contents)}else if(x[0]instanceof D)if(x[0].node.uri===l.ns_tt&&"metadata"===x[0].node.local)Z--;else if(0<Z&&m&&"onCloseTag"in
m)m.onCloseTag();M.shift();E.shift();x.shift()};t.ontext=function(a){if(void 0!==x[0])if(x[0]instanceof G||x[0]instanceof N){if(x[0]instanceof G){var b=x[0].styleAttrs[p.byName.ruby.qname];if("container"===b||"textContainer"===b||"baseContainer"===b)return}b=new A;b.initFromText(y,x[0],a,M[0],e);x[0].contents.push(b)}else if(x[0]instanceof D&&0<Z&&m&&"onText"in m)m.onText(a)};t.onopentag=function(b){function c(a){l.ttaf_map[a.uri]&&(a.uri=l.ttaf_map[a.uri])}var d=b.attributes["xml:space"];d?M.unshift(d.value):
0===M.length?M.unshift("default"):M.unshift(M[0]);(d=b.attributes["xml:lang"])?E.unshift(d.value):0===E.length?E.unshift(""):E.unshift(E[0]);c(b);if(b.attributes)for(var h in b.attributes)b.attributes.hasOwnProperty(h)&&c(b.attributes[h]);if(b.uri===l.ns_tt)if("tt"===b.local)null!==y&&O(e,"Two <tt> elements at ("+this.line+","+this.column+")"),y=new q,y.initFromNode(b,e),x.unshift(y);else if("head"===b.local)x[0]instanceof q||O(e,"Parent of <head> element is not <tt> at ("+this.line+","+this.column+
...
c.attributes?c.attributes.type.value:null)||J(f,"Invalid image@type attribute");K.prototype.initFromNode.call(this,a,b,c,f);H.prototype.initFromNode.call(this,a,b,c,f);E.prototype.initFromNode.call(this,a,b,c,f);w.prototype.initFromNode.call(this,a,b,c,f)};y.prototype.initFromNode=function(a,b,c,f){this.id=e(c)};w.prototype.initFromNode=function(a,b,c,f){this.regionID=c&&"region"in c.attributes?c.attributes.region.value:""};K.prototype.initFromNode=function(a,b,c,f){this.styleAttrs=V(c,f);null!==
a.head&&null!==a.head.styling&&X(a.head.styling,t(c),this.styleAttrs,f)};E.prototype.initFromNode=function(a,b,c,f){this.sets=[]};P.prototype.initFromNode=function(a,b,c,f){this.contents=[]};H.prototype.initFromNode=function(a,b,c,f){b=null;c&&"begin"in c.attributes&&(b=Y(a.tickRate,a.effectiveFrameRate,c.attributes.begin.value),null===b&&U(f,"Malformed begin value "+c.attributes.begin.value+" (using 0)"));var e=null;c&&"dur"in c.attributes&&(e=Y(a.tickRate,a.effectiveFrameRate,c.attributes.dur.value),
...
function(a,b,c){K.prototype.initFromNode.call(this,a,null,b,c);H.prototype.initFromNode.call(this,a,null,b,c);E.prototype.initFromNode.call(this,a,null,b,c);w.prototype.initFromNode.call(this,a,null,b,c);P.prototype.initFromNode.call(this,a,null,b,c)};L.prototype.initFromNode=function(a,b,c,f){K.prototype.initFromNode.call(this,a,b,c,f);H.prototype.initFromNode.call(this,a,b,c,f);E.prototype.initFromNode.call(this,a,b,c,f);w.prototype.initFromNode.call(this,a,b,c,f);P.prototype.initFromNode.call(this,
a,b,c,f)};N.prototype.initFromNode=function(a,b,c,f){K.prototype.initFromNode.call(this,a,b,c,f);H.prototype.initFromNode.call(this,a,b,c,f);E.prototype.initFromNode.call(this,a,b,c,f);w.prototype.initFromNode.call(this,a,b,c,f);P.prototype.initFromNode.call(this,a,b,c,f)};G.prototype.initFromNode=function(a,b,c,f,e){K.prototype.initFromNode.call(this,a,b,c,e);H.prototype.initFromNode.call(this,a,b,c,e);E.prototype.initFromNode.call(this,a,b,c,e);w.prototype.initFromNode.call(this,a,b,c,e);P.prototype.initFromNode.call(this,
a,b,c,e);this.space=f};A.prototype.initFromText=function(a,b,c,f,e){H.prototype.initFromNode.call(this,a,b,null,e);this.text=c;this.space=f};W.prototype.initFromNode=function(a,b,c,f){w.prototype.initFromNode.call(this,a,b,c,f);H.prototype.initFromNode.call(this,a,b,c,f)};k.prototype.createDefaultRegion=function(a,b){var c=new k;c.id="";K.prototype.initFromNode.call(c,a,null,{name:"region",attributes:{"tts:displayAlign":{name:"tts:displayAlign",value:"after",prefix:"tts",local:"displayAlign",uri:"http://www.w3.org/ns/ttml#styling"},
...
itts:"http://www.w3.org/ns/ttml/profile/imsc1#styling",ttm:"http://www.w3.org/ns/ttml#metadata",ttp:"http://www.w3.org/ns/ttml#parameter",tts:"http://www.w3.org/ns/ttml#styling",xml:"http://www.w3.org/XML/1998/namespace"},prefix:"",local:"region",uri:"http://www.w3.org/ns/ttml",isSelfClosing:!0},b);c.sets=[];H.call(c,0,Number.POSITIVE_INFINITY,null);return c};k.prototype.initFromNode=function(a,b,c){y.prototype.initFromNode.call(this,a,null,b,c);K.prototype.initFromNode.call(this,a,null,b,c);H.prototype.initFromNode.call(this,
a,null,b,c);E.prototype.initFromNode.call(this,a,null,b,c);null!==a.head&&null!==a.head.styling&&X(a.head.styling,t(b),this.styleAttrs,c)};I.prototype.initFromNode=function(a,b,c,f){H.prototype.initFromNode.call(this,a,b,c,f);a=V(c,f);this.value=this.qname=null;for(var e in a){if(this.qname){J(f,"More than one style specified on set");break}this.qname=e;this.value=a[e]}}})("undefined"===typeof m?this.imscDoc={}:m,"undefined"===typeof sax?d("sax"):sax,"undefined"===typeof imscNames?d("./names"):imscNames,
...
p.length;v++){E=0===v?B:v===p.length?c:(p[v].before+p[v-1].after)/2;if(0<v)for(var H=0;H<p[v-1].elements.length;H++)if(null!==p[v-1].elements[H].bgcolor){var z=p[v-1].elements[H];0>h*(z.after-E)&&(w=Math.ceil(Math.abs(E-z.after))+"px",z.node.style.backgroundColor=z.bgcolor,"lr"===a.bpd?z.node.style.paddingRight=w:"rl"===a.bpd?z.node.style.paddingLeft=w:"tb"===a.bpd&&(z.node.style.paddingBottom=w))}if(v<p.length)for(H=0;H<p[v].elements.length;H++)z=p[v].elements[H],null!==z.bgcolor&&0<h*(z.before-
...
new p.ComputedLength(.5*z.rw,.5*z.rh));for(var A in l.all)(C=l.all[A],C.qname in f.styleAttrs||C.qname===l.byName.position.qname&&l.byName.origin.qname in f.styleAttrs||C.qname===l.byName.origin.qname&&l.byName.position.qname in f.styleAttrs||(v=a.head.styling.initials[C.qname]||C.initial,"region"!==f.kind&&(!1!==C.inherit||null===v)))||(f.styleAttrs[C.qname]=C.parse(v),n[C.qname]=!0);for(var R in l.all)if(A=l.all[R],A.qname in n&&null!==A.compute)if(C=A.compute(a,r,f,f.styleAttrs[A.qname],K),null!==
C)f.styleAttrs[A.qname]=C;else if(f.styleAttrs[A.qname]=A.compute(a,r,f,A.parse(A.initial),K),A="Style '"+A.qname+"' on element '"+f.kind+"' cannot be computed",B&&B.error&&B.error(A))throw A;if("none"===f.styleAttrs[l.byName.display.qname])return null;if(null===r)var k=null===h?[]:[h];else"contents"in y&&(k=y.contents);for(var I in k)r=g(a,c,d,h,f,w,k[I],B,K),null!==r&&f.contents.push(r.element);for(var e in f.styleAttrs)a=!1,"span"===f.kind&&(c=f.styleAttrs[l.byName.ruby.qname],(a=("container"===
...
a.contents.length}}function h(a){this.contents=[];this.aspectRatio=a.aspectRatio}function D(a){this.kind=a.kind||"region";a.id&&(this.id=a.id);this.styleAttrs={};for(var b in a.styleAttrs)this.styleAttrs[b]=a.styleAttrs[b];"src"in a&&(this.src=a.src);"type"in a&&(this.type=a.type);if("text"in a)this.text=a.text;else if("region"===this.kind||"contents"in a)this.contents=[];"space"in a&&(this.space=a.space)}c.generateISD=function(a,b,c){var d=new h(a),f={},l={},q=[];for(m in a.body)l[m]=a.body[m];l.contents=
[];a.body.contents.forEach(function(a,c){var d=a.contents.filter(function(a){return b<a.begin||b>=a.end?!1:(a.regionID&&q.push(a.regionID),!0)}),f={},h;for(h in a)f[h]=a[h];f.contents=d;l.contents[c]=f});for(var p in q){var m=g(a,b,a.head.layout.regions[q[p]],l,null,"",a.head.layout.regions[q[p]],c,f);null!==m&&d.contents.push(m.element)}return d};var q=[l.byName.color.qname,l.byName.textCombine.qname,l.byName.textDecoration.qname,l.byName.textEmphasis.qname,l.byName.textOutline.qname,l.byName.textShadow.qname]})("undefined"===
