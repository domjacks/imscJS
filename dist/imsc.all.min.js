...
var z=k[r].elements[k[r].end_elem];if(C===z){var y=C.node.getBoundingClientRect();if(0==y.width||0==y.height)continue}"lr"===b.ipd?(C.node.style.marginLeft=w,C.node.style.paddingLeft=m):"rl"===b.ipd?(C.node.style.paddingRight=m,C.node.style.marginRight=w):"tb"===b.ipd&&(C.node.style.paddingTop=m,C.node.style.marginTop=w);"lr"===b.ipd?(z.node.style.marginRight=w,z.node.style.paddingRight=m):"rl"===b.ipd?(z.node.style.paddingLeft=m,z.node.style.marginLeft=w):"tb"===b.ipd&&(z.node.style.paddingBottom=
m,z.node.style.marginBottom=w)}"tb"===b.bpd?(b.removePaddingElement.style.paddingLeft=0,b.removePaddingElement.style.paddingRight=0):(b.removePaddingElement.style.paddingTop=0,b.removePaddingElement.style.paddingBottom=0);b.lp=null}for(l=0;l<k.length;l++)for(r=k[l],m=1;m<r.elements.length;){w=r.elements[m-1].node;C=r.elements[m].node;if("SPAN"===w.tagName&&"SPAN"===C.tagName&&w._isd_element===C._isd_element){w.textContent+=C.textContent;for(z=0;z<C.style.length;z++)if(y=C.style[z],0<=y.indexOf("border")||
0<=y.indexOf("padding")||0<=y.indexOf("margin"))w.style[y]=C.style[y];C.parentElement.removeChild(C);w=!0}else w=!1;w?r.elements.splice(m,1):m++}l=[];for(w=0;w<k.length;w++)for(C=0;C<k[w].elements.length;C++)if(r=k[w].elements[C].node,m=d(r,l,!1))r.style.backgroundColor=m;for(r=0;r<l.length;r++)l[r].style.backgroundColor="";if(b.flg){r=u(c.getBoundingClientRect(),b);l=r.before;r=r.after;m=Math.sign(r-l);for(w=0;w<=k.length;w++){C=0===w?Math.round(l):w===k.length?Math.round(r):Math.round((k[w-1].after+
k[w].before)/2);if(0<w&&k[w-1])for(y=0;y<k[w-1].elements.length;y++){var G=k[w-1].elements[y];z=m*(C-G.after)+"px";"lr"===b.bpd?G.node.style.paddingRight=z:"rl"===b.bpd?G.node.style.paddingLeft=z:"tb"===b.bpd&&(G.node.style.paddingBottom=z)}if(w<k.length)for(y=0;y<k[w].elements.length;y++)G=k[w].elements[y],z=m*(G.before-C)+"px","lr"===b.bpd?G.node.style.paddingLeft=z:"rl"===b.bpd?G.node.style.paddingRight=z:"tb"===b.bpd&&(G.node.style.paddingTop=z)}b.flg=null}}"region"===n.kind&&"tb"===b.bpd&&b.enableRollUp&&
0<n.contents.length&&"after"===n.styleAttrs[a.byName.displayAlign.qname]&&(h(b,c,k,null),n=new t(""===n.id?"_":n.id,k),b.currentISDState[n.id]=n,b.previousISDState&&n.id in b.previousISDState&&0<b.previousISDState[n.id].plist.length&&1<n.plist.length&&n.plist[n.plist.length-2].text===b.previousISDState[n.id].plist[b.previousISDState[n.id].plist.length-1].text&&(b=g.firstElementChild,n=n.plist[n.plist.length-1].after-n.plist[n.plist.length-1].before,b.style.bottom="-"+n+"px",b.style.transition="transform 0.4s",
b.style.position="relative",b.style.transform="translateY(-"+n+"px)"))}else if(b=b.errorHandler,n="Error processing ISD element kind: "+n.kind,b&&b.error&&b.error(n))throw n;}function d(a,c,n){if(a.style.backgroundColor)return n&&!c.includes(a)&&c.push(a),a.style.backgroundColor;if("SPAN"===a.parentElement.nodeName)return d(a.parentElement,c,!0)}function t(a,d){this.id=a;this.plist=d}function u(a,d){var b={before:null,after:null,start:null,end:null};"tb"===d.bpd?(b.before=a.top,b.after=a.bottom,"lr"===
d.ipd?(b.start=a.left,b.end=a.right):(b.start=a.right,b.end=a.left)):"lr"===d.bpd?(b.before=a.left,b.after=a.right,b.start=a.top,b.end=a.bottom):"rl"===d.bpd&&(b.before=a.right,b.after=a.left,b.start=a.top,b.end=a.bottom);return b}function h(a,d,c,k){if("rt"!==d.localName&&"rtc"!==d.localName)if(k=d.style.backgroundColor||k,0===d.childElementCount)if("span"===d.localName||"rb"===d.localName){var b=d.getBoundingClientRect();a=u(b,a);if(!(b=0===c.length)){b=a.before;var n=a.after,l=c[c.length-1].before,
g=c[c.length-1].after;b=!(n<g&&b>l||g<=n&&l>=b)}b?c.push({before:a.before,after:a.after,start:a.start,end:a.end,start_elem:0,end_elem:0,elements:[],rbc:[],te:[],text:"",br:!1}):(b=Math.sign(a.after-a.before),n=Math.sign(a.end-a.start),0>b*(a.before-c[c.length-1].before)&&(c[c.length-1].before=a.before),0<b*(a.after-c[c.length-1].after)&&(c[c.length-1].after=a.after),0>n*(a.start-c[c.length-1].start)&&(c[c.length-1].start=a.start,c[c.length-1].start_elem=c[c.length-1].elements.length),0<n*(a.end-c[c.length-
1].end)&&(c[c.length-1].end=a.end,c[c.length-1].end_elem=c[c.length-1].elements.length));c[c.length-1].text+=d.textContent;c[c.length-1].elements.push({node:d,bgcolor:k,before:a.before,after:a.after})}else"br"===d.localName&&0!==c.length&&(c[c.length-1].br=!0);else for(d=d.firstChild;d;)d.nodeType===Node.ELEMENT_NODE&&(h(a,d,c,k),"ruby"===d.localName||"rtc"===d.localName?0<c.length&&c[c.length-1].rbc.push(d):"span"===d.localName&&d.style[z]&&"none"!==d.style[z]&&0<c.length&&c[c.length-1].te.push(d)),
d=d.nextSibling}function v(a,d,c,k){"none"!==k.style&&(d.style[z]="auto"===k.style?"filled":k.style+" "+k.symbol,"before"===k.position||"after"===k.position)&&(d.style[H]="tb"===a.bpd?"before"===k.position?"left over":"left under":"rl"===a.bpd?"before"===k.position?"right under":"left under":"before"===k.position?"left under":"right under")}function r(a,d){this.qname=a;this.map=d}c.render=function(a,d,c,k,h,g,t,u,r,m){k=k||d.clientHeight;var b=h||d.clientWidth;null!==a.aspectRatio&&(h=k*a.aspectRatio,
h>b?k=Math.round(b/a.aspectRatio):b=h);h=document.createElement("div");h.style.position="relative";h.style.width=b+"px";h.style.height=k+"px";h.style.margin="auto";h.style.top=0;h.style.bottom=0;h.style.left=0;h.style.right=0;h.style.zIndex=0;c={h:k,w:b,regionH:null,regionW:null,imgResolver:c,displayForcedOnlyMode:g||!1,isd:a,errorHandler:t,previousISDState:u,enableRollUp:r||!1,currentISDState:{},flg:null,lp:null,mra:null,ipd:null,bpd:null,ruby:null,textEmphasis:null,rubyReserve:null,options:Object.assign({},
m)||{}};c.options.colorAdjust&&(c.options.colorAdjust=l(c.options.colorAdjust));g=["region","body","div","p","span"];for(var n in g)g.hasOwnProperty(n)&&(t=g[n]+"BackgroundColorAdjust",c.options[t]&&(c.options[t]=l(c.options[t])));d.appendChild(h);if("contents"in a)for(d=0;d<a.contents.length;d++)p(c,h,a.contents[d],a);return c.currentISDState};var x=[new r("http://www.w3.org/ns/ttml#styling backgroundColor",function(a,d,c,k){(c=(c=a.options[c.kind+"BackgroundColorAdjust"])&&c[k.toString()])&&(k=
c);c=k[3];0!==c&&(void 0!=a.options.backgroundOpacityScale&&(c*=a.options.backgroundOpacityScale),d.style.backgroundColor="rgba("+k[0].toString()+","+k[1].toString()+","+k[2].toString()+","+(c/255).toString()+")")}),new r("http://www.w3.org/ns/ttml#styling color",function(a,d,c,k){c=a.options.colorOpacityScale||1;a=a.options.colorAdjust;void 0!=a&&(a=a[k.toString()])&&(k=a);d.style.color="rgba("+k[0].toString()+","+k[1].toString()+","+k[2].toString()+","+(c*k[3]/255).toString()+")"}),new r("http://www.w3.org/ns/ttml#styling direction",
function(a,d,c,k){d.style.direction=k}),new r("http://www.w3.org/ns/ttml#styling display",function(a,d,c,k){}),new r("http://www.w3.org/ns/ttml#styling displayAlign",function(a,d,c,k){d.style.display="flex";d.style.flexDirection="column";"before"===k?d.style.justifyContent="flex-start":"center"===k?d.style.justifyContent="center":"after"===k&&(d.style.justifyContent="flex-end")}),new r("http://www.w3.org/ns/ttml#styling extent",function(a,d,c,k){a.regionH=k.h.toUsedLength(a.w,a.h);a.regionW=k.w.toUsedLength(a.w,
a.h);var b=k=0;if(c=c.styleAttrs["http://www.w3.org/ns/ttml#styling padding"])k=c[0].toUsedLength(a.w,a.h)+c[2].toUsedLength(a.w,a.h),b=c[1].toUsedLength(a.w,a.h)+c[3].toUsedLength(a.w,a.h);d.style.height=a.regionH-k+"px";d.style.width=a.regionW-b+"px"}),new r("http://www.w3.org/ns/ttml#styling fontFamily",function(a,d,c,k){c=[];a.options.fontFamily&&(k=a.options.fontFamily.split(","));for(a=0;a<k.length;a++)k[a]=k[a].trim(),"monospaceSerif"===k[a]?(c.push("Courier New"),c.push('"Liberation Mono"'),
c.push("Courier"),c.push("monospace")):"proportionalSansSerif"===k[a]||"default"===k[a]?(c.push("Arial"),c.push("Helvetica"),c.push('"Liberation Sans"'),c.push("sans-serif")):"monospace"===k[a]?c.push("monospace"):"sansSerif"===k[a]?c.push("sans-serif"):"serif"===k[a]?c.push("serif"):"monospaceSansSerif"===k[a]?(c.push("Consolas"),c.push("monospace")):"proportionalSerif"===k[a]?c.push("serif"):c.push(k[a]);if(0<c.length){k=[c[0]];for(a=1;a<c.length;a++)-1==k.indexOf(c[a])&&k.push(c[a]);c=k}d.style.fontFamily=
c.join(",")}),new r("http://www.w3.org/ns/ttml#styling shear",function(a,d,c,k){0!==k&&(c=-.9*k,d.style.transform="tb"===a.bpd?"skewX("+c+"deg)":"skewY("+c+"deg)")}),new r("http://www.w3.org/ns/ttml#styling fontSize",function(a,d,c,k){d.style.fontSize=k.multiply(k.toUsedLength(a.w,a.h),a.options.sizeAdjust)+"px"}),new r("http://www.w3.org/ns/ttml#styling fontStyle",function(a,d,c,k){d.style.fontStyle=k}),new r("http://www.w3.org/ns/ttml#styling fontWeight",function(a,d,c,k){d.style.fontWeight=k}),
new r("http://www.w3.org/ns/ttml#styling lineHeight",function(a,d,c,k){d.style.lineHeight="normal"===k?"normal":k.multiply(k.multiply(k.toUsedLength(a.w,a.h),a.options.sizeAdjust),a.options.lineHeightAdjust)+"px"}),new r("http://www.w3.org/ns/ttml#styling opacity",function(a,d,c,k){c=k;void 0!=a.options.regionOpacityScale&&(c*=a.options.regionOpacityScale);d.style.opacity=c}),new r("http://www.w3.org/ns/ttml#styling origin",function(a,d,c,k){d.style.top=k.h.toUsedLength(a.w,a.h)+"px";d.style.left=
k.w.toUsedLength(a.w,a.h)+"px"}),new r("http://www.w3.org/ns/ttml#styling overflow",function(a,d,c,k){d.style.overflow=k}),new r("http://www.w3.org/ns/ttml#styling padding",function(a,d,c,k){c=[];c[0]=k[0].toUsedLength(a.w,a.h)+"px";c[1]=k[3].toUsedLength(a.w,a.h)+"px";c[2]=k[2].toUsedLength(a.w,a.h)+"px";c[3]=k[1].toUsedLength(a.w,a.h)+"px";d.style.padding=c.join(" ")}),new r("http://www.w3.org/ns/ttml#styling position",function(a,d,c,k){d.style.top=k.h.toUsedLength(a.w,a.h)+"px";d.style.left=k.w.toUsedLength(a.w,
a.h)+"px"}),new r("http://www.w3.org/ns/ttml#styling rubyAlign",function(a,d,c,k){d.style.rubyAlign="spaceAround"===k?"space-around":"center"}),new r("http://www.w3.org/ns/ttml#styling rubyPosition",function(a,d,c,k){if("before"===k||"after"===k)d.parentElement.style[D]=F?k:"tb"===a.bpd?"before"===k?"over":"under":"rl"===a.bpd?"before"===k?"over":"under":"before"===k?"under":"over"}),new r("http://www.w3.org/ns/ttml#styling showBackground",null),new r("http://www.w3.org/ns/ttml#styling textAlign",
function(a,d,c,k){d.style.textAlign="start"===k?"rl"===a.ipd?"right":"left":"end"===k?"rl"===a.ipd?"left":"right":k}),new r("http://www.w3.org/ns/ttml#styling textDecoration",function(a,d,c,k){d.style.textDecoration=k.join(" ").replace("lineThrough","line-through")}),new r("http://www.w3.org/ns/ttml#styling textOutline",function(a,d,c,k){}),new r("http://www.w3.org/ns/ttml#styling textShadow",function(b,d,c,k){c=c.styleAttrs[a.byName.textOutline.qname];var h=b.options.textOutline;if(h)if("none"===
h)c=h;else{var l={};h=h.split(" ");if(0!==h.length&&2>=h.length){var g=m.parseColor(h[0]);l.color=g;null!==g&&h.shift();1===h.length&&(h=m.parseLength(h[0]))&&(l.thickness=h,c=l)}}if("none"===k&&"none"===c)d.style.textShadow="";else{l=[];"none"!==c&&(c="rgba("+c.color[0].toString()+","+c.color[1].toString()+","+c.color[2].toString()+","+(c.color[3]/255).toString()+")",l.push("1px 1px 1px "+c),l.push("-1px 1px 1px "+c),l.push("1px -1px 1px "+c),l.push("-1px -1px 1px "+c));if("none"!==k)for(c=0;c<k.length;c++)l.push(k[c].x_off.toUsedLength(b.w,
b.h)+"px "+k[c].y_off.toUsedLength(b.w,b.h)+"px "+k[c].b_radius.toUsedLength(b.w,b.h)+"px rgba("+k[c].color[0].toString()+","+k[c].color[1].toString()+","+k[c].color[2].toString()+","+(k[c].color[3]/255).toString()+")");d.style.textShadow=l.join(",")}}),new r("http://www.w3.org/ns/ttml#styling textCombine",function(a,d,c,k){d.style.textCombineUpright=k}),new r("http://www.w3.org/ns/ttml#styling textEmphasis",function(a,d,c,k){}),new r("http://www.w3.org/ns/ttml#styling unicodeBidi",function(a,d,c,
k){d.style.unicodeBidi="bidiOverride"===k?"bidi-override":k}),new r("http://www.w3.org/ns/ttml#styling visibility",function(a,d,c,k){d.style.visibility=k}),new r("http://www.w3.org/ns/ttml#styling wrapOption",function(a,d,c,k){d.style.whiteSpace="wrap"===k?"preserve"===c.space?"pre-wrap":"normal":"preserve"===c.space?"pre":"noWrap"}),new r("http://www.w3.org/ns/ttml#styling writingMode",function(a,d,c,k){if("lrtb"===k||"lr"===k)d.style.writingMode="horizontal-tb";else if("rltb"===k||"rl"===k)d.style.writingMode=
"horizontal-tb";else if("tblr"===k)d.style.writingMode="vertical-lr";else if("tbrl"===k||"tb"===k)d.style.writingMode="vertical-rl"}),new r("http://www.w3.org/ns/ttml#styling zIndex",function(a,d,c,k){d.style.zIndex=k}),new r("http://www.w3.org/ns/ttml/profile/imsc1#styling forcedDisplay",function(a,d,c,k){a.displayForcedOnlyMode&&!1===k&&(d.style.visibility="hidden")})];for(c=0;c<x.length;c++);var F="webkitRubyPosition"in window.getComputedStyle(document.documentElement),D=F?"webkitRubyPosition":
"rubyPosition",z="webkitTextEmphasisStyle"in window.getComputedStyle(document.documentElement)?"webkitTextEmphasisStyle":"textEmphasisStyle",H="webkitTextEmphasisPosition"in window.getComputedStyle(document.documentElement)?"webkitTextEmphasisPosition":"textEmphasisPosition"})("undefined"===typeof m?this.imscHTML={}:m,"undefined"===typeof imscNames?c("./names"):imscNames,"undefined"===typeof imscStyles?c("./styles"):imscStyles,"undefined"===typeof imscUtils?c("./utils"):imscUtils)},{"./names":31,
"./styles":32,"./utils":33}],29:[function(c,v,m){(function(c,g,a,m){function l(c,g,u,v,x,y,b,C,n){if(g<b.begin||g>=b.end)return null;y="regionID"in b&&""!==b.regionID?b.regionID:y;if(null!==x&&y!==u.id&&(!("contents"in b)||"contents"in b&&0===b.contents.length||""!==y))return null;var k=new h(b);if("sets"in b)for(var r=0;r<b.sets.length;r++)g<b.sets[r].begin||g>=b.sets[r].end||(k.styleAttrs[b.sets[r].qname]=b.sets[r].value);r={};for(var z in k.styleAttrs)if(k.styleAttrs.hasOwnProperty(z)&&(r[z]=!0,
"region"===k.kind&&z===a.byName.writingMode.qname&&!(a.byName.direction.qname in k.styleAttrs))){var B=k.styleAttrs[z];if("lrtb"===B||"lr"===B)k.styleAttrs[a.byName.direction.qname]="ltr";else if("rltb"===B||"rl"===B)k.styleAttrs[a.byName.direction.qname]="rtl"}if(null!==x)for(z=0;z<a.all.length;z++)if(B=a.all[z],B.qname===a.byName.textDecoration.qname){var D=x.styleAttrs[B.qname],G=k.styleAttrs[B.qname],E=[];void 0===G?E=D:-1===G.indexOf("none")?((-1===G.indexOf("noUnderline")&&-1!==D.indexOf("underline")||
-1!==G.indexOf("underline"))&&E.push("underline"),(-1===G.indexOf("noLineThrough")&&-1!==D.indexOf("lineThrough")||-1!==G.indexOf("lineThrough"))&&E.push("lineThrough"),(-1===G.indexOf("noOverline")&&-1!==D.indexOf("overline")||-1!==G.indexOf("overline"))&&E.push("overline")):E.push("none");k.styleAttrs[B.qname]=E}else B.qname!==a.byName.fontSize.qname||B.qname in k.styleAttrs||"span"!==k.kind||"textContainer"!==k.styleAttrs[a.byName.ruby.qname]?B.qname!==a.byName.fontSize.qname||B.qname in k.styleAttrs||
"span"!==k.kind||"text"!==k.styleAttrs[a.byName.ruby.qname]?B.inherit&&B.qname in x.styleAttrs&&!(B.qname in k.styleAttrs)&&(k.styleAttrs[B.qname]=x.styleAttrs[B.qname]):(D=x.styleAttrs[a.byName.fontSize.qname],k.styleAttrs[B.qname]="textContainer"===x.styleAttrs[a.byName.ruby.qname]?D:new m.ComputedLength(.5*D.rw,.5*D.rh)):(D=x.styleAttrs[a.byName.fontSize.qname],k.styleAttrs[B.qname]=new m.ComputedLength(.5*D.rw,.5*D.rh));for(z=0;z<a.all.length;z++)if(B=a.all[z],!(B.qname in k.styleAttrs||B.qname===
a.byName.position.qname&&a.byName.origin.qname in k.styleAttrs||B.qname===a.byName.origin.qname&&a.byName.position.qname in k.styleAttrs)&&(D=c.head.styling.initials[B.qname]||B.initial,null!==D&&("region"===k.kind||!1===B.inherit&&null!==D)))if(D=B.parse(D),null!==D)k.styleAttrs[B.qname]=D,r[B.qname]=!0;else if(B="Invalid initial value for '"+B.qname+"' on element '"+k.kind,C&&C.error&&C.error(B))throw B;for(z=0;z<a.all.length;z++)if(B=a.all[z],B.qname in r&&null!==B.compute)if(D=B.compute(c,x,k,
k.styleAttrs[B.qname],n),null!==D)k.styleAttrs[B.qname]=D;else if(k.styleAttrs[B.qname]=B.compute(c,x,k,B.parse(B.initial),n),B="Style '"+B.qname+"' on element '"+k.kind+"' cannot be computed",C&&C.error&&C.error(B))throw B;if("none"===k.styleAttrs[a.byName.display.qname])return null;r=null;null===x?r=null===v?[]:[v]:"contents"in b&&(r=b.contents);for(x=0;null!==r&&x<r.length;x++)b=l(c,g,u,v,k,y,r[x],C,n),null!==b&&k.contents.push(b.element);for(var F in k.styleAttrs)k.styleAttrs.hasOwnProperty(F)&&
