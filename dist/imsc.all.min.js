...
1/d),w:new h.ComputedLength(1/f,0)};d=P(a,p.ns_ttp,"frameRate");b=30;null!==d&&(f=/(\d+)/.exec(d),null!==f?b=parseInt(f[1]):R(c,"Malformed frame rate attribute (using initial value instead)"));f=P(a,p.ns_ttp,"frameRateMultiplier");var n=1;null!==f&&(f=/(\d+) (\d+)/.exec(f),null!==f?n=parseInt(f[1])/parseInt(f[2]):R(c,"Malformed frame rate multiplier attribute (using initial value instead)"));b*=n;n=1;f=P(a,p.ns_ttp,"tickRate");null===f?null!==d&&(n=b):(f=/(\d+)/.exec(f),null!==f?n=parseInt(f[1]):
R(c,"Malformed tick rate attribute (using initial value instead)"));this.effectiveFrameRate=b;this.tickRate=n;f=P(a,p.ns_ittp,"aspectRatio");null===f&&(f=P(a,p.ns_ttp,"displayAspectRatio"));d=null;null!==f&&(b=/(\d+)\s+(\d+)/.exec(f),null!==b?(f=parseInt(b[1]),b=parseInt(b[2]),0!==f&&0!==b?d=f/b:L(c,"Illegal aspectRatio values (ignoring)")):L(c,"Malformed aspectRatio attribute (ignoring)"));this.aspectRatio=d;d=P(a,p.ns_ttp,"timeBase");null!==d&&"media"!==d&&O(c,"Unsupported time base");a=X(a,c);
...
R(d,"Malformed begin value "+b.attributes.begin.value+" (using 0)"));var f=null;b&&"dur"in b.attributes&&(f=V(a.tickRate,a.effectiveFrameRate,b.attributes.dur.value),null===f&&R(d,"Malformed dur value "+b.attributes.dur.value+" (ignoring)"));var n=null;b&&"end"in b.attributes&&(n=V(a.tickRate,a.effectiveFrameRate,b.attributes.end.value),null===n&&R(d,"Malformed end value (ignoring)"));this.explicit_begin=c;this.explicit_end=n;this.explicit_dur=f;(a=b&&"timeContainer"in b.attributes?b.attributes.timeContainer.value:
...
b,d,e){b.style.rubyAlign="spaceAround"===e?"space-around":"center"}),new h("http://www.w3.org/ns/ttml#styling rubyPosition",function(a,b,d,e){if("before"===e||"after"===e)b.parentElement.style[z]=F?e:"tb"===a.bpd?"before"===e?"over":"under":"rl"===a.bpd?"before"===e?"over":"under":"before"===e?"under":"over"}),new h("http://www.w3.org/ns/ttml#styling showBackground",null),new h("http://www.w3.org/ns/ttml#styling textAlign",function(a,b,d,e){b.style.textAlign="start"===e?"rl"===a.ipd?"right":"left":
"end"===e?"rl"===a.ipd?"left":"right":e}),new h("http://www.w3.org/ns/ttml#styling textDecoration",function(a,b,d,e){b.style.textDecoration=e.join(" ").replace("lineThrough","line-through")}),new h("http://www.w3.org/ns/ttml#styling textOutline",function(a,b,d,e){}),new h("http://www.w3.org/ns/ttml#styling textShadow",function(a,b,d,e){d=d.styleAttrs[p.byName.textOutline.qname];var c=a.options.textOutline;if(c)if("none"===c)d=c;else{var q={};c=c.split(" ");if(0!==c.length&&2>=c.length){var m=k.parseColor(c[0]);
q.color=m;null!==m&&c.shift();1===c.length&&(c=k.parseLength(c[0]))&&(q.thickness=c,d=q)}}if("none"===e&&"none"===d)b.style.textShadow="";else{q=[];"none"!==d&&(d="rgba("+d.color[0].toString()+","+d.color[1].toString()+","+d.color[2].toString()+","+(d.color[3]/255).toString()+")",q.push("1px 1px 1px "+d),q.push("-1px 1px 1px "+d),q.push("1px -1px 1px "+d),q.push("-1px -1px 1px "+d));if("none"!==e)for(var n in e)q.push(e[n].x_off.toUsedLength(a.w,a.h)+"px "+e[n].y_off.toUsedLength(a.w,a.h)+"px "+e[n].b_radius.toUsedLength(a.w,
a.h)+"px rgba("+e[n].color[0].toString()+","+e[n].color[1].toString()+","+e[n].color[2].toString()+","+(e[n].color[3]/255).toString()+")");b.style.textShadow=q.join(",")}}),new h("http://www.w3.org/ns/ttml#styling textCombine",function(a,b,d,e){b.style.textCombineUpright=e.join(" ")}),new h("http://www.w3.org/ns/ttml#styling textEmphasis",function(a,b,d,e){}),new h("http://www.w3.org/ns/ttml#styling unicodeBidi",function(a,b,d,e){b.style.unicodeBidi="bidiOverride"===e?"bidi-override":e}),new h("http://www.w3.org/ns/ttml#styling visibility",
...
"vertical-rl"}),new h("http://www.w3.org/ns/ttml#styling zIndex",function(a,b,d,e){b.style.zIndex=e}),new h("http://www.w3.org/ns/ttml/profile/imsc1#styling forcedDisplay",function(a,b,d,e){a.displayForcedOnlyMode&&!1===e&&(b.style.visibility="hidden")})],G;for(G in x);var F="webkitRubyPosition"in window.getComputedStyle(document.documentElement),z=F?"webkitRubyPosition":"rubyPosition",C="webkitTextEmphasisStyle"in window.getComputedStyle(document.documentElement)?"webkitTextEmphasisStyle":"textEmphasisStyle",
I="webkitTextEmphasisPosition"in window.getComputedStyle(document.documentElement)?"webkitTextEmphasisPosition":"textEmphasisPosition"})("undefined"===typeof k?this.imscHTML={}:k,"undefined"===typeof imscNames?d("./names"):imscNames,"undefined"===typeof imscStyles?d("./styles"):imscStyles,"undefined"===typeof imscUtils?d("./utils"):imscUtils)},{"./names":37,"./styles":38,"./utils":39}],35:[function(d,h,k){(function(b,d,h,k){function e(b,d,w,y,v,D,c,B,n){if(d<c.begin||d>=c.end)return null;D="regionID"in
c&&""!==c.regionID?c.regionID:D;if(null!==v&&D!==w.id&&(!("contents"in c)||"contents"in c&&0===c.contents.length||""!==D))return null;var m=new A(c);for(x in c.sets)d<c.sets[x].begin||d>=c.sets[x].end||(m.styleAttrs[c.sets[x].qname]=c.sets[x].value);var x={};for(var z in m.styleAttrs)if(x[z]=!0,"region"===m.kind&&z===h.byName.writingMode.qname&&!(h.byName.direction.qname in m.styleAttrs)){var C=m.styleAttrs[z];if("lrtb"===C||"lr"===C)m.styleAttrs[h.byName.direction.qname]="ltr";else if("rltb"===C||
"rl"===C)m.styleAttrs[h.byName.direction.qname]="rtl"}if(null!==v)for(var G in h.all)if(z=h.all[G],z.qname===h.byName.textDecoration.qname){C=v.styleAttrs[z.qname];var F=m.styleAttrs[z.qname],E=[];void 0===F?E=C:-1===F.indexOf("none")?((-1===F.indexOf("noUnderline")&&-1!==C.indexOf("underline")||-1!==F.indexOf("underline"))&&E.push("underline"),(-1===F.indexOf("noLineThrough")&&-1!==C.indexOf("lineThrough")||-1!==F.indexOf("lineThrough"))&&E.push("lineThrough"),(-1===F.indexOf("noOverline")&&-1!==
C.indexOf("overline")||-1!==F.indexOf("overline"))&&E.push("overline")):E.push("none");m.styleAttrs[z.qname]=E}else z.qname!==h.byName.fontSize.qname||z.qname in m.styleAttrs||"span"!==m.kind||"textContainer"!==m.styleAttrs[h.byName.ruby.qname]?z.qname!==h.byName.fontSize.qname||z.qname in m.styleAttrs||"span"!==m.kind||"text"!==m.styleAttrs[h.byName.ruby.qname]?z.inherit&&z.qname in v.styleAttrs&&!(z.qname in m.styleAttrs)&&(m.styleAttrs[z.qname]=v.styleAttrs[z.qname]):(C=v.styleAttrs[h.byName.fontSize.qname],
m.styleAttrs[z.qname]="textContainer"===v.styleAttrs[h.byName.ruby.qname]?C:new k.ComputedLength(.5*C.rw,.5*C.rh)):(C=v.styleAttrs[h.byName.fontSize.qname],m.styleAttrs[z.qname]=new k.ComputedLength(.5*C.rw,.5*C.rh));for(var I in h.all)if(G=h.all[I],!(G.qname in m.styleAttrs||G.qname===h.byName.position.qname&&h.byName.origin.qname in m.styleAttrs||G.qname===h.byName.origin.qname&&h.byName.position.qname in m.styleAttrs)&&(z=b.head.styling.initials[G.qname]||G.initial,null!==z&&("region"===m.kind||
!1===G.inherit&&null!==z)))if(z=G.parse(z),null!==z)m.styleAttrs[G.qname]=z,x[G.qname]=!0;else if(G="Invalid initial value for '"+G.qname+"' on element '"+m.kind,B&&B.error&&B.error(G))throw G;for(var g in h.all)if(I=h.all[g],I.qname in x&&null!==I.compute)if(G=I.compute(b,v,m,m.styleAttrs[I.qname],n),null!==G)m.styleAttrs[I.qname]=G;else if(m.styleAttrs[I.qname]=I.compute(b,v,m,I.parse(I.initial),n),I="Style '"+I.qname+"' on element '"+m.kind+"' cannot be computed",B&&B.error&&B.error(I))throw I;
if("none"===m.styleAttrs[h.byName.display.qname])return null;if(null===v)var r=null===y?[]:[y];else"contents"in c&&(r=c.contents);for(var f in r)v=e(b,d,w,y,m,D,r[f],B,n),null!==v&&m.contents.push(v.element);for(var l in m.styleAttrs)b=!1,"span"===m.kind&&(d=m.styleAttrs[h.byName.ruby.qname],(b=("container"===d||"textContainer"===d||"baseContainer"===d)&&-1!==u.indexOf(l))||(b="container"!==d&&l===h.byName.rubyAlign.qname),b||(b=!("textContainer"===d||"text"===d)&&l===h.byName.rubyPosition.qname)),
b||(b=-1===h.byQName[l].applies.indexOf(m.kind)),b&&delete m.styleAttrs[l];l=m.styleAttrs[h.byName.ruby.qname];if("p"===m.kind||"span"===m.kind&&("textContainer"===l||"text"===l))l=[],a(m,l),p(l),q(m);return"div"===m.kind&&h.byName.backgroundImage.qname in m.styleAttrs||"br"===m.kind||"image"===m.kind||"contents"in m&&0<m.contents.length||"span"===m.kind&&null!==m.text||"region"===m.kind&&"always"===m.styleAttrs[h.byName.showBackground.qname]?{region_id:D,element:m}:null}function p(a){function b(a){return"br"===
a.kind||/[\r\n\t ]$/.test(a.text)}function d(a){return"br"===a.kind||"preserve"===a.space&&/^[\r\n]/.test(a.text)}for(var e,h=0;h<a.length;)if(e=a[h],"br"===e.kind||"preserve"===e.space)h++;else{var q=e.text.replace(/[\t\r\n ]+/g," ");/^[ ]/.test(q)&&(0===h||b(a[h-1]))&&(q=q.substring(1));e.text=q;0===q.length?a.splice(h,1):h++}for(h=0;h<a.length;h++)e=a[h],"br"===e.kind||"preserve"===e.space?h++:/[ ]$/.test(e.text)&&(h===a.length-1||d(a[h+1]))&&(e.text=e.text.slice(0,-1))}function a(b,d){for(var e in b.contents){var q=
b.contents[e],k=q.styleAttrs[h.byName.ruby.qname];if("span"!==q.kind||"textContainer"!==k&&"text"!==k)"contents"in q?a(q,d):("span"===q.kind&&0!==q.text.length||"br"===q.kind)&&d.push(q)}}function q(a){if("br"===a.kind)return!1;if("text"in a)return 0===a.text.length;if("contents"in a){for(var b=a.contents.length;b--;)q(a.contents[b])&&a.contents.splice(b,1);return 0===a.contents.length}}function w(a){this.contents=[];this.aspectRatio=a.aspectRatio}function A(a){this.kind=a.kind||"region";a.id&&(this.id=
a.id);this.styleAttrs={};for(var b in a.styleAttrs)this.styleAttrs[b]=a.styleAttrs[b];"src"in a&&(this.src=a.src);"type"in a&&(this.type=a.type);if("text"in a)this.text=a.text;else if("region"===this.kind||"contents"in a)this.contents=[];"space"in a&&(this.space=a.space)}b.generateISD=function(a,b,d){var h=new w(a),q={},k;for(k in a.head.layout.regions){var c=e(a,b,a.head.layout.regions[k],a.body,null,"",a.head.layout.regions[k],d,q);null!==c&&h.contents.push(c.element)}return h};var u=[h.byName.color.qname,
h.byName.textCombine.qname,h.byName.textDecoration.qname,h.byName.textEmphasis.qname,h.byName.textOutline.qname,h.byName.textShadow.qname]})("undefined"===typeof k?this.imscISD={}:k,"undefined"===typeof imscNames?d("./names"):imscNames,"undefined"===typeof imscStyles?d("./styles"):imscStyles,"undefined"===typeof imscUtils?d("./utils"):imscUtils)},{"./names":37,"./styles":38,"./utils":39}],36:[function(d,h,k){k.generateISD=d("./isd").generateISD;k.fromXML=d("./doc").fromXML;k.renderHTML=d("./html").render},
{"./doc":33,"./html":34,"./isd":35}],37:[function(d,h,k){d="undefined"===typeof k?this.imscNames={}:k;d.ns_tt="http://www.w3.org/ns/ttml";d.ns_tts="http://www.w3.org/ns/ttml#styling";d.ns_ttp="http://www.w3.org/ns/ttml#parameter";d.ns_xml="http://www.w3.org/XML/1998/namespace";d.ns_itts="http://www.w3.org/ns/ttml/profile/imsc1#styling";d.ns_ittp="http://www.w3.org/ns/ttml/profile/imsc1#parameter";d.ns_smpte="http://www.smpte-ra.org/schemas/2052-1/2010/smpte-tt";d.ns_ebutts="urn:ebu:tt:style";d.ttaf_map=
{"http://www.w3.org/2006/10/ttaf1":d.ns_tt,"http://www.w3.org/2006/10/ttaf1#style":d.ns_tts,"http://www.w3.org/2006/10/ttaf1#parameter":d.ns_ttp}},{}],38:[function(d,h,k){(function(b,d,h){function e(a,b,d,e,h,k,p,u){this.name=b;this.ns=a;this.qname=a+" "+b;this.inherit=h;this.animatable=k;this.initial=d;this.applies=e;this.parse=p;this.compute=u}b.all=[new e(d.ns_tts,"backgroundColor","transparent",["body","div","p","region","span"],!1,!0,h.parseColor,null),new e(d.ns_tts,"color","white",["span"],
!0,!0,h.parseColor,null),new e(d.ns_tts,"direction","ltr",["p","span"],!0,!0,function(a){return a},null),new e(d.ns_tts,"display","auto",["body","div","p","region","span"],!1,!0,function(a){return a},null),new e(d.ns_tts,"displayAlign","before",["region"],!1,!0,function(a){return a},null),new e(d.ns_tts,"extent","auto",["tt","region"],!1,!0,function(a){if("auto"===a)return a;var b=a.split(" ");if(2!==b.length)return null;a=h.parseLength(b[0]);return(b=h.parseLength(b[1]))&&a?{h:b,w:a}:null},function(a,
b,d,e,k){if("auto"===e)b=new h.ComputedLength(0,1);else if(b=h.toComputedLength(e.h.value,e.h.unit,null,a.dimensions.h,null,a.pxLength.h),null===b)return null;if("auto"===e)a=new h.ComputedLength(1,0);else if(a=h.toComputedLength(e.w.value,e.w.unit,null,a.dimensions.w,null,a.pxLength.w),null===a)return null;return{h:b,w:a}}),new e(d.ns_tts,"fontFamily","default",["span"],!0,!0,function(a){a=a.split(",");var b=[],d;for(d in a)"'"!==a[d].charAt(0)&&'"'!==a[d].charAt(0)?"default"===a[d]?b.push("monospaceSerif"):
b.push(a[d]):b.push(a[d]);return b},null),new e(d.ns_tts,"shear","0%",["p"],!0,!0,h.parseLength,function(a,b,d,e){if("%"===e.unit)a=100<Math.abs(e.value)?100*Math.sign(e.value):e.value;else return null;return a}),new e(d.ns_tts,"fontSize","1c",["span"],!0,!0,h.parseLength,function(a,d,e,k,p){return h.toComputedLength(k.value,k.unit,null!==d?d.styleAttrs[b.byName.fontSize.qname]:a.cellLength.h,null!==d?d.styleAttrs[b.byName.fontSize.qname]:a.cellLength.h,a.cellLength.h,a.pxLength.h)}),new e(d.ns_tts,
"fontStyle","normal",["span"],!0,!0,function(a){return a},null),new e(d.ns_tts,"fontWeight","normal",["span"],!0,!0,function(a){return a},null),new e(d.ns_tts,"lineHeight","normal",["p"],!0,!0,function(a){return"normal"===a?a:h.parseLength(a)},function(a,d,e,k,p){if("normal"===k)a=k;else if(a=h.toComputedLength(k.value,k.unit,e.styleAttrs[b.byName.fontSize.qname],e.styleAttrs[b.byName.fontSize.qname],a.cellLength.h,a.pxLength.h),null===a)return null;return a}),new e(d.ns_tts,"opacity",1,["region"],
!1,!0,parseFloat,null),new e(d.ns_tts,"origin","auto",["region"],!1,!0,function(a){if("auto"===a)return a;var b=a.split(" ");if(2!==b.length)return null;a=h.parseLength(b[0]);return(b=h.parseLength(b[1]))&&a?{h:b,w:a}:null},function(a,b,d,e,k){if("auto"===e)b=new h.ComputedLength(0,0);else if(b=h.toComputedLength(e.h.value,e.h.unit,null,a.dimensions.h,null,a.pxLength.h),null===b)return null;if("auto"===e)a=new h.ComputedLength(0,0);else if(a=h.toComputedLength(e.w.value,e.w.unit,null,a.dimensions.w,
null,a.pxLength.w),null===a)return null;return{h:b,w:a}}),new e(d.ns_tts,"overflow","hidden",["region"],!1,!0,function(a){return a},null),new e(d.ns_tts,"padding","0px",["region"],!1,!0,function(a){a=a.split(" ");if(4<a.length)return null;var b=[],d;for(d in a){var e=h.parseLength(a[d]);if(!e)return null;b.push(e)}return b},function(a,d,e,k,p){if(1===k.length)d=[k[0],k[0],k[0],k[0]];else if(2===k.length)d=[k[0],k[1],k[0],k[1]];else if(3===k.length)d=[k[0],k[1],k[2],k[1]];else if(4===k.length)d=[k[0],
k[1],k[2],k[3]];else return null;k=e.styleAttrs[b.byName.writingMode.qname];if("lrtb"===k||"lr"===k)d=[d[0],d[3],d[2],d[1]];else if("rltb"===k||"rl"===k)d=[d[0],d[1],d[2],d[3]];else if("tblr"===k)d=[d[3],d[0],d[1],d[2]];else if("tbrl"===k||"tb"===k)d=[d[3],d[2],d[1],d[0]];else return null;k=[];for(var q in d)if(0===d[q].value)k[q]=new h.ComputedLength(0,0);else if(k[q]=h.toComputedLength(d[q].value,d[q].unit,e.styleAttrs[b.byName.fontSize.qname],"0"===q||"2"===q?e.styleAttrs[b.byName.extent.qname].h:
