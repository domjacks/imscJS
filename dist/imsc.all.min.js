...
k||"function"==k?g.has(d)?k=g.get(d):(k=""+ ++F,g.set(d,k)):k="p_"+d;var c=a.data_[k];if(c&&$jscomp.owns(a.data_,k))for(a=0;a<c.length;a++){var e=c[a];if(d!==d&&e.key!==e.key||d===e.key)return{id:k,list:c,index:a,entry:e}}return{id:k,list:c,index:-1,entry:void 0}},l=function(a,d){var c=a.head_;return $jscomp.iteratorPrototype(function(){if(c){for(;c.head!=a.head_;)c=c.previous;for(;c.next!=c.head;)return c=c.next,{done:!1,value:d(c)};c=null}return{done:!0,value:void 0}})},n=function(){var a={};return a.previous=
a.next=a.head=a},F=0;return a},"es6","es3");
$jscomp.polyfill("Set",function(e){function q(){if($jscomp.ASSUME_NO_NATIVE_SET||!e||"function"!=typeof e||!e.prototype.entries||"function"!=typeof Object.seal)return!1;try{var a=Object.seal({x:4}),c=new e($jscomp.makeIterator([a]));if(!c.has(a)||1!=c.size||c.add(a)!=c||1!=c.size||c.add({x:4})!=c||2!=c.size)return!1;var l=c.entries(),n=l.next();if(n.done||n.value[0]!=a||n.value[1]!=a)return!1;n=l.next();return n.done||n.value[0]==a||4!=n.value[0].x||n.value[1]!=n.value[0]?!1:l.next().done}catch(F){return!1}}
...
l[d>>12&63]+l[d>>6&63]+l[d&63]);return k.join("")}g.byteLength=function(c){c=a(c);var d=c[1];return 3*(c[0]+d)/4-d};g.toByteArray=function(c){var d=a(c);var k=d[0];d=d[1];var e=new F(3*(k+d)/4-d),l=0,b=0<d?k-4:k,h;for(h=0;h<b;h+=4)k=n[c.charCodeAt(h)]<<18|n[c.charCodeAt(h+1)]<<12|n[c.charCodeAt(h+2)]<<6|n[c.charCodeAt(h+3)],e[l++]=k>>16&255,e[l++]=k>>8&255,e[l++]=k&255;2===d&&(k=n[c.charCodeAt(h)]<<2|n[c.charCodeAt(h+1)]>>4,e[l++]=k&255);1===d&&(k=n[c.charCodeAt(h)]<<10|n[c.charCodeAt(h+1)]<<4|n[c.charCodeAt(h+
2)]>>2,e[l++]=k>>8&255,e[l++]=k&255);return e};g.fromByteArray=function(a){for(var d=a.length,k=d%3,e=[],n=0,b=d-k;n<b;n+=16383)e.push(c(a,n,n+16383>b?b:n+16383));1===k?(a=a[d-1],e.push(l[a>>2]+l[a<<4&63]+"==")):2===k&&(a=(a[d-2]<<8)+a[d-1],e.push(l[a>>10]+l[a>>4&63]+l[a<<2&63]+"="));return e.join("")};var l=[],n=[],F="undefined"!==typeof Uint8Array?Uint8Array:Array;for(e=0;64>e;++e)l[e]="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/"[e],n["ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charCodeAt(e)]=
e;n[45]=62;n[95]=63},{}],2:[function(e,q,g){},{}],3:[function(e,q,g){(function(a){function c(m){if(2147483647<m)throw new RangeError('The value "'+m+'" is invalid for option "size"');m=new Uint8Array(m);m.__proto__=a.prototype;return m}function a(m,a,f){if("number"===typeof m){if("string"===typeof a)throw new TypeError('The "string" argument must be of type string. Received type number');return F(m)}return l(m,a,f)}function l(m,b,f){if("string"===typeof m){var I=b;if("string"!==typeof I||""===I)I=
"utf8";if(!a.isEncoding(I))throw new TypeError("Unknown encoding: "+I);b=z(m,I)|0;f=c(b);m=f.write(m,I);m!==b&&(f=f.slice(0,m));return f}if(ArrayBuffer.isView(m))return t(m);if(null==m)throw TypeError("The first argument must be one of type string, Buffer, ArrayBuffer, Array, or Array-like Object. Received type "+typeof m);if(L(m,ArrayBuffer)||m&&L(m.buffer,ArrayBuffer)){if(0>b||m.byteLength<b)throw new RangeError('"offset" is outside of buffer bounds');if(m.byteLength<b+(f||0))throw new RangeError('"length" is outside of buffer bounds');
m=void 0===b&&void 0===f?new Uint8Array(m):void 0===f?new Uint8Array(m,b):new Uint8Array(m,b,f);m.__proto__=a.prototype;return m}if("number"===typeof m)throw new TypeError('The "value" argument must not be of type number. Received type number');I=m.valueOf&&m.valueOf();if(null!=I&&I!==m)return a.from(I,b,f);if(I=d(m))return I;if("undefined"!==typeof Symbol&&null!=Symbol.toPrimitive&&"function"===typeof m[Symbol.toPrimitive])return a.from(m[Symbol.toPrimitive]("string"),b,f);throw new TypeError("The first argument must be one of type string, Buffer, ArrayBuffer, Array, or Array-like Object. Received type "+
typeof m);}function n(m){if("number"!==typeof m)throw new TypeError('"size" argument must be of type number');if(0>m)throw new RangeError('The value "'+m+'" is invalid for option "size"');}function F(m){n(m);return c(0>m?0:k(m)|0)}function t(m){for(var a=0>m.length?0:k(m.length)|0,f=c(a),b=0;b<a;b+=1)f[b]=m[b]&255;return f}function d(m){if(a.isBuffer(m)){var b=k(m.length)|0,f=c(b);if(0===f.length)return f;m.copy(f,0,0,b);return f}if(void 0!==m.length)return(b="number"!==typeof m.length)||(b=m.length,
b=b!==b),b?c(0):t(m);if("Buffer"===m.type&&Array.isArray(m.data))return t(m.data)}function k(m){if(2147483647<=m)throw new RangeError("Attempt to allocate Buffer larger than maximum size: 0x"+(2147483647).toString(16)+" bytes");return m|0}function z(m,b){if(a.isBuffer(m))return m.length;if(ArrayBuffer.isView(m)||L(m,ArrayBuffer))return m.byteLength;if("string"!==typeof m)throw new TypeError('The "string" argument must be one of type string, Buffer, or ArrayBuffer. Received type '+typeof m);var f=
m.length,d=2<arguments.length&&!0===arguments[2];if(!d&&0===f)return 0;for(var H=!1;;)switch(b){case "ascii":case "latin1":case "binary":return f;case "utf8":case "utf-8":return J(m).length;case "ucs2":case "ucs-2":case "utf16le":case "utf-16le":return 2*f;case "hex":return f>>>1;case "base64":return O.toByteArray(B(m)).length;default:if(H)return d?-1:J(m).length;b=(""+b).toLowerCase();H=!0}}function w(m,a,f){var b=!1;if(void 0===a||0>a)a=0;if(a>this.length)return"";if(void 0===f||f>this.length)f=
...
case "base64":return a=0===a&&f===this.length?O.fromByteArray(this):O.fromByteArray(this.slice(a,f)),a;case "ucs2":case "ucs-2":case "utf16le":case "utf-16le":a=this.slice(a,f);f="";for(m=0;m<a.length;m+=2)f+=String.fromCharCode(a[m]+256*a[m+1]);return f;default:if(b)throw new TypeError("Unknown encoding: "+m);m=(m+"").toLowerCase();b=!0}}function b(m,a,f){var b=m[a];m[a]=m[f];m[f]=b}function h(m,b,f,d,c){if(0===m.length)return-1;"string"===typeof f?(d=f,f=0):2147483647<f?f=2147483647:-2147483648>
...
a,f,b,d){function I(f,m){return 1===c?f[m]:f.readUInt16BE(m*c)}var c=1,H=m.length,h=a.length;if(void 0!==b&&(b=String(b).toLowerCase(),"ucs2"===b||"ucs-2"===b||"utf16le"===b||"utf-16le"===b)){if(2>m.length||2>a.length)return-1;c=2;H/=2;h/=2;f/=2}if(d)for(b=-1;f<H;f++)if(I(m,f)===I(a,-1===b?0:f-b)){if(-1===b&&(b=f),f-b+1===h)return b*c}else-1!==b&&(f-=f-b),b=-1;else for(f+h>H&&(f=H-h);0<=f;f--){H=!0;for(b=0;b<h;b++)if(I(m,f+b)!==I(a,b)){H=!1;break}if(H)return f}return-1}function u(m,a,f){f=Math.min(m.length,
f);for(var b=[];a<f;){var d=m[a],c=null,H=239<d?4:223<d?3:191<d?2:1;if(a+H<=f)switch(H){case 1:128>d&&(c=d);break;case 2:var h=m[a+1];128===(h&192)&&(d=(d&31)<<6|h&63,127<d&&(c=d));break;case 3:h=m[a+1];var k=m[a+2];128===(h&192)&&128===(k&192)&&(d=(d&15)<<12|(h&63)<<6|k&63,2047<d&&(55296>d||57343<d)&&(c=d));break;case 4:h=m[a+1];k=m[a+2];var e=m[a+3];128===(h&192)&&128===(k&192)&&128===(e&192)&&(d=(d&15)<<18|(h&63)<<12|(k&63)<<6|e&63,65535<d&&1114112>d&&(c=d))}null===c?(c=65533,H=1):65535<c&&(c-=
65536,b.push(c>>>10&1023|55296),c=56320|c&1023);b.push(c);a+=H}m=b.length;if(m<=y)b=String.fromCharCode.apply(String,b);else{f="";for(a=0;a<m;)f+=String.fromCharCode.apply(String,b.slice(a,a+=y));b=f}return b}function A(m,a,f){if(0!==m%1||0>m)throw new RangeError("offset is not uint");if(m+a>f)throw new RangeError("Trying to access beyond buffer length");}function D(m,b,f,d,c,h){if(!a.isBuffer(m))throw new TypeError('"buffer" argument must be a Buffer instance');if(b>c||b<h)throw new RangeError('"value" argument is out of bounds');
if(f+d>m.length)throw new RangeError("Index out of range");}function x(m,a,f,b,d,c){if(f+b>m.length)throw new RangeError("Index out of range");if(0>f)throw new RangeError("Index out of range");}function N(m,a,f,b,d){a=+a;f>>>=0;d||x(m,a,f,4,3.4028234663852886E38,-3.4028234663852886E38);E.write(m,a,f,b,23,4);return f+4}function q(a,b,f,d,c){b=+b;f>>>=0;c||x(a,b,f,8,1.7976931348623157E308,-1.7976931348623157E308);E.write(a,b,f,d,52,8);return f+8}function B(a){a=a.split("=")[0];a=a.trim().replace(V,
"");if(2>a.length)return"";for(;0!==a.length%4;)a+="=";return a}function J(a,b){b=b||Infinity;for(var f,m=a.length,d=null,c=[],h=0;h<m;++h){f=a.charCodeAt(h);if(55295<f&&57344>f){if(!d){if(56319<f){-1<(b-=3)&&c.push(239,191,189);continue}else if(h+1===m){-1<(b-=3)&&c.push(239,191,189);continue}d=f;continue}if(56320>f){-1<(b-=3)&&c.push(239,191,189);d=f;continue}f=(d-55296<<10|f-56320)+65536}else d&&-1<(b-=3)&&c.push(239,191,189);d=null;if(128>f){if(0>--b)break;c.push(f)}else if(2048>f){if(0>(b-=2))break;
c.push(f>>6|192,f&63|128)}else if(65536>f){if(0>(b-=3))break;c.push(f>>12|224,f>>6&63|128,f&63|128)}else if(1114112>f){if(0>(b-=4))break;c.push(f>>18|240,f>>12&63|128,f>>6&63|128,f&63|128)}else throw Error("Invalid code point");}return c}function G(a){for(var b=[],f=0;f<a.length;++f)b.push(a.charCodeAt(f)&255);return b}function C(a,b,f,d){for(var m=0;m<d&&!(m+f>=b.length||m>=a.length);++m)b[m+f]=a[m];return m}function L(a,b){return a instanceof b||null!=a&&null!=a.constructor&&null!=a.constructor.name&&
a.constructor.name===b.name}var O=e("base64-js"),E=e("ieee754");g.Buffer=a;g.SlowBuffer=function(b){+b!=b&&(b=0);return a.alloc(+b)};g.INSPECT_MAX_BYTES=50;g.kMaxLength=2147483647;a.TYPED_ARRAY_SUPPORT=function(){try{var a=new Uint8Array(1);a.__proto__={__proto__:Uint8Array.prototype,foo:function(){return 42}};return 42===a.foo()}catch(H){return!1}}();a.TYPED_ARRAY_SUPPORT||"undefined"===typeof console||"function"!==typeof console.error||console.error("This browser lacks typed array (Uint8Array) support which is required by `buffer` v5.x. Use `buffer` v4.x if you require old browser support.");
...
a.__proto__=Uint8Array;a.alloc=function(a,b,f){n(a);a=0>=a?c(a):void 0!==b?"string"===typeof f?c(a).fill(b,f):c(a).fill(b):c(a);return a};a.allocUnsafe=function(a){return F(a)};a.allocUnsafeSlow=function(a){return F(a)};a.isBuffer=function(b){return null!=b&&!0===b._isBuffer&&b!==a.prototype};a.compare=function(b,d){L(b,Uint8Array)&&(b=a.from(b,b.offset,b.byteLength));L(d,Uint8Array)&&(d=a.from(d,d.offset,d.byteLength));if(!a.isBuffer(b)||!a.isBuffer(d))throw new TypeError('The "buf1", "buf2" arguments must be one of type Buffer or Uint8Array');
...
var f;if(void 0===d)for(f=d=0;f<b.length;++f)d+=b[f].length;d=a.allocUnsafe(d);var m=0;for(f=0;f<b.length;++f){var c=b[f];L(c,Uint8Array)&&(c=a.from(c));if(!a.isBuffer(c))throw new TypeError('"list" argument must be an Array of Buffers');c.copy(d,m);m+=c.length}return d};a.byteLength=z;a.prototype._isBuffer=!0;a.prototype.swap16=function(){var a=this.length;if(0!==a%2)throw new RangeError("Buffer size must be a multiple of 16-bits");for(var d=0;d<a;d+=2)b(this,d,d+1);return this};a.prototype.swap32=
...
d||(d="utf8");for(m=!1;;)switch(d){case "hex":a:{b=Number(b)||0;d=this.length-b;f?(f=Number(f),f>d&&(f=d)):f=d;d=a.length;f>d/2&&(f=d/2);for(d=0;d<f;++d){m=parseInt(a.substr(2*d,2),16);if(m!==m){a=d;break a}this[b+d]=m}a=d}return a;case "utf8":case "utf-8":return C(J(a,this.length-b),this,b,f);case "ascii":return C(G(a),this,b,f);case "latin1":case "binary":return C(G(a),this,b,f);case "base64":return C(O.toByteArray(B(a)),this,b,f);case "ucs2":case "ucs-2":case "utf16le":case "utf-16le":d=a;m=this.length-
...
a.prototype;return b};a.prototype.readUIntLE=function(b,a,d){b>>>=0;a>>>=0;d||A(b,a,this.length);d=this[b];for(var f=1,m=0;++m<a&&(f*=256);)d+=this[b+m]*f;return d};a.prototype.readUIntBE=function(b,a,d){b>>>=0;a>>>=0;d||A(b,a,this.length);d=this[b+--a];for(var f=1;0<a&&(f*=256);)d+=this[b+--a]*f;return d};a.prototype.readUInt8=function(b,a){b>>>=0;a||A(b,1,this.length);return this[b]};a.prototype.readUInt16LE=function(b,a){b>>>=0;a||A(b,2,this.length);return this[b]|this[b+1]<<8};a.prototype.readUInt16BE=
function(b,a){b>>>=0;a||A(b,2,this.length);return this[b]<<8|this[b+1]};a.prototype.readUInt32LE=function(b,a){b>>>=0;a||A(b,4,this.length);return(this[b]|this[b+1]<<8|this[b+2]<<16)+16777216*this[b+3]};a.prototype.readUInt32BE=function(b,a){b>>>=0;a||A(b,4,this.length);return 16777216*this[b]+(this[b+1]<<16|this[b+2]<<8|this[b+3])};a.prototype.readIntLE=function(b,a,d){b>>>=0;a>>>=0;d||A(b,a,this.length);d=this[b];for(var f=1,c=0;++c<a&&(f*=256);)d+=this[b+c]*f;d>=128*f&&(d-=Math.pow(2,8*a));return d};
a.prototype.readIntBE=function(b,a,d){b>>>=0;a>>>=0;d||A(b,a,this.length);d=a;for(var f=1,c=this[b+--d];0<d&&(f*=256);)c+=this[b+--d]*f;c>=128*f&&(c-=Math.pow(2,8*a));return c};a.prototype.readInt8=function(b,a){b>>>=0;a||A(b,1,this.length);return this[b]&128?-1*(255-this[b]+1):this[b]};a.prototype.readInt16LE=function(b,a){b>>>=0;a||A(b,2,this.length);b=this[b]|this[b+1]<<8;return b&32768?b|4294901760:b};a.prototype.readInt16BE=function(b,a){b>>>=0;a||A(b,2,this.length);b=this[b+1]|this[b]<<8;return b&
32768?b|4294901760:b};a.prototype.readInt32LE=function(b,a){b>>>=0;a||A(b,4,this.length);return this[b]|this[b+1]<<8|this[b+2]<<16|this[b+3]<<24};a.prototype.readInt32BE=function(b,a){b>>>=0;a||A(b,4,this.length);return this[b]<<24|this[b+1]<<16|this[b+2]<<8|this[b+3]};a.prototype.readFloatLE=function(b,a){b>>>=0;a||A(b,4,this.length);return E.read(this,b,!0,23,4)};a.prototype.readFloatBE=function(b,a){b>>>=0;a||A(b,4,this.length);return E.read(this,b,!1,23,4)};a.prototype.readDoubleLE=function(b,
a){b>>>=0;a||A(b,8,this.length);return E.read(this,b,!0,52,8)};a.prototype.readDoubleBE=function(b,a){b>>>=0;a||A(b,8,this.length);return E.read(this,b,!1,52,8)};a.prototype.writeUIntLE=function(b,a,d,c){b=+b;a>>>=0;d>>>=0;c||D(this,b,a,d,Math.pow(2,8*d)-1,0);c=1;var f=0;for(this[a]=b&255;++f<d&&(c*=256);)this[a+f]=b/c&255;return a+d};a.prototype.writeUIntBE=function(b,a,d,c){b=+b;a>>>=0;d>>>=0;c||D(this,b,a,d,Math.pow(2,8*d)-1,0);c=d-1;var f=1;for(this[a+c]=b&255;0<=--c&&(f*=256);)this[a+c]=b/f&
...
arguments[1],arguments[2]);default:for(var b=Array(arguments.length),a=0;a<b.length;++a)b[a]=arguments[a];this.listener.apply(this.target,b)}}function n(b,a,d){b={fired:!1,wrapFn:void 0,target:b,type:a,listener:d};a=r.call(l,b);a.listener=d;return b.wrapFn=a}function F(b,a,c){b=b._events;if(!b)return[];a=b[a];if(!a)return[];if("function"===typeof a)return c?[a.listener||a]:[a];if(c)for(c=Array(a.length),b=0;b<c.length;++b)c[b]=a[b].listener||a[b];else c=d(a,a.length);return c}function t(b){var a=
...
void 0;a.prototype._maxListeners=void 0;var u=10;try{e={};Object.defineProperty&&Object.defineProperty(e,"x",{value:0});var A=0===e.x}catch(D){A=!1}A?Object.defineProperty(a,"defaultMaxListeners",{enumerable:!0,get:function(){return u},set:function(b){if("number"!==typeof b||0>b||b!==b)throw new TypeError('"defaultMaxListeners" must be a positive number');u=b}}):a.defaultMaxListeners=u;a.prototype.setMaxListeners=function(b){if("number"!==typeof b||0>b||isNaN(b))throw new TypeError('"n" argument must be a positive number');
...
c[d];"removeListener"!==k&&this.removeAllListeners(k)}this.removeAllListeners("removeListener");this._events=b(null);this._eventsCount=0;return this}c=d[a];if("function"===typeof c)this.removeListener(a,c);else if(c)for(d=c.length-1;0<=d;d--)this.removeListener(a,c[d]);return this};a.prototype.listeners=function(b){return F(this,b,!0)};a.prototype.rawListeners=function(b){return F(this,b,!1)};a.listenerCount=function(b,a){return"function"===typeof b.listenerCount?b.listenerCount(a):t.call(b,a)};a.prototype.listenerCount=
...
}function l(b){if(z===setTimeout)return setTimeout(b,0);if((z===a||!z)&&setTimeout)return z=setTimeout,setTimeout(b,0);try{return z(b,0)}catch(D){try{return z.call(null,b,0)}catch(x){return z.call(this,b,0)}}}function n(b){if(w===clearTimeout)return clearTimeout(b);if((w===c||!w)&&clearTimeout)return w=clearTimeout,clearTimeout(b);try{return w(b)}catch(D){try{return w.call(null,b)}catch(x){return w.call(this,b)}}}function F(){h&&r&&(h=!1,r.length?b=r.concat(b):u=-1,b.length&&t())}function t(){if(!h){var a=
l(F);h=!0;for(var d=b.length;d;){r=b;for(b=[];++u<d;)r&&r[u].run();u=-1;d=b.length}r=null;h=!1;n(a)}}function d(b,a){this.fun=b;this.array=a}function k(){}e=q.exports={};try{var z="function"===typeof setTimeout?setTimeout:a}catch(A){z=a}try{var w="function"===typeof clearTimeout?clearTimeout:c}catch(A){w=c}var b=[],h=!1,r,u=-1;e.nextTick=function(a){var c=Array(arguments.length-1);if(1<arguments.length)for(var k=1;k<arguments.length;k++)c[k-1]=arguments[k];b.push(new d(a,c));1!==b.length||h||l(t)};
...
{}],12:[function(e,q,g){q.exports=e("./lib/_stream_duplex.js")},{"./lib/_stream_duplex.js":13}],13:[function(e,q,g){function a(d){if(!(this instanceof a))return new a(d);F.call(this,d);t.call(this,d);d&&!1===d.readable&&(this.readable=!1);d&&!1===d.writable&&(this.writable=!1);this.allowHalfOpen=!0;d&&!1===d.allowHalfOpen&&(this.allowHalfOpen=!1);this.once("end",c)}function c(){this.allowHalfOpen||this._writableState.ended||n.nextTick(l,this)}function l(a){a.end()}var n=e("process-nextick-args");
g=Object.keys||function(a){var d=[],c;for(c in a)d.push(c);return d};q.exports=a;q=Object.create(e("core-util-is"));q.inherits=e("inherits");var F=e("./_stream_readable"),t=e("./_stream_writable");q.inherits(a,F);e=g(t.prototype);for(q=0;q<e.length;q++)g=e[q],a.prototype[g]||(a.prototype[g]=t.prototype[g]);Object.defineProperty(a.prototype,"writableHighWaterMark",{enumerable:!1,get:function(){return this._writableState.highWaterMark}});Object.defineProperty(a.prototype,"destroyed",{get:function(){return void 0===
...
c.call(this,e)}q.exports=a;var c=e("./_stream_transform");q=Object.create(e("core-util-is"));q.inherits=e("inherits");q.inherits(a,c);a.prototype._transform=function(a,c,e){e(null,a)}},{"./_stream_transform":16,"core-util-is":4,inherits:7}],15:[function(e,q,g){(function(a,c){function l(b,a,d){if("function"===typeof b.prependListener)return b.prependListener(a,d);if(b._events&&b._events[a])J(b._events[a])?b._events[a].unshift(d):b._events[a]=[d,b._events[a]];else b.on(a,d)}function n(b,a){G=G||e("./_stream_duplex");
b=b||{};a=a instanceof G;this.objectMode=!!b.objectMode;a&&(this.objectMode=this.objectMode||!!b.readableObjectMode);var d=b.highWaterMark,c=b.readableHighWaterMark,f=this.objectMode?16:16384;this.highWaterMark=d||0===d?d:a&&(c||0===c)?c:f;this.highWaterMark=Math.floor(this.highWaterMark);this.buffer=new V;this.length=0;this.pipes=null;this.pipesCount=0;this.flowing=null;this.reading=this.endEmitted=this.ended=!1;this.sync=!0;this.destroyed=this.resumeScheduled=this.readableListening=this.emittedReadable=
this.needReadable=!1;this.defaultEncoding=b.defaultEncoding||"utf8";this.awaitDrain=0;this.readingMore=!1;this.encoding=this.decoder=null;b.encoding&&(m||(m=e("string_decoder/").StringDecoder),this.decoder=new m(b.encoding),this.encoding=b.encoding)}function g(b){G=G||e("./_stream_duplex");if(!(this instanceof g))return new g(b);this._readableState=new n(b,this);this.readable=!0;b&&("function"===typeof b.read&&(this._read=b.read),"function"===typeof b.destroy&&(this._destroy=b.destroy));C.call(this)}
function t(a,c,h,k,e){var f=a._readableState;if(null===c)f.reading=!1,f.ended||(f.decoder&&(c=f.decoder.end())&&c.length&&(f.buffer.push(c),f.length+=f.objectMode?1:c.length),f.ended=!0,z(a));else{if(!e){e=c;var u;L.isBuffer(e)||e instanceof O||"string"===typeof e||void 0===e||f.objectMode||(u=new TypeError("Invalid non-string/buffer chunk"));var l=u}l?a.emit("error",l):f.objectMode||c&&0<c.length?("string"===typeof c||f.objectMode||Object.getPrototypeOf(c)===L.prototype||(c=L.from(c)),k?f.endEmitted?
a.emit("error",Error("stream.unshift() after end event")):d(a,f,c,!0):f.ended?a.emit("error",Error("stream.push() after EOF")):(f.reading=!1,f.decoder&&!h?(c=f.decoder.write(c),f.objectMode||0!==c.length?d(a,f,c,!1):f.readingMore||(f.readingMore=!0,B.nextTick(b,a,f))):d(a,f,c,!1))):k||(f.reading=!1)}return!f.ended&&(f.needReadable||f.length<f.highWaterMark||0===f.length)}function d(a,d,c,h){d.flowing&&0===d.length&&!d.sync?(a.emit("data",c),a.read(0)):(d.length+=d.objectMode?1:c.length,h?d.buffer.unshift(c):
d.buffer.push(c),d.needReadable&&z(a));d.readingMore||(d.readingMore=!0,B.nextTick(b,a,d))}function k(b,a){if(0>=b||0===a.length&&a.ended)return 0;if(a.objectMode)return 1;if(b!==b)return a.flowing&&a.length?a.buffer.head.data.length:a.length;if(b>a.highWaterMark){var d=b;8388608<=d?d=8388608:(d--,d|=d>>>1,d|=d>>>2,d|=d>>>4,d|=d>>>8,d|=d>>>16,d++);a.highWaterMark=d}return b<=a.length?b:a.ended?a.length:(a.needReadable=!0,0)}function z(b){var a=b._readableState;a.needReadable=!1;a.emittedReadable||
(y("emitReadable",a.flowing),a.emittedReadable=!0,a.sync?B.nextTick(w,b):w(b))}function w(b){y("emit readable");b.emit("readable");A(b)}function b(b,a){for(var d=a.length;!a.reading&&!a.flowing&&!a.ended&&a.length<a.highWaterMark&&(y("maybeReadMore read 0"),b.read(0),d!==a.length);)d=a.length;a.readingMore=!1}function h(b){return function(){var a=b._readableState;y("pipeOnDrain",a.awaitDrain);a.awaitDrain&&a.awaitDrain--;0===a.awaitDrain&&b.listeners("data").length&&(a.flowing=!0,A(b))}}function r(b){y("readable nexttick read 0");
b.read(0)}function u(b,a){a.reading||(y("resume read 0"),b.read(0));a.resumeScheduled=!1;a.awaitDrain=0;b.emit("resume");A(b);a.flowing&&!a.reading&&b.read(0)}function A(b){var a=b._readableState;for(y("flow",a.flowing);a.flowing&&null!==b.read(););}function D(b,a){if(0===a.length)return null;if(a.objectMode)var d=a.buffer.shift();else if(!b||b>=a.length)d=a.decoder?a.buffer.join(""):1===a.buffer.length?a.buffer.head.data:a.buffer.concat(a.length),a.buffer.clear();else{d=a.buffer;a=a.decoder;if(b<
d.head.data.length)a=d.head.data.slice(0,b),d.head.data=d.head.data.slice(b);else{if(b===d.head.data.length)d=d.shift();else if(a){a=d.head;var c=1,f=a.data;for(b-=f.length;a=a.next;){var h=a.data,e=b>h.length?h.length:b;f=e===h.length?f+h:f+h.slice(0,b);b-=e;if(0===b){e===h.length?(++c,d.head=a.next?a.next:d.tail=null):(d.head=a,a.data=h.slice(e));break}++c}d.length-=c;d=f}else{a=L.allocUnsafe(b);c=d.head;f=1;c.data.copy(a);for(b-=c.data.length;c=c.next;){h=c.data;e=b>h.length?h.length:b;h.copy(a,
a.length-b,0,e);b-=e;if(0===b){e===h.length?(++f,d.head=c.next?c.next:d.tail=null):(d.head=c,c.data=h.slice(e));break}++f}d.length-=f;d=a}a=d}d=a}return d}function x(b){var a=b._readableState;if(0<a.length)throw Error('"endReadable()" called on non-empty stream');a.endEmitted||(a.ended=!0,B.nextTick(N,a,b))}function N(b,a){b.endEmitted||0!==b.length||(b.endEmitted=!0,a.readable=!1,a.emit("end"))}function M(b,a){for(var d=0,c=b.length;d<c;d++)if(b[d]===a)return d;return-1}var B=e("process-nextick-args");
q.exports=g;var J=e("isarray"),G;g.ReadableState=n;e("events");var C=e("./internal/streams/stream"),L=e("safe-buffer").Buffer,O=c.Uint8Array||function(){};c=Object.create(e("core-util-is"));c.inherits=e("inherits");var E=e("util"),y=void 0;y=E&&E.debuglog?E.debuglog("stream"):function(){};var V=e("./internal/streams/BufferList");E=e("./internal/streams/destroy");var m;c.inherits(g,C);var H=["error","close","destroy","pause","resume"];Object.defineProperty(g.prototype,"destroyed",{get:function(){return void 0===
this._readableState?!1:this._readableState.destroyed},set:function(b){this._readableState&&(this._readableState.destroyed=b)}});g.prototype.destroy=E.destroy;g.prototype._undestroy=E.undestroy;g.prototype._destroy=function(b,a){this.push(null);a(b)};g.prototype.push=function(b,a){var d=this._readableState;if(d.objectMode)var c=!0;else"string"===typeof b&&(a=a||d.defaultEncoding,a!==d.encoding&&(b=L.from(b,a),a=""),c=!0);return t(this,b,a,!1,c)};g.prototype.unshift=function(b){return t(this,b,null,
...
null!==c&&this.emit("data",c);return c};g.prototype._read=function(a){this.emit("error",Error("_read() is not implemented"))};g.prototype.pipe=function(b,d){function c(a,d){y("onunpipe");a===m&&d&&!1===d.hasUnpiped&&(d.hasUnpiped=!0,y("cleanup"),b.removeListener("close",u),b.removeListener("finish",r),b.removeListener("drain",n),b.removeListener("error",k),b.removeListener("unpipe",c),m.removeListener("end",f),m.removeListener("end",S),m.removeListener("data",e),g=!0,!K.awaitDrain||b._writableState&&
!b._writableState.needDrain||n())}function f(){y("onend");b.end()}function e(a){y("ondata");W=!1;!1!==b.write(a)||W||((1===K.pipesCount&&K.pipes===b||1<K.pipesCount&&-1!==M(K.pipes,b))&&!g&&(y("false write response, pause",m._readableState.awaitDrain),m._readableState.awaitDrain++,W=!0),m.pause())}function k(a){y("onerror",a);S();b.removeListener("error",k);0===b.listeners("error").length&&b.emit("error",a)}function u(){b.removeListener("finish",r);S()}function r(){y("onfinish");b.removeListener("close",
u);S()}function S(){y("unpipe");m.unpipe(b)}var m=this,K=this._readableState;switch(K.pipesCount){case 0:K.pipes=b;break;case 1:K.pipes=[K.pipes,b];break;default:K.pipes.push(b)}K.pipesCount+=1;y("pipe count=%d opts=%j",K.pipesCount,d);d=d&&!1===d.end||b===a.stdout||b===a.stderr?S:f;if(K.endEmitted)B.nextTick(d);else m.once("end",d);b.on("unpipe",c);var n=h(m);b.on("drain",n);var g=!1,W=!1;m.on("data",e);l(b,"error",k);b.once("close",u);b.once("finish",r);b.emit("pipe",m);K.flowing||(y("pipe resume"),
...
a.pipes[0]);b.emit("unpipe",this,d);return this};g.prototype.on=function(b,a){a=C.prototype.on.call(this,b,a);"data"===b?!1!==this._readableState.flowing&&this.resume():"readable"===b&&(b=this._readableState,b.endEmitted||b.readableListening||(b.readableListening=b.needReadable=!0,b.emittedReadable=!1,b.reading?b.length&&z(this):B.nextTick(r,this)));return a};g.prototype.addListener=g.prototype.on;g.prototype.resume=function(){var b=this._readableState;b.flowing||(y("resume"),b.flowing=!0,b.resumeScheduled||
(b.resumeScheduled=!0,B.nextTick(u,this,b)));return this};g.prototype.pause=function(){y("call pause flowing=%j",this._readableState.flowing);!1!==this._readableState.flowing&&(y("pause"),this._readableState.flowing=!1,this.emit("pause"));return this};g.prototype.wrap=function(b){var a=this,d=this._readableState,c=!1;b.on("end",function(){y("wrapped end");if(d.decoder&&!d.ended){var b=d.decoder.end();b&&b.length&&a.push(b)}a.push(null)});b.on("data",function(h){y("wrapped data");d.decoder&&(h=d.decoder.write(h));
d.objectMode&&(null===h||void 0===h)||!(d.objectMode||h&&h.length)||a.push(h)||(c=!0,b.pause())});for(var h in b)void 0===this[h]&&"function"===typeof b[h]&&(this[h]=function(a){return function(){return b[a].apply(b,arguments)}}(h));for(h=0;h<H.length;h++)b.on(H[h],this.emit.bind(this,H[h]));this._read=function(a){y("wrapped _read",a);c&&(c=!1,b.resume())};return this};Object.defineProperty(g.prototype,"readableHighWaterMark",{enumerable:!1,get:function(){return this._readableState.highWaterMark}});
...
!0,d.emit("error",a),r(d,c))):((a=b(c))||c.corked||c.bufferProcessing||!c.bufferedRequest||w(d,c),h?A(z,d,c,a,e):z(d,c,a,e))};this.writecb=null;this.writelen=0;this.lastBufferedRequest=this.bufferedRequest=null;this.pendingcb=0;this.errorEmitted=this.prefinished=!1;this.bufferedRequestCount=0;this.corkedRequestsFree=new n(this)}function d(a){D=D||e("./_stream_duplex");if(!(J.call(d,this)||this instanceof D))return new d(a);this._writableState=new t(a,this);this.writable=!0;a&&("function"===typeof a.write&&
...
var u=e("process-nextick-args");q.exports=d;var A=!a.browser&&-1<["v0.10","v0.9."].indexOf(a.version.slice(0,5))?l:u.nextTick,D;d.WritableState=t;a=Object.create(e("core-util-is"));a.inherits=e("inherits");var x={deprecate:e("util-deprecate")},N=e("./internal/streams/stream"),M=e("safe-buffer").Buffer,B=c.Uint8Array||function(){};c=e("./internal/streams/destroy");a.inherits(d,N);t.prototype.getBuffer=function(){for(var a=this.bufferedRequest,b=[];a;)b.push(a),a=a.next;return b};(function(){try{Object.defineProperty(t.prototype,
"buffer",{get:x.deprecate(function(){return this.getBuffer()},"_writableState.buffer is deprecated. Use _writableState.getBuffer instead.","DEP0003")})}catch(G){}})();if("function"===typeof Symbol&&Symbol.hasInstance&&"function"===typeof Function.prototype[Symbol.hasInstance]){var J=Function.prototype[Symbol.hasInstance];Object.defineProperty(d,Symbol.hasInstance,{value:function(a){return J.call(this,a)?!0:this!==d?!1:a&&a._writableState instanceof t}})}else J=function(a){return a instanceof this};
d.prototype.pipe=function(){this.emit("error",Error("Cannot pipe, not readable"))};d.prototype.write=function(a,b,d){var c=this._writableState,h=!1,e;if(e=!c.objectMode)e=a,e=M.isBuffer(e)||e instanceof B;e&&!M.isBuffer(a)&&(a=M.from(a));"function"===typeof b&&(d=b,b=null);e?b="buffer":b||(b=c.defaultEncoding);"function"!==typeof d&&(d=g);if(c.ended)c=d,d=Error("write after end"),this.emit("error",d),u.nextTick(c,d);else{var l;if(!(l=e)){l=a;var r=d,n=!0,f=!1;null===l?f=new TypeError("May not write null values to stream"):
...
default:if(b)return;a=(""+a).toLowerCase();b=!0}}function c(c){var e=a(c);if("string"!==typeof e&&(h.isEncoding===r||!r(c)))throw Error("Unknown encoding: "+c);this.encoding=e||c;switch(this.encoding){case "utf16le":this.text=t;this.end=d;c=4;break;case "utf8":this.fillLast=F;c=4;break;case "base64":this.text=k;this.end=z;c=3;break;default:this.write=w;this.end=b;return}this.lastTotal=this.lastNeed=0;this.lastChar=h.allocUnsafe(c)}function l(a){return 127>=a?0:6===a>>5?2:14===a>>4?3:30===a>>3?4:2===
a>>6?-1:-2}function n(a,b,d){var c=b.length-1;if(c<d)return 0;var h=l(b[c]);if(0<=h)return 0<h&&(a.lastNeed=h-1),h;if(--c<d||-2===h)return 0;h=l(b[c]);if(0<=h)return 0<h&&(a.lastNeed=h-2),h;if(--c<d||-2===h)return 0;h=l(b[c]);return 0<=h?(0<h&&(2===h?h=0:a.lastNeed=h-3),h):0}function F(a){var b=this.lastTotal-this.lastNeed;a:if(128!==(a[0]&192)){this.lastNeed=0;var d="\ufffd"}else{if(1<this.lastNeed&&1<a.length){if(128!==(a[1]&192)){this.lastNeed=1;d="\ufffd";break a}if(2<this.lastNeed&&2<a.length&&
...
function(a){if("number"!==typeof a)throw new TypeError("Argument must be a number");return n(a)};c.allocUnsafeSlow=function(a){if("number"!==typeof a)throw new TypeError("Argument must be a number");return l.SlowBuffer(a)}},{buffer:3}],28:[function(e,q,g){(function(a){(function(c){function l(a,b){if(!(this instanceof l))return new l(a,b);for(var d=0,h=B.length;d<h;d++)this[B[d]]="";this.q=this.c="";this.bufferCheckPosition=c.MAX_BUFFER_LENGTH;this.opt=b||{};this.opt.lowercase=this.opt.lowercase||
...
0;this.onready&&this.onready(void 0)}function g(a,b){if(!(this instanceof g))return new g(a,b);J.apply(this);this._parser=new l(a,b);this.readable=this.writable=!0;var d=this;this._parser.onend=function(){d.emit("end")};this._parser.onerror=function(a){d.emit("error",a);d._parser.error=null};this._decoder=null;G.forEach(function(a){Object.defineProperty(d,"on"+a,{get:function(){return d._parser["on"+a]},set:function(b){if(!b)return d.removeAllListeners(a),d._parser["on"+a]=b;d.on(a,b)},enumerable:!0,
...
a&&(c="xmlns",d="");return{prefix:c,local:d}}function u(a){a.strict||(a.attribName=a.attribName[a.looseCase]());if(-1===a.attribList.indexOf(a.attribName)&&!a.tag.attributes.hasOwnProperty(a.attribName))if(a.opt.xmlns){var b=r(a.attribName,!0),c=b.local;if("xmlns"===b.prefix)if("xml"===c&&a.attribValue!==H)h(a,"xml: prefix must be bound to "+H+"\nActual: "+a.attribValue);else if("xmlns"===c&&a.attribValue!==f)h(a,"xmlns: prefix must be bound to "+f+"\nActual: "+a.attribValue);else{b=a.tag;var e=a.tags[a.tags.length-
1]||a;b.ns===e.ns&&(b.ns=Object.create(e.ns));b.ns[c]=a.attribValue}a.attribList.push([a.attribName,a.attribValue])}else a.tag.attributes[a.attribName]=a.attribValue,d(a,"onattribute",{name:a.attribName,value:a.attribValue});a.attribName=a.attribValue=""}function A(a,b){if(a.opt.xmlns){var c=a.tag,e=r(a.tagName);c.prefix=e.prefix;c.local=e.local;c.uri=c.ns[e.prefix]||"";c.prefix&&!c.uri&&(h(a,"Unbound namespace prefix: "+JSON.stringify(a.tagName)),c.uri=e.prefix);e=a.tags[a.tags.length-1]||a;c.ns&&
...
b,a.state=p.TEXT)}function M(a,b){var d="";b<a.length&&(d=a.charAt(b));return d}c.parser=function(a,b){return new l(a,b)};c.SAXParser=l;c.SAXStream=g;c.createStream=function(a,b){return new g(a,b)};c.MAX_BUFFER_LENGTH=65536;var B="comment sgmlDecl textNode tagName doctype procInstName procInstBody entity attribName attribValue cdata script".split(" ");c.EVENTS="text processinginstruction sgmldeclaration doctype comment opentagstart attribute opentag closetag opencdata cdata closecdata error end ready script opennamespace closenamespace".split(" ");
...
h(this,"Text data outside of root node."),"&"===f?this.state=p.TEXT_ENTITY:this.textNode+=f):(this.state=p.OPEN_WAKA,this.startTagPosition=this.position);continue;case p.SCRIPT:"<"===f?this.state=p.SCRIPT_ENDING:this.script+=f;continue;case p.SCRIPT_ENDING:"/"===f?this.state=p.CLOSE_TAG:(this.script+="<"+f,this.state=p.SCRIPT);continue;case p.OPEN_WAKA:"!"===f?(this.state=p.SGML_DECL,this.sgmlDecl=""):t(C,f)||(t(U,f)?(this.state=p.OPEN_TAG,this.tagName=f):"/"===f?(this.state=p.CLOSE_TAG,this.tagName=
...
(this.doctype||this.sawRoot)&&h(this,"Inappropriately located doctype declaration"),this.sgmlDecl=this.doctype=""):">"===f?(d(this,"onsgmldeclaration",this.sgmlDecl),this.sgmlDecl="",this.state=p.TEXT):(t(E,f)&&(this.state=p.SGML_DECL_QUOTED),this.sgmlDecl+=f);continue;case p.SGML_DECL_QUOTED:f===this.q&&(this.state=p.SGML_DECL,this.q="");this.sgmlDecl+=f;continue;case p.DOCTYPE:">"===f?(this.state=p.TEXT,d(this,"ondoctype",this.doctype),this.doctype=!0):(this.doctype+=f,"["===f?this.state=p.DOCTYPE_DTD:
t(E,f)&&(this.state=p.DOCTYPE_QUOTED,this.q=f));continue;case p.DOCTYPE_QUOTED:this.doctype+=f;f===this.q&&(this.q="",this.state=p.DOCTYPE);continue;case p.DOCTYPE_DTD:this.doctype+=f;"]"===f?this.state=p.DOCTYPE:t(E,f)&&(this.state=p.DOCTYPE_DTD_QUOTED,this.q=f);continue;case p.DOCTYPE_DTD_QUOTED:this.doctype+=f;f===this.q&&(this.state=p.DOCTYPE_DTD,this.q="");continue;case p.COMMENT:"-"===f?this.state=p.COMMENT_ENDING:this.comment+=f;continue;case p.COMMENT_ENDING:"-"===f?(this.state=p.COMMENT_ENDED,
...
this.procInstName=this.procInstBody="",this.state=p.TEXT):(this.procInstBody+="?"+f,this.state=p.PROC_INST_BODY);continue;case p.OPEN_TAG:if(t(Q,f))this.tagName+=f;else{this.strict||(this.tagName=this.tagName[this.looseCase]());l=this.tags[this.tags.length-1]||this;var r=this.tag={name:this.tagName,attributes:{}};this.opt.xmlns&&(r.ns=l.ns);this.attribList.length=0;d(this,"onopentagstart",r);">"===f?A(this):"/"===f?this.state=p.OPEN_TAG_SLASH:(t(C,f)||h(this,"Invalid character in tag name"),this.state=
p.ATTRIB)}continue;case p.OPEN_TAG_SLASH:">"===f?(A(this,!0),D(this)):(h(this,"Forward-slash in opening tag not followed by >"),this.state=p.ATTRIB);continue;case p.ATTRIB:if(t(C,f))continue;else">"===f?A(this):"/"===f?this.state=p.OPEN_TAG_SLASH:t(U,f)?(this.attribName=f,this.attribValue="",this.state=p.ATTRIB_NAME):h(this,"Invalid attribute name");continue;case p.ATTRIB_NAME:"="===f?this.state=p.ATTRIB_VALUE:">"===f?(h(this,"Attribute without value"),this.attribValue=this.attribName,u(this),A(this)):
t(C,f)?this.state=p.ATTRIB_NAME_SAW_WHITE:t(Q,f)?this.attribName+=f:h(this,"Invalid attribute name");continue;case p.ATTRIB_NAME_SAW_WHITE:if("="===f)this.state=p.ATTRIB_VALUE;else if(t(C,f))continue;else h(this,"Attribute without value"),this.attribValue=this.tag.attributes[this.attribName]="",d(this,"onattribute",{name:this.attribName,value:""}),this.attribName="",">"===f?A(this):t(U,f)?(this.attribName=f,this.state=p.ATTRIB_NAME):(h(this,"Invalid attribute name"),this.state=p.ATTRIB);continue;
case p.ATTRIB_VALUE:if(t(C,f))continue;else t(E,f)?(this.q=f,this.state=p.ATTRIB_VALUE_QUOTED):(h(this,"Unquoted attribute value"),this.state=p.ATTRIB_VALUE_UNQUOTED,this.attribValue=f);continue;case p.ATTRIB_VALUE_QUOTED:if(f!==this.q){"&"===f?this.state=p.ATTRIB_VALUE_ENTITY_Q:this.attribValue+=f;continue}u(this);this.q="";this.state=p.ATTRIB_VALUE_CLOSED;continue;case p.ATTRIB_VALUE_CLOSED:t(C,f)?this.state=p.ATTRIB:">"===f?A(this):"/"===f?this.state=p.OPEN_TAG_SLASH:t(U,f)?(h(this,"No whitespace between attributes"),
this.attribName=f,this.attribValue="",this.state=p.ATTRIB_NAME):h(this,"Invalid attribute name");continue;case p.ATTRIB_VALUE_UNQUOTED:if(!t(y,f)){"&"===f?this.state=p.ATTRIB_VALUE_ENTITY_U:this.attribValue+=f;continue}u(this);">"===f?A(this):this.state=p.ATTRIB;continue;case p.CLOSE_TAG:if(this.tagName)">"===f?D(this):t(Q,f)?this.tagName+=f:this.script?(this.script+="</"+this.tagName,this.tagName="",this.state=p.SCRIPT):(t(C,f)||h(this,"Invalid tagname in closing tag"),this.state=p.CLOSE_TAG_SAW_WHITE);
else if(t(C,f))continue;else t(U,f)?this.tagName=f:this.script?(this.script+="</"+f,this.state=p.SCRIPT):h(this,"Invalid tagname in closing tag.");continue;case p.CLOSE_TAG_SAW_WHITE:if(t(C,f))continue;">"===f?D(this):h(this,"Invalid characters in closing tag");continue;case p.TEXT_ENTITY:case p.ATTRIB_VALUE_ENTITY_Q:case p.ATTRIB_VALUE_ENTITY_U:switch(this.state){case p.TEXT_ENTITY:var g=p.TEXT;var R="textNode";break;case p.ATTRIB_VALUE_ENTITY_Q:g=p.ATTRIB_VALUE_QUOTED;R="attribValue";break;case p.ATTRIB_VALUE_ENTITY_U:g=
p.ATTRIB_VALUE_UNQUOTED,R="attribValue"}";"===f?(this[R]+=x(this),this.entity="",this.state=g):t(this.entity.length?Z:aa,f)?this.entity+=f:(h(this,"Invalid character in entity name"),this[R]+="&"+this.entity+f,this.entity="",this.state=g);continue;default:throw Error(this,"Unknown state: "+this.state);}}if(this.position>=this.bufferCheckPosition){a=Math.max(c.MAX_BUFFER_LENGTH,10);f=e=0;for(g=B.length;f<g;f++){R=this[B[f]].length;if(R>a)switch(B[f]){case "textNode":k(this);break;case "cdata":d(this,
"oncdata",this.cdata);this.cdata="";break;case "script":d(this,"onscript",this.script);this.script="";break;default:w(this,"Max buffer length exceeded: "+B[f])}e=Math.max(e,R)}this.bufferCheckPosition=c.MAX_BUFFER_LENGTH-e+this.position}return this},resume:function(){this.error=null;return this},close:function(){return this.write(null)},flush:function(){k(this);""!==this.cdata&&(d(this,"oncdata",this.cdata),this.cdata="");""!==this.script&&(d(this,"onscript",this.script),this.script="")}};try{var J=
e("stream").Stream}catch(S){J=function(){}}var G=c.EVENTS.filter(function(a){return"error"!==a&&"end"!==a});g.prototype=Object.create(J.prototype,{constructor:{value:g}});g.prototype.write=function(b){"function"===typeof a&&"function"===typeof a.isBuffer&&a.isBuffer(b)&&(this._decoder||(this._decoder=new (e("string_decoder").StringDecoder)("utf8")),b=this._decoder.write(b));this._parser.write(b.toString());this.emit("data",b);return!0};g.prototype.end=function(a){a&&a.length&&this.write(a);this._parser.end();
return!0};g.prototype.on=function(a,b){var d=this;d._parser["on"+a]||-1===G.indexOf(a)||(d._parser["on"+a]=function(){var b=1===arguments.length?[arguments[0]]:Array.apply(null,arguments);b.splice(0,0,a);d.emit.apply(d,b)});return J.prototype.on.call(d,a,b)};var C="\r\n\t ",L="0124356789",O="abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ",E="'\"",y=C+">",V="[CDATA[",m="DOCTYPE",H="http://www.w3.org/XML/1998/namespace",f="http://www.w3.org/2000/xmlns/",I={xml:H,xmlns:f};C=q(C);L=q(L);O=q(O);
var U=/[:_A-Za-z\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD]/,Q=/[:_A-Za-z\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD\u00B7\u0300-\u036F\u203F-\u2040\.\d-]/,aa=/[#:_A-Za-z\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD]/,
Z=/[#:_A-Za-z\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD\u00B7\u0300-\u036F\u203F-\u2040\.\d-]/;E=q(E);y=q(y);var p=0;c.STATE={BEGIN:p++,BEGIN_WHITESPACE:p++,TEXT:p++,TEXT_ENTITY:p++,OPEN_WAKA:p++,SGML_DECL:p++,SGML_DECL_QUOTED:p++,DOCTYPE:p++,DOCTYPE_QUOTED:p++,DOCTYPE_DTD:p++,DOCTYPE_DTD_QUOTED:p++,COMMENT_STARTING:p++,COMMENT:p++,COMMENT_ENDING:p++,COMMENT_ENDED:p++,CDATA:p++,CDATA_ENDING:p++,CDATA_ENDING_2:p++,
...
b.explicit_dur:null!==b.explicit_end&&null===b.explicit_dur?h+b.explicit_end:d;delete b.explicit_begin;delete b.explicit_dur;delete b.explicit_end;a._registerEvent(b)}function n(a){this.node=a}function w(){this.events=[];this.head=new b;this.body=null}function b(){this.styling=new h;this.layout=new A}function h(){this.styles={};this.initials={}}function r(){this.styleRefs=this.styleAttrs=this.id=null}function u(){this.styleAttrs=null}function A(){this.regions={}}function D(a,b){this.kind="image";
this.src=a;this.type=b}function x(a){this.id=a}function N(a){this.regionID=a}function M(a){this.styleAttrs=a}function B(a){this.sets=a}function J(a){this.contents=a}function G(a,b,d){this.explicit_begin=a;this.explicit_end=b;this.explicit_dur=d}function C(){this.kind="body"}function L(){this.kind="div"}function F(){this.kind="p"}function E(){this.kind="span"}function y(){this.kind="span"}function V(){this.kind="br"}function m(){}function H(){}function f(a){var b=null;a&&(a=a.attributes["xml:id"]||
a.attributes.id)&&(b=a.value||null);return b}function I(a){return a&&"style"in a.attributes?a.attributes.style.value.split(" "):[]}function U(a,b){var d={};if(null!==a)for(var c in a.attributes){var e=a.attributes[c].uri+" "+a.attributes[c].local,h=g.byQName[e];if(void 0!==h){var f=h.parse(a.attributes[c].value);null!==f?(d[e]=f,h===g.byName.zIndex&&T(b,"zIndex attribute present but not used by IMSC1 since regions do not overlap")):K(b,"Cannot parse styling attribute "+e+" --\x3e "+a.attributes[c].value)}}return d}
function Q(a,b,d){for(var c in a.attributes)if(a.attributes[c].uri===b&&a.attributes[c].local===d)return a.attributes[c].value;return null}function aa(a,b){a=Q(a,e.ns_tts,"extent");if(null===a)return null;var d=a.split(" ");if(2!==d.length)return T(b,"Malformed extent (ignoring)"),null;a=q.parseLength(d[0]);d=q.parseLength(d[1]);return d&&a?{h:d,w:a}:(T(b,"Malformed extent values (ignoring)"),null)}function Z(a,b,d){var c=/^(\d{2,}):(\d\d):(\d\d(?:\.\d+)?)$/,e=/^(\d{2,}):(\d\d):(\d\d):(\d{2,})$/,
...
null!==(l=e.exec(d))&&null!==b&&(u=3600*parseInt(l[1])+60*parseInt(l[2])+parseInt(l[3])+(null===l[4]?0:parseInt(l[4])/b));return u}function p(a,b,d){for(;0<b.styleRefs.length;){var c=b.styleRefs.pop();c in a.styles?(p(a,a.styles[c],d),S(a.styles[c].styleAttrs,b.styleAttrs)):K(d,"Non-existant style id referenced")}}function Y(a,b,d,c){for(var e=b.length-1;0<=e;e--){var h=b[e];h in a.styles?S(a.styles[h].styleAttrs,d):K(c,"Non-existant style id referenced")}}function S(a,b){for(var d in a)d in b||(b[d]=
a[d])}function T(a,b){if(a&&a.warn&&a.warn(b))throw b;}function K(a,b){if(a&&a.error&&a.error(b))throw b;}function P(a,b){a&&a.fatal&&a.fatal(b);throw b;}function ba(a,b){for(var d=0,c=a.length-1,e;d<=c;){e=Math.floor((d+c)/2);var h=a[e];if(h<b)d=e+1;else if(h>b)c=e-1;else return{found:!0,index:e}}return{found:!1,index:d}}a.fromXML=function(a,f,z){var q=c.parser(!0,{xmlns:!0}),v=[],B=[],X=[],W=0,x=null;q.onclosetag=function(a){if(v[0]instanceof h)for(var b in v[0].styles)p(v[0],v[0].styles[b],f);
else if(v[0]instanceof F||v[0]instanceof E){if(1<v[0].contents.length){a=[v[0].contents[0]];for(b=1;b<v[0].contents.length;b++)v[0].contents[b]instanceof y&&a[a.length-1]instanceof y?a[a.length-1].text+=v[0].contents[b].text:a.push(v[0].contents[b]);v[0].contents=a}v[0]instanceof E&&1===v[0].contents.length&&v[0].contents[0]instanceof y&&(v[0].text=v[0].contents[0].text,delete v[0].contents)}else if(v[0]instanceof n)if(v[0].node.uri===e.ns_tt&&"metadata"===v[0].node.local)W--;else if(0<W&&z&&"onCloseTag"in
z)z.onCloseTag();X.shift();B.shift();v.shift()};q.ontext=function(a){if(void 0!==v[0])if(v[0]instanceof E||v[0]instanceof F){if(v[0]instanceof E){var b=v[0].styleAttrs[g.byName.ruby.qname];if("container"===b||"textContainer"===b||"baseContainer"===b)return}b=new y;b.initFromText(x,v[0],a,X[0],f);v[0].contents.push(b)}else if(v[0]instanceof n&&0<W&&z&&"onText"in z)z.onText(a)};q.onopentag=function(a){function d(a){e.ttaf_map[a.uri]&&(a.uri=e.ttaf_map[a.uri])}var c=a.attributes["xml:space"];c?X.unshift(c.value):
0===X.length?X.unshift("default"):X.unshift(X[0]);(c=a.attributes["xml:lang"])?B.unshift(c.value):0===B.length?B.unshift(""):B.unshift(B[0]);d(a);if(a.attributes)for(var k in a.attributes)a.attributes.hasOwnProperty(k)&&d(a.attributes[k]);if(a.uri===e.ns_tt)if("tt"===a.local)null!==x&&P(f,"Two <tt> elements at ("+this.line+","+this.column+")"),x=new w,x.initFromNode(a,f),v.unshift(x);else if("head"===a.local)v[0]instanceof w||P(f,"Parent of <head> element is not <tt> at ("+this.line+","+this.column+
")"),v.unshift(x.head);else if("styling"===a.local)v[0]instanceof b||P(f,"Parent of <styling> element is not <head> at ("+this.line+","+this.column+")"),v.unshift(x.head.styling);else if("style"===a.local)if(v[0]instanceof h){var l=new r;l.initFromNode(a,f);l.id?x.head.styling.styles[l.id]=l:K(f,"<style> element missing @id attribute");v.unshift(l)}else v[0]instanceof m?(l=new r,l.initFromNode(a,f),S(l.styleAttrs,v[0].styleAttrs),v.unshift(l)):P(f,"Parent of <style> element is not <styling> or <region> at ("+
this.line+","+this.column+")");else if("initial"===a.local)if(v[0]instanceof h){k=new u;k.initFromNode(a,f);for(l in k.styleAttrs)x.head.styling.initials[l]=k.styleAttrs[l];v.unshift(k)}else P(f,"Parent of <initial> element is not <styling> at ("+this.line+","+this.column+")");else if("layout"===a.local)v[0]instanceof b||P(f,"Parent of <layout> element is not <head> at "+this.line+","+this.column+")"),v.unshift(x.head.layout);else if("region"===a.local)v[0]instanceof A||P(f,"Parent of <region> element is not <layout> at "+
this.line+","+this.column+")"),l=new m,l.initFromNode(x,a,f),!l.id||l.id in x.head.layout.regions?K(f,"Ignoring <region> with duplicate or missing @id at "+this.line+","+this.column+")"):x.head.layout.regions[l.id]=l,v.unshift(l);else if("body"===a.local)v[0]instanceof w||P(f,"Parent of <body> element is not <tt> at "+this.line+","+this.column+")"),null!==x.body&&P(f,"Second <body> element at "+this.line+","+this.column+")"),l=new C,l.initFromNode(x,a,f),x.body=l,v.unshift(l);else if("div"===a.local){v[0]instanceof
L||v[0]instanceof C||P(f,"Parent of <div> element is not <body> or <div> at "+this.line+","+this.column+")");l=new L;l.initFromNode(x,v[0],a,f);if(k=l.styleAttrs[g.byName.backgroundImage.qname])l.contents.push(new D(k)),delete l.styleAttrs[g.byName.backgroundImage.qname];v[0].contents.push(l);v.unshift(l)}else"image"===a.local?(v[0]instanceof L||P(f,"Parent of <image> element is not <div> at "+this.line+","+this.column+")"),l=new D,l.initFromNode(x,v[0],a,f),v[0].contents.push(l),v.unshift(l)):"p"===
a.local?(v[0]instanceof L||P(f,"Parent of <p> element is not <div> at "+this.line+","+this.column+")"),l=new F,l.initFromNode(x,v[0],a,f),v[0].contents.push(l),v.unshift(l)):"span"===a.local?(v[0]instanceof E||v[0]instanceof F||P(f,"Parent of <span> element is not <span> or <p> at "+this.line+","+this.column+")"),l=new E,l.initFromNode(x,v[0],a,X[0],f),v[0].contents.push(l),v.unshift(l)):"br"===a.local?(v[0]instanceof E||v[0]instanceof F||P(f,"Parent of <br> element is not <span> or <p> at "+this.line+
","+this.column+")"),l=new V,l.initFromNode(x,v[0],a,f),v[0].contents.push(l),v.unshift(l)):"set"===a.local?(v[0]instanceof E||v[0]instanceof F||v[0]instanceof L||v[0]instanceof C||v[0]instanceof m||v[0]instanceof V||P(f,"Parent of <set> element is not a content element or a region at "+this.line+","+this.column+")"),l=new H,l.initFromNode(x,v[0],a,f),v[0].sets.push(l),v.unshift(l)):v.unshift(new n(a));else v.unshift(new n(a));if(v[0]instanceof n)if(a.uri===e.ns_tt&&"metadata"===a.local)W++;else if(0<
W&&z&&"onOpenTag"in z){l=[];for(var p in a.attributes)l[a.attributes[p].uri+" "+a.attributes[p].local]={uri:a.attributes[p].uri,local:a.attributes[p].local,value:a.attributes[p].value};z.onOpenTag(a.uri,a.local,l)}};q.write(a).close();delete x.head.styling.styles;a=!1;for(var t in x.head.layout.regions){a=!0;break}a||(t=m.prototype.createDefaultRegion(x,f),x.head.layout.regions[t.id]=t);for(var R in x.head.layout.regions)k(x,x.head.layout.regions[R],null,null);x.body&&k(x,x.body,null,null);x.body&&
d(x.body);x.body&&l(x.body);return x};w.prototype.initFromNode=function(a,b){var d=Q(a,e.ns_ttp,"cellResolution"),c=15;var f=32;null!==d&&(d=/(\d+) (\d+)/.exec(d),null!==d?(f=parseInt(d[1]),c=parseInt(d[2])):T(b,"Malformed cellResolution value (using initial value instead)"));this.cellLength={h:new q.ComputedLength(0,1/c),w:new q.ComputedLength(1/f,0)};c=Q(a,e.ns_ttp,"frameRate");d=30;null!==c&&(f=/(\d+)/.exec(c),null!==f?d=parseInt(f[1]):T(b,"Malformed frame rate attribute (using initial value instead)"));
f=Q(a,e.ns_ttp,"frameRateMultiplier");var h=1;null!==f&&(f=/(\d+) (\d+)/.exec(f),null!==f?h=parseInt(f[1])/parseInt(f[2]):T(b,"Malformed frame rate multiplier attribute (using initial value instead)"));d*=h;h=1;f=Q(a,e.ns_ttp,"tickRate");null===f?null!==c&&(h=d):(f=/(\d+)/.exec(f),null!==f?h=parseInt(f[1]):T(b,"Malformed tick rate attribute (using initial value instead)"));this.effectiveFrameRate=d;this.tickRate=h;f=Q(a,e.ns_ittp,"aspectRatio");null===f&&(f=Q(a,e.ns_ttp,"displayAspectRatio"));c=null;
null!==f&&(d=/(\d+)\s+(\d+)/.exec(f),null!==d?(f=parseInt(d[1]),d=parseInt(d[2]),0!==f&&0!==d?c=f/d:K(b,"Illegal aspectRatio values (ignoring)")):K(b,"Malformed aspectRatio attribute (ignoring)"));this.aspectRatio=c;c=Q(a,e.ns_ttp,"timeBase");null!==c&&"media"!==c&&P(b,"Unsupported time base");a=aa(a,b);null===a?this.pxLength={h:null,w:null}:("px"===a.h.unit&&"px"===a.w.unit||P(b,"Extent on TT must be in px or absent"),this.pxLength={h:new q.ComputedLength(0,1/a.h.value),w:new q.ComputedLength(1/
...
function(a,b){this.id=f(a);this.styleAttrs=U(a,b);this.styleRefs=I(a)};u.prototype.initFromNode=function(a,b){this.styleAttrs={};for(var d in a.attributes)if(a.attributes[d].uri===e.ns_itts||a.attributes[d].uri===e.ns_ebutts||a.attributes[d].uri===e.ns_tts)this.styleAttrs[a.attributes[d].uri+" "+a.attributes[d].local]=a.attributes[d].value};D.prototype.initFromNode=function(a,b,d,c){(this.src="src"in d.attributes?d.attributes.src.value:null)||K(c,"Invalid image@src attribute");(this.type="type"in
d.attributes?d.attributes.type.value:null)||K(c,"Invalid image@type attribute");M.prototype.initFromNode.call(this,a,b,d,c);G.prototype.initFromNode.call(this,a,b,d,c);B.prototype.initFromNode.call(this,a,b,d,c);N.prototype.initFromNode.call(this,a,b,d,c)};x.prototype.initFromNode=function(a,b,d,c){this.id=f(d)};N.prototype.initFromNode=function(a,b,d,c){this.regionID=d&&"region"in d.attributes?d.attributes.region.value:""};M.prototype.initFromNode=function(a,b,d,c){this.styleAttrs=U(d,c);null!==
a.head&&null!==a.head.styling&&Y(a.head.styling,I(d),this.styleAttrs,c)};B.prototype.initFromNode=function(a,b,d,c){this.sets=[]};J.prototype.initFromNode=function(a,b,d,c){this.contents=[]};G.prototype.initFromNode=function(a,b,d,c){b=null;d&&"begin"in d.attributes&&(b=Z(a.tickRate,a.effectiveFrameRate,d.attributes.begin.value),null===b&&T(c,"Malformed begin value "+d.attributes.begin.value+" (using 0)"));var f=null;d&&"dur"in d.attributes&&(f=Z(a.tickRate,a.effectiveFrameRate,d.attributes.dur.value),
null===f&&T(c,"Malformed dur value "+d.attributes.dur.value+" (ignoring)"));var e=null;d&&"end"in d.attributes&&(e=Z(a.tickRate,a.effectiveFrameRate,d.attributes.end.value),null===e&&T(c,"Malformed end value (ignoring)"));this.explicit_begin=b;this.explicit_end=e;this.explicit_dur=f;(a=d&&"timeContainer"in d.attributes?d.attributes.timeContainer.value:null)&&"par"!==a?"seq"===a?c="seq":(K(c,"Illegal value of timeContainer (assuming 'par')"),c="par"):c="par";this.timeContainer=c};C.prototype.initFromNode=
function(a,b,d){M.prototype.initFromNode.call(this,a,null,b,d);G.prototype.initFromNode.call(this,a,null,b,d);B.prototype.initFromNode.call(this,a,null,b,d);N.prototype.initFromNode.call(this,a,null,b,d);J.prototype.initFromNode.call(this,a,null,b,d)};L.prototype.initFromNode=function(a,b,d,c){M.prototype.initFromNode.call(this,a,b,d,c);G.prototype.initFromNode.call(this,a,b,d,c);B.prototype.initFromNode.call(this,a,b,d,c);N.prototype.initFromNode.call(this,a,b,d,c);J.prototype.initFromNode.call(this,
a,b,d,c)};F.prototype.initFromNode=function(a,b,d,c){M.prototype.initFromNode.call(this,a,b,d,c);G.prototype.initFromNode.call(this,a,b,d,c);B.prototype.initFromNode.call(this,a,b,d,c);N.prototype.initFromNode.call(this,a,b,d,c);J.prototype.initFromNode.call(this,a,b,d,c)};E.prototype.initFromNode=function(a,b,d,c,f){M.prototype.initFromNode.call(this,a,b,d,f);G.prototype.initFromNode.call(this,a,b,d,f);B.prototype.initFromNode.call(this,a,b,d,f);N.prototype.initFromNode.call(this,a,b,d,f);J.prototype.initFromNode.call(this,
a,b,d,f);this.space=c};y.prototype.initFromText=function(a,b,d,c,f){G.prototype.initFromNode.call(this,a,b,null,f);this.text=d;this.space=c};V.prototype.initFromNode=function(a,b,d,c){N.prototype.initFromNode.call(this,a,b,d,c);G.prototype.initFromNode.call(this,a,b,d,c)};m.prototype.createDefaultRegion=function(a,b){var d=new m;d.id="";M.prototype.initFromNode.call(d,a,null,{name:"region",attributes:{"tts:displayAlign":{name:"tts:displayAlign",value:"after",prefix:"tts",local:"displayAlign",uri:"http://www.w3.org/ns/ttml#styling"},
...
itts:"http://www.w3.org/ns/ttml/profile/imsc1#styling",ttm:"http://www.w3.org/ns/ttml#metadata",ttp:"http://www.w3.org/ns/ttml#parameter",tts:"http://www.w3.org/ns/ttml#styling",xml:"http://www.w3.org/XML/1998/namespace"},prefix:"",local:"region",uri:"http://www.w3.org/ns/ttml",isSelfClosing:!0},b);d.sets=[];G.call(d,0,Number.POSITIVE_INFINITY,null);return d};m.prototype.initFromNode=function(a,b,d){x.prototype.initFromNode.call(this,a,null,b,d);M.prototype.initFromNode.call(this,a,null,b,d);G.prototype.initFromNode.call(this,
a,null,b,d);B.prototype.initFromNode.call(this,a,null,b,d);null!==a.head&&null!==a.head.styling&&Y(a.head.styling,I(b),this.styleAttrs,d)};H.prototype.initFromNode=function(a,b,d,c){G.prototype.initFromNode.call(this,a,b,d,c);a=U(d,c);this.value=this.qname=null;for(var f in a){if(this.qname){K(c,"More than one style specified on set");break}this.qname=f;this.value=a[f]}}})("undefined"===typeof g?this.imscDoc={}:g,"undefined"===typeof sax?e("sax"):sax,"undefined"===typeof imscNames?e("./names"):imscNames,
...
t;var B=document.createElement("rtc");B.style.rubyPosition="over";B.textContent="\u200b";B.style.fontSize=t;h.appendChild(r);h.appendChild(B)}else r=document.createElement("rtc"),r.textContent="\u200b",r.style.fontSize=t,r.style.rubyPosition="after"===a.rubyReserve[0]||"outside"===a.rubyReserve[0]&&0<c?"tb"===a.bpd||"rl"===a.bpd?"under":"over":"tb"===a.bpd||"rl"===a.bpd?"over":"under",h.appendChild(r);n[c].elements[0].node.parentElement.insertBefore(h,n[c].elements[0].node)}a.rubyReserve=null}if(a.ruby||
...
"left under":0===c?"left under":"right under");a.textEmphasis=null}if(a.mra){for(c=0;c<n.length-1;c++)r=n[c].elements.length,0!==r&&!1===n[c].br&&(h=document.createElement("br"),r=n[c].elements[r-1].node,r.parentElement.insertBefore(h,r.nextSibling));a.mra=null}if(a.lp){c=a.lp.toUsedLength(a.w,a.h);for(var J in n)h=n[J].elements[n[J].start_elem],r=n[J].elements[n[J].end_elem],B=Math.ceil(c)+"px",t="-"+Math.ceil(c)+"px",0!==n[J].elements.length&&("lr"===a.ipd?(h.node.style.borderLeftColor=h.bgcolor||
"#00000000",h.node.style.borderLeftStyle="solid",h.node.style.borderLeftWidth=B,h.node.style.marginLeft=t):"rl"===a.ipd?(h.node.style.borderRightColor=h.bgcolor||"#00000000",h.node.style.borderRightStyle="solid",h.node.style.borderRightWidth=B,h.node.style.marginRight=t):"tb"===a.ipd&&(h.node.style.borderTopColor=h.bgcolor||"#00000000",h.node.style.borderTopStyle="solid",h.node.style.borderTopWidth=B,h.node.style.marginTop=t),"lr"===a.ipd?(r.node.style.borderRightColor=r.bgcolor||"#00000000",r.node.style.borderRightStyle=
"solid",r.node.style.borderRightWidth=B,r.node.style.marginRight=t):"rl"===a.ipd?(r.node.style.borderLeftColor=r.bgcolor||"#00000000",r.node.style.borderLeftStyle="solid",r.node.style.borderLeftWidth=B,r.node.style.marginLeft=t):"tb"===a.ipd&&(r.node.style.borderBottomColor=r.bgcolor||"#00000000",r.node.style.borderBottomStyle="solid",r.node.style.borderBottomWidth=B,r.node.style.marginBottom=t));a.lp=null}if(a.flg){c=q(w.getBoundingClientRect(),a);J=c.before;c=c.after;h=Math.sign(c-J);for(r=0;r<=
n.length;r++){B=0===r?J:r===n.length?c:(n[r].before+n[r-1].after)/2;if(0<r)for(var G=0;G<n[r-1].elements.length;G++)if(null!==n[r-1].elements[G].bgcolor){var C=n[r-1].elements[G];0>h*(C.after-B)&&(t=Math.ceil(Math.abs(B-C.after))+"px",C.node.style.backgroundColor=C.bgcolor,"lr"===a.bpd?C.node.style.paddingRight=t:"rl"===a.bpd?C.node.style.paddingLeft=t:"tb"===a.bpd&&(C.node.style.paddingBottom=t))}if(r<n.length)for(G=0;G<n[r].elements.length;G++)C=n[r].elements[G],null!==C.bgcolor&&0<h*(C.before-
B)&&(t=Math.ceil(Math.abs(C.before-B))+"px",C.node.style.backgroundColor=C.bgcolor,"lr"===a.bpd?C.node.style.paddingLeft=t:"rl"===a.bpd?C.node.style.paddingRight=t:"tb"===a.bpd&&(C.node.style.paddingTop=t))}a.flg=null}}"region"===k.kind&&(d(a,w,n),"tb"===a.bpd&&a.enableRollUp&&0<k.contents.length&&"after"===k.styleAttrs[e.byName.displayAlign.qname]&&(k=new g(""===k.id?"_":k.id,n),a.currentISDState[k.id]=k,a.previousISDState&&k.id in a.previousISDState&&0<a.previousISDState[k.id].plist.length&&1<k.plist.length&&
...
{}:g,"undefined"===typeof imscNames?e("./names"):imscNames,"undefined"===typeof imscStyles?e("./styles"):imscStyles,"undefined"===typeof imscUtils?e("./utils"):imscUtils)},{"./names":37,"./styles":38,"./utils":39}],35:[function(e,q,g){(function(a,c,e,g){function l(a,c,k,q,t,D,x,F,M){if(c<x.begin||c>=x.end)return null;D="regionID"in x&&""!==x.regionID?x.regionID:D;if(null!==t&&D!==k.id&&(!("contents"in x)||"contents"in x&&0===x.contents.length||""!==D))return null;var b=new z(x);for(h in x.sets)c<
x.sets[h].begin||c>=x.sets[h].end||(b.styleAttrs[x.sets[h].qname]=x.sets[h].value);var h={};for(var r in b.styleAttrs)if(h[r]=!0,r===e.byName.writingMode.qname&&!(e.byName.direction.qname in b.styleAttrs)){var u=b.styleAttrs[r];if("lrtb"===u||"lr"===u)b.styleAttrs[e.byName.direction.qname]="ltr";else if("rltb"===u||"rl"===u)b.styleAttrs[e.byName.direction.qname]="rtl"}if(null!==t)for(var A in e.all)if(r=e.all[A],r.qname===e.byName.textDecoration.qname){u=t.styleAttrs[r.qname];var O=b.styleAttrs[r.qname],
E=[];void 0===O?E=u:-1===O.indexOf("none")?((-1===O.indexOf("noUnderline")&&-1!==u.indexOf("underline")||-1!==O.indexOf("underline"))&&E.push("underline"),(-1===O.indexOf("noLineThrough")&&-1!==u.indexOf("lineThrough")||-1!==O.indexOf("lineThrough"))&&E.push("lineThrough"),(-1===O.indexOf("noOverline")&&-1!==u.indexOf("overline")||-1!==O.indexOf("overline"))&&E.push("overline")):E.push("none");b.styleAttrs[r.qname]=E}else r.qname!==e.byName.fontSize.qname||r.qname in b.styleAttrs||"span"!==b.kind||
...
new g.ComputedLength(.5*u.rw,.5*u.rh));for(var y in e.all)(A=e.all[y],A.qname in b.styleAttrs||A.qname===e.byName.position.qname&&e.byName.origin.qname in b.styleAttrs||A.qname===e.byName.origin.qname&&e.byName.position.qname in b.styleAttrs||(r=a.head.styling.initials[A.qname]||A.initial,"region"!==b.kind&&(!1!==A.inherit||null===r)))||(b.styleAttrs[A.qname]=A.parse(r),h[A.qname]=!0);for(var N in e.all)if(y=e.all[N],y.qname in h&&null!==y.compute)if(A=y.compute(a,t,b,b.styleAttrs[y.qname],M),null!==
A)b.styleAttrs[y.qname]=A;else if(b.styleAttrs[y.qname]=y.compute(a,t,b,y.parse(y.initial),M),y="Style '"+y.qname+"' on element '"+b.kind+"' cannot be computed",F&&F.error&&F.error(y))throw y;if("none"===b.styleAttrs[e.byName.display.qname])return null;if(null===t)var m=null===q?[]:[q];else"contents"in x&&(m=x.contents);for(var H in m)t=l(a,c,k,q,b,D,m[H],F,M),null!==t&&b.contents.push(t.element);for(var f in b.styleAttrs)a=!1,"span"===b.kind&&(c=b.styleAttrs[e.byName.ruby.qname],(a=("container"===
...
a.contents.length}}function k(a){this.contents=[];this.aspectRatio=a.aspectRatio}function z(a){this.kind=a.kind||"region";a.id&&(this.id=a.id);this.styleAttrs={};for(var b in a.styleAttrs)this.styleAttrs[b]=a.styleAttrs[b];"src"in a&&(this.src=a.src);"type"in a&&(this.type=a.type);if("text"in a)this.text=a.text;else if("region"===this.kind||"contents"in a)this.contents=[];"space"in a&&(this.space=a.space)}a.generateISD=function(a,d,c){var b=new k(a),e={},h={},g=new Set;for(w in a.body)h[w]=a.body[w];
h.contents=[];a.body.contents.forEach(function(a,b){var c=a.contents.filter(function(a){return d<a.begin||d>=a.end?!1:(a.regionID&&g.add(a.regionID),!0)}),e={},k;for(k in a)e[k]=a[k];e.contents=c;h.contents[b]=e});0===g.length&&a.head.layout.regions[""]&&g.add("");for(var n in g){var w=l(a,d,a.head.layout.regions[g[n]],h,null,"",a.head.layout.regions[g[n]],c,e);null!==w&&b.contents.push(w.element)}return b};var w=[e.byName.color.qname,e.byName.textCombine.qname,e.byName.textDecoration.qname,e.byName.textEmphasis.qname,
...
!0,function(a){if("none"===a)return a;var c={};a=a.split(" ");if(0===a.length||2<a.length)return null;var d=e.parseColor(a[0]);c.color=d;null!==d&&a.shift();if(1!==a.length)return null;a=e.parseLength(a[0]);if(!a)return null;c.thickness=a;return c},function(c,k,g,l,b){if("none"===l)return l;k={};k.color=null===l.color?g.styleAttrs[a.byName.color.qname]:l.color;k.thickness=e.toComputedLength(l.thickness.value,l.thickness.unit,g.styleAttrs[a.byName.fontSize.qname],g.styleAttrs[a.byName.fontSize.qname],
c.cellLength.h,c.pxLength.h);return null===k.thickness?null:k}),new g(c.ns_tts,"textShadow","none",["span"],!0,!0,e.parseTextShadow,function(c,k,g,l){if("none"===l)return l;k=[];for(var b in l){var d={};d.x_off=e.toComputedLength(l[b][0].value,l[b][0].unit,null,g.styleAttrs[a.byName.fontSize.qname],null,c.pxLength.w);if(null===d.x_off)return null;d.y_off=e.toComputedLength(l[b][1].value,l[b][1].unit,null,g.styleAttrs[a.byName.fontSize.qname],null,c.pxLength.h);if(null===d.y_off)return null;if(null===
