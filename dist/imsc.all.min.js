...
a=a!==a),a?g(0):B(k);if("Buffer"===k.type&&Array.isArray(k.data))return B(k.data)}function h(k){if(2147483647<=k)throw new RangeError("Attempt to allocate Buffer larger than maximum size: 0x"+(2147483647).toString(16)+" bytes");return k|0}function D(k,a){if(c.isBuffer(k))return k.length;if(ArrayBuffer.isView(k)||K(k,ArrayBuffer))return k.byteLength;if("string"!==typeof k)throw new TypeError('The "string" argument must be one of type string, Buffer, or ArrayBuffer. Received type '+typeof k);var e=
k.length,t=2<arguments.length&&!0===arguments[2];if(!t&&0===e)return 0;for(var b=!1;;)switch(a){case "ascii":case "latin1":case "binary":return e;case "utf8":case "utf-8":return M(k).length;case "ucs2":case "ucs-2":case "utf16le":case "utf-16le":return 2*e;case "hex":return e>>>1;case "base64":return O.toByteArray(E(k)).length;default:if(b)return t?-1:M(k).length;a=(""+a).toLowerCase();b=!0}}function q(k,a,e){var t=!1;if(void 0===a||0>a)a=0;if(a>this.length)return"";if(void 0===e||e>this.length)e=
...
case "base64":return a=0===a&&e===this.length?O.fromByteArray(this):O.fromByteArray(this.slice(a,e)),a;case "ucs2":case "ucs-2":case "utf16le":case "utf-16le":a=this.slice(a,e);e="";for(k=0;k<a.length;k+=2)e+=String.fromCharCode(a[k]+256*a[k+1]);return e;default:if(t)throw new TypeError("Unknown encoding: "+k);k=(k+"").toLowerCase();t=!0}}function a(k,a,e){var t=k[a];k[a]=k[e];k[e]=t}function f(k,a,e,t,b){if(0===k.length)return-1;"string"===typeof e?(t=e,e=0):2147483647<e?e=2147483647:-2147483648>
...
65536,t.push(c>>>10&1023|55296),c=56320|c&1023);t.push(c);a+=I}k=t.length;if(k<=A)t=String.fromCharCode.apply(String,t);else{e="";for(a=0;a<k;)e+=String.fromCharCode.apply(String,t.slice(a,a+=A));t=e}return t}function C(k,a,e){if(0!==k%1||0>k)throw new RangeError("offset is not uint");if(k+a>e)throw new RangeError("Trying to access beyond buffer length");}function F(k,a,e,b,f,n){if(!c.isBuffer(k))throw new TypeError('"buffer" argument must be a Buffer instance');if(a>f||a<n)throw new RangeError('"value" argument is out of bounds');
if(e+b>k.length)throw new RangeError("Index out of range");}function y(k,a,e,b,c,f){if(e+b>k.length)throw new RangeError("Index out of range");if(0>e)throw new RangeError("Index out of range");}function U(k,a,e,b,c){a=+a;e>>>=0;c||y(k,a,e,4,3.4028234663852886E38,-3.4028234663852886E38);G.write(k,a,e,b,23,4);return e+4}function r(k,a,e,b,c){a=+a;e>>>=0;c||y(k,a,e,8,1.7976931348623157E308,-1.7976931348623157E308);G.write(k,a,e,b,52,8);return e+8}function E(k){k=k.split("=")[0];k=k.trim().replace(R,
"");if(2>k.length)return"";for(;0!==k.length%4;)k+="=";return k}function M(k,a){a=a||Infinity;for(var e,b=k.length,c=null,f=[],I=0;I<b;++I){e=k.charCodeAt(I);if(55295<e&&57344>e){if(!c){if(56319<e){-1<(a-=3)&&f.push(239,191,189);continue}else if(I+1===b){-1<(a-=3)&&f.push(239,191,189);continue}c=e;continue}if(56320>e){-1<(a-=3)&&f.push(239,191,189);c=e;continue}e=(c-55296<<10|e-56320)+65536}else c&&-1<(a-=3)&&f.push(239,191,189);c=null;if(128>e){if(0>--a)break;f.push(e)}else if(2048>e){if(0>(a-=2))break;
f.push(e>>6|192,e&63|128)}else if(65536>e){if(0>(a-=3))break;f.push(e>>12|224,e>>6&63|128,e&63|128)}else if(1114112>e){if(0>(a-=4))break;f.push(e>>18|240,e>>12&63|128,e>>6&63|128,e&63|128)}else throw Error("Invalid code point");}return f}function H(a){for(var k=[],e=0;e<a.length;++e)k.push(a.charCodeAt(e)&255);return k}function z(a,b,e,t){for(var k=0;k<t&&!(k+e>=b.length||k>=a.length);++k)b[k+e]=a[k];return k}function K(a,b){return a instanceof b||null!=a&&null!=a.constructor&&null!=a.constructor.name&&
a.constructor.name===b.name}var O=d("base64-js"),G=d("ieee754");m.Buffer=c;m.SlowBuffer=function(a){+a!=a&&(a=0);return c.alloc(+a)};m.INSPECT_MAX_BYTES=50;m.kMaxLength=2147483647;c.TYPED_ARRAY_SUPPORT=function(){try{var a=new Uint8Array(1);a.__proto__={__proto__:Uint8Array.prototype,foo:function(){return 42}};return 42===a.foo()}catch(I){return!1}}();c.TYPED_ARRAY_SUPPORT||"undefined"===typeof console||"function"!==typeof console.error||console.error("This browser lacks typed array (Uint8Array) support which is required by `buffer` v5.x. Use `buffer` v4.x if you require old browser support.");
...
t||(t="utf8");for(k=!1;;)switch(t){case "hex":a:{b=Number(b)||0;t=this.length-b;e?(e=Number(e),e>t&&(e=t)):e=t;t=a.length;e>t/2&&(e=t/2);for(t=0;t<e;++t){k=parseInt(a.substr(2*t,2),16);if(k!==k){a=t;break a}this[b+t]=k}a=t}return a;case "utf8":case "utf-8":return z(M(a,this.length-b),this,b,e);case "ascii":return z(H(a),this,b,e);case "latin1":case "binary":return z(H(a),this,b,e);case "base64":return z(O.toByteArray(E(a)),this,b,e);case "ucs2":case "ucs-2":case "utf16le":case "utf-16le":t=a;k=this.length-
...
void 0;c.prototype._maxListeners=void 0;var n=10;try{d={};Object.defineProperty&&Object.defineProperty(d,"x",{value:0});var C=0===d.x}catch(F){C=!1}C?Object.defineProperty(c,"defaultMaxListeners",{enumerable:!0,get:function(){return n},set:function(a){if("number"!==typeof a||0>a||a!==a)throw new TypeError('"defaultMaxListeners" must be a positive number');n=a}}):c.defaultMaxListeners=n;c.prototype.setMaxListeners=function(a){if("number"!==typeof a||0>a||isNaN(a))throw new TypeError('"n" argument must be a positive number');
...
}function l(a){if(D===setTimeout)return setTimeout(a,0);if((D===c||!D)&&setTimeout)return D=setTimeout,setTimeout(a,0);try{return D(a,0)}catch(F){try{return D.call(null,a,0)}catch(y){return D.call(this,a,0)}}}function p(a){if(q===clearTimeout)return clearTimeout(a);if((q===g||!q)&&clearTimeout)return q=clearTimeout,clearTimeout(a);try{return q(a)}catch(F){try{return q.call(null,a)}catch(y){return q.call(this,a)}}}function w(){f&&v&&(f=!1,v.length?a=v.concat(a):n=-1,a.length&&B())}function B(){if(!f){var b=
...
c.head.data.length)b=c.head.data.slice(0,a),c.head.data=c.head.data.slice(a);else{if(a===c.head.data.length)c=c.shift();else if(b){b=c.head;var e=1,f=b.data;for(a-=f.length;b=b.next;){var n=b.data,d=a>n.length?n.length:a;f=d===n.length?f+n:f+n.slice(0,a);a-=d;if(0===a){d===n.length?(++e,c.head=b.next?b.next:c.tail=null):(c.head=b,b.data=n.slice(d));break}++e}c.length-=e;c=f}else{b=K.allocUnsafe(a);e=c.head;f=1;e.data.copy(b);for(a-=e.data.length;e=e.next;){n=e.data;d=a>n.length?n.length:a;n.copy(b,
b.length-a,0,d);a-=d;if(0===a){d===n.length?(++f,c.head=e.next?e.next:c.tail=null):(c.head=e,e.data=n.slice(d));break}++f}c.length-=f;c=b}b=c}c=b}return c}function y(a){var b=a._readableState;if(0<b.length)throw Error('"endReadable()" called on non-empty stream');b.endEmitted||(b.ended=!0,E.nextTick(U,b,a))}function U(a,b){a.endEmitted||0!==a.length||(a.endEmitted=!0,b.readable=!1,b.emit("end"))}function L(a,b){for(var c=0,e=a.length;c<e;c++)if(a[c]===b)return c;return-1}var E=d("process-nextick-args");
r.exports=w;var M=d("isarray"),H;w.ReadableState=p;d("events");var z=d("./internal/streams/stream"),K=d("safe-buffer").Buffer,O=g.Uint8Array||function(){};g=Object.create(d("core-util-is"));g.inherits=d("inherits");var G=d("util"),A=void 0;A=G&&G.debuglog?G.debuglog("stream"):function(){};var R=d("./internal/streams/BufferList");G=d("./internal/streams/destroy");var k;g.inherits(w,z);var I=["error","close","destroy","pause","resume"];Object.defineProperty(w.prototype,"destroyed",{get:function(){return void 0===
this._readableState?!1:this._readableState.destroyed},set:function(a){this._readableState&&(this._readableState.destroyed=a)}});w.prototype.destroy=G.destroy;w.prototype._undestroy=G.undestroy;w.prototype._destroy=function(a,b){this.push(null);b(a)};w.prototype.push=function(a,b){var c=this._readableState;if(c.objectMode)var f=!0;else"string"===typeof a&&(b=b||c.defaultEncoding,b!==c.encoding&&(a=K.from(a,b),b=""),f=!0);return B(this,a,b,!1,f)};w.prototype.unshift=function(a){return B(this,a,null,
...
null!==f&&this.emit("data",f);return f};w.prototype._read=function(a){this.emit("error",Error("_read() is not implemented"))};w.prototype.pipe=function(a,b){function e(b,c){A("onunpipe");b===g&&c&&!1===c.hasUnpiped&&(c.hasUnpiped=!0,A("cleanup"),a.removeListener("close",k),a.removeListener("finish",v),a.removeListener("drain",q),a.removeListener("error",h),a.removeListener("unpipe",e),g.removeListener("end",n),g.removeListener("end",T),g.removeListener("data",d),p=!0,!J.awaitDrain||a._writableState&&
!a._writableState.needDrain||q())}function n(){A("onend");a.end()}function d(b){A("ondata");N=!1;!1!==a.write(b)||N||((1===J.pipesCount&&J.pipes===a||1<J.pipesCount&&-1!==L(J.pipes,a))&&!p&&(A("false write response, pause",g._readableState.awaitDrain),g._readableState.awaitDrain++,N=!0),g.pause())}function h(b){A("onerror",b);T();a.removeListener("error",h);0===a.listeners("error").length&&a.emit("error",b)}function k(){a.removeListener("finish",v);T()}function v(){A("onfinish");a.removeListener("close",
k);T()}function T(){A("unpipe");g.unpipe(a)}var g=this,J=this._readableState;switch(J.pipesCount){case 0:J.pipes=a;break;case 1:J.pipes=[J.pipes,a];break;default:J.pipes.push(a)}J.pipesCount+=1;A("pipe count=%d opts=%j",J.pipesCount,b);b=b&&!1===b.end||a===c.stdout||a===c.stderr?T:n;if(J.endEmitted)E.nextTick(b);else g.once("end",b);a.on("unpipe",e);var q=f(g);a.on("drain",q);var p=!1,N=!1;g.on("data",d);l(a,"error",h);a.once("close",k);a.once("finish",v);a.emit("pipe",g);J.flowing||(A("pipe resume"),
g.resume());return a};w.prototype.unpipe=function(a){var b=this._readableState,c={hasUnpiped:!1};if(0===b.pipesCount)return this;if(1===b.pipesCount){if(a&&a!==b.pipes)return this;a||(a=b.pipes);b.pipes=null;b.pipesCount=0;b.flowing=!1;a&&a.emit("unpipe",this,c);return this}if(!a){a=b.pipes;var f=b.pipesCount;b.pipes=null;b.pipesCount=0;b.flowing=!1;for(b=0;b<f;b++)a[b].emit("unpipe",this,c);return this}f=L(b.pipes,a);if(-1===f)return this;b.pipes.splice(f,1);--b.pipesCount;1===b.pipesCount&&(b.pipes=
...
var n=d("process-nextick-args");r.exports=b;var C=!c.browser&&-1<["v0.10","v0.9."].indexOf(c.version.slice(0,5))?l:n.nextTick,F;b.WritableState=m;c=Object.create(d("core-util-is"));c.inherits=d("inherits");var y={deprecate:d("util-deprecate")},U=d("./internal/streams/stream"),L=d("safe-buffer").Buffer,E=g.Uint8Array||function(){};g=d("./internal/streams/destroy");c.inherits(b,U);m.prototype.getBuffer=function(){for(var a=this.bufferedRequest,b=[];a;)b.push(a),a=a.next;return b};(function(){try{Object.defineProperty(m.prototype,
"buffer",{get:y.deprecate(function(){return this.getBuffer()},"_writableState.buffer is deprecated. Use _writableState.getBuffer instead.","DEP0003")})}catch(H){}})();if("function"===typeof Symbol&&Symbol.hasInstance&&"function"===typeof Function.prototype[Symbol.hasInstance]){var M=Function.prototype[Symbol.hasInstance];Object.defineProperty(b,Symbol.hasInstance,{value:function(a){return M.call(this,a)?!0:this!==b?!1:a&&a._writableState instanceof m}})}else M=function(a){return a instanceof this};
b.prototype.pipe=function(){this.emit("error",Error("Cannot pipe, not readable"))};b.prototype.write=function(a,b,c){var f=this._writableState,d=!1,g;if(g=!f.objectMode)g=a,g=L.isBuffer(g)||g instanceof E;g&&!L.isBuffer(a)&&(a=L.from(a));"function"===typeof b&&(c=b,b=null);g?b="buffer":b||(b=f.defaultEncoding);"function"!==typeof c&&(c=w);if(f.ended)f=c,c=Error("write after end"),this.emit("error",c),n.nextTick(f,c);else{var v;if(!(v=g)){v=a;var k=c,l=!0,e=!1;null===v?e=new TypeError("May not write null values to stream"):
"string"===typeof v||void 0===v||f.objectMode||(e=new TypeError("Invalid non-string/buffer chunk"));e&&(this.emit("error",e),n.nextTick(k,e),l=!1);v=l}v&&(f.pendingcb++,d=g,d||(g=a,f.objectMode||!1===f.decodeStrings||"string"!==typeof g||(g=L.from(g,b)),a!==g&&(d=!0,b="buffer",a=g)),v=f.objectMode?1:a.length,f.length+=v,g=f.length<f.highWaterMark,g||(f.needDrain=!0),f.writing||f.corked?(v=f.lastBufferedRequest,f.lastBufferedRequest={chunk:a,encoding:b,isBuf:d,callback:c,next:null},v?v.next=f.lastBufferedRequest:
...
"\n"===e?(this.line++,this.column=0):this.column++);switch(this.state){case u.BEGIN:this.state=u.BEGIN_WHITESPACE;if("\ufeff"===e)continue;U(this,e);continue;case u.BEGIN_WHITESPACE:U(this,e);continue;case u.TEXT:if(this.sawRoot&&!this.closedRoot){for(var v=d-1;e&&"<"!==e&&"&"!==e;)(e=L(c,d++))&&this.trackPosition&&(this.position++,"\n"===e?(this.line++,this.column=0):this.column++);this.textNode+=c.substring(v,d-1)}"<"!==e||this.sawRoot&&this.closedRoot&&!this.strict?(r(z,e)||this.sawRoot&&!this.closedRoot||
...
else if(r(z,e))continue;else r(W,e)?this.tagName=e:this.script?(this.script+="</"+e,this.state=u.SCRIPT):f(this,"Invalid tagname in closing tag.");continue;case u.CLOSE_TAG_SAW_WHITE:if(r(z,e))continue;">"===e?F(this):f(this,"Invalid characters in closing tag");continue;case u.TEXT_ENTITY:case u.ATTRIB_VALUE_ENTITY_Q:case u.ATTRIB_VALUE_ENTITY_U:switch(this.state){case u.TEXT_ENTITY:var N=u.TEXT;var S="textNode";break;case u.ATTRIB_VALUE_ENTITY_Q:N=u.ATTRIB_VALUE_QUOTED;S="attribValue";break;case u.ATTRIB_VALUE_ENTITY_U:N=
u.ATTRIB_VALUE_UNQUOTED,S="attribValue"}";"===e?(this[S]+=y(this),this.entity="",this.state=N):r(this.entity.length?Y:aa,e)?this.entity+=e:(f(this,"Invalid character in entity name"),this[S]+="&"+this.entity+e,this.entity="",this.state=N);continue;default:throw Error(this,"Unknown state: "+this.state);}}if(this.position>=this.bufferCheckPosition){c=Math.max(g.MAX_BUFFER_LENGTH,10);e=d=0;for(N=E.length;e<N;e++){S=this[E[e]].length;if(S>c)switch(E[e]){case "textNode":h(this);break;case "cdata":b(this,
"oncdata",this.cdata);this.cdata="";break;case "script":b(this,"onscript",this.script);this.script="";break;default:q(this,"Max buffer length exceeded: "+E[e])}d=Math.max(d,S)}this.bufferCheckPosition=g.MAX_BUFFER_LENGTH-d+this.position}return this},resume:function(){this.error=null;return this},close:function(){return this.write(null)},flush:function(){h(this);""!==this.cdata&&(b(this,"oncdata",this.cdata),this.cdata="");""!==this.script&&(b(this,"onscript",this.script),this.script="")}};try{var M=
d("stream").Stream}catch(T){M=function(){}}var H=g.EVENTS.filter(function(a){return"error"!==a&&"end"!==a});p.prototype=Object.create(M.prototype,{constructor:{value:p}});p.prototype.write=function(a){"function"===typeof c&&"function"===typeof c.isBuffer&&c.isBuffer(a)&&(this._decoder||(this._decoder=new (d("string_decoder").StringDecoder)("utf8")),a=this._decoder.write(a));this._parser.write(a.toString());this.emit("data",a);return!0};p.prototype.end=function(a){a&&a.length&&this.write(a);this._parser.end();
return!0};p.prototype.on=function(a,b){var c=this;c._parser["on"+a]||-1===H.indexOf(a)||(c._parser["on"+a]=function(){var b=1===arguments.length?[arguments[0]]:Array.apply(null,arguments);b.splice(0,0,a);c.emit.apply(c,b)});return M.prototype.on.call(c,a,b)};var z="\r\n\t ",K="0124356789",O="abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ",G="'\"",A=z+">",R="[CDATA[",k="DOCTYPE",I="http://www.w3.org/XML/1998/namespace",e="http://www.w3.org/2000/xmlns/",t={xml:I,xmlns:e};z=m(z);K=m(K);O=m(O);
var W=/[:_A-Za-z\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD]/,Q=/[:_A-Za-z\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD\u00B7\u0300-\u036F\u203F-\u2040\.\d-]/,aa=/[#:_A-Za-z\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD]/,
Y=/[#:_A-Za-z\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD\u00B7\u0300-\u036F\u203F-\u2040\.\d-]/;G=m(G);A=m(A);var u=0;g.STATE={BEGIN:u++,BEGIN_WHITESPACE:u++,TEXT:u++,TEXT_ENTITY:u++,OPEN_WAKA:u++,SGML_DECL:u++,SGML_DECL_QUOTED:u++,DOCTYPE:u++,DOCTYPE_QUOTED:u++,DOCTYPE_DTD:u++,DOCTYPE_DTD_QUOTED:u++,COMMENT_STARTING:u++,COMMENT:u++,COMMENT_ENDING:u++,COMMENT_ENDED:u++,CDATA:u++,CDATA_ENDING:u++,CDATA_ENDING_2:u++,
...
0}return d};Object.defineProperty?Object.defineProperty(String,"fromCodePoint",{value:c,configurable:!0,writable:!0}):String.fromCodePoint=c}()})("undefined"===typeof m?this.sax={}:m)}).call(this,d("buffer").Buffer)},{buffer:3,stream:29,string_decoder:30}],29:[function(d,r,m){function c(){g.call(this)}r.exports=c;var g=d("events").EventEmitter;d("inherits")(c,g);c.Readable=d("readable-stream/readable.js");c.Writable=d("readable-stream/writable.js");c.Duplex=d("readable-stream/duplex.js");c.Transform=
d("readable-stream/transform.js");c.PassThrough=d("readable-stream/passthrough.js");c.Stream=c;c.prototype.pipe=function(c,d){function l(b){c.writable&&!1===c.write(b)&&a.pause&&a.pause()}function p(){a.readable&&a.resume&&a.resume()}function b(){f||(f=!0,c.end())}function h(){f||(f=!0,"function"===typeof c.destroy&&c.destroy())}function D(a){q();if(0===g.listenerCount(this,"error"))throw a;}function q(){a.removeListener("data",l);c.removeListener("drain",p);a.removeListener("end",b);a.removeListener("close",
h);a.removeListener("error",D);c.removeListener("error",D);a.removeListener("end",q);a.removeListener("close",q);c.removeListener("close",q)}var a=this;a.on("data",l);c.on("drain",p);c._isStdio||d&&!1===d.end||(a.on("end",b),a.on("close",h));var f=!1;a.on("error",D);c.on("error",D);a.on("end",q);a.on("close",q);c.on("close",q);c.emit("pipe",a);return c}},{events:5,inherits:7,"readable-stream/duplex.js":12,"readable-stream/passthrough.js":23,"readable-stream/readable.js":24,"readable-stream/transform.js":25,
"readable-stream/writable.js":26}],30:[function(d,r,m){arguments[4][22][0].apply(m,arguments)},{dup:22,"safe-buffer":27}],31:[function(d,r,m){(function(c,g){function l(b,c){this._id=b;this._clearFn=c}var p=d("process/browser.js").nextTick,r=Function.prototype.apply,B=Array.prototype.slice,b={},h=0;m.setTimeout=function(){return new l(r.call(setTimeout,window,arguments),clearTimeout)};m.setInterval=function(){return new l(r.call(setInterval,window,arguments),clearInterval)};m.clearTimeout=m.clearInterval=
function(b){b.close()};l.prototype.unref=l.prototype.ref=function(){};l.prototype.close=function(){this._clearFn.call(window,this._id)};m.enroll=function(b,c){clearTimeout(b._idleTimeoutId);b._idleTimeout=c};m.unenroll=function(b){clearTimeout(b._idleTimeoutId);b._idleTimeout=-1};m._unrefActive=m.active=function(b){clearTimeout(b._idleTimeoutId);var c=b._idleTimeout;0<=c&&(b._idleTimeoutId=setTimeout(function(){b._onTimeout&&b._onTimeout()},c))};m.setImmediate="function"===typeof c?c:function(c){var d=
h++,a=2>arguments.length?!1:B.call(arguments,1);b[d]=!0;p(function(){b[d]&&(a?c.apply(null,a):c.call(null),m.clearImmediate(d))});return d};m.clearImmediate="function"===typeof g?g:function(c){delete b[c]}}).call(this,d("timers").setImmediate,d("timers").clearImmediate)},{"process/browser.js":11,timers:31}],32:[function(d,r,m){(function(c){function d(d){try{if(!c.localStorage)return!1}catch(p){return!1}d=c.localStorage[d];return null==d?!1:"true"===String(d).toLowerCase()}r.exports=function(c,g){if(d("noDeprecation"))return c;
var l=!1;return function(){if(!l){if(d("throwDeprecation"))throw Error(g);d("traceDeprecation")?console.trace(g):console.warn(g);l=!0}return c.apply(this,arguments)}}}).call(this,"undefined"!==typeof global?global:"undefined"!==typeof self?self:"undefined"!==typeof window?window:{})},{}],33:[function(d,r,m){(function(c,d,l,p,m){function g(a,b){var c=a.styleAttrs&&a.styleAttrs["http://www.w3.org/ns/ttml#styling backgroundColor"];if("span"===a.kind)!c&&b&&(a.styleAttrs||(a.styleAttrs={}),a.styleAttrs["http://www.w3.org/ns/ttml#styling backgroundColor"]=
...
b.explicit_dur,d+b.explicit_end):null===b.explicit_end&&null!==b.explicit_dur?b.begin+b.explicit_dur:null!==b.explicit_end&&null===b.explicit_dur?d+b.explicit_end:c;delete b.explicit_begin;delete b.explicit_dur;delete b.explicit_end;a._registerEvent(b)}function D(a){this.node=a}function q(){this.events=[];this.head=new a;this.body=null}function a(){this.styling=new f;this.layout=new C}function f(){this.styles={};this.initials={}}function v(){this.styleRefs=this.styleAttrs=this.id=null}function n(){this.styleAttrs=
null}function C(){this.regions={}}function r(a,b){this.kind="image";this.src=a;this.type=b}function y(a){this.id=a}function w(a){this.regionID=a}function L(a){this.styleAttrs=a}function E(a){this.sets=a}function M(a){this.contents=a}function H(a,b,c){this.explicit_begin=a;this.explicit_end=b;this.explicit_dur=c}function z(){this.kind="body"}function K(){this.kind="div"}function O(){this.kind="p"}function G(){this.kind="span"}function A(){this.kind="span"}function R(){this.kind="br"}function k(){}
function I(){}function e(a){var b=null;a&&(a=a.attributes["xml:id"]||a.attributes.id)&&(b=a.value||null);return b}function t(a){return a&&"style"in a.attributes?a.attributes.style.value.split(" "):[]}function W(a,b){var c={};if(null!==a)for(var f in a.attributes){var e=a.attributes[f].uri+" "+a.attributes[f].local,d=p.byQName[e];if(void 0!==d){var h=d.parse(a.attributes[f].value);null!==h?(c[e]=h,d===p.byName.zIndex&&V(b,"zIndex attribute present but not used by IMSC1 since regions do not overlap")):
J(b,"Cannot parse styling attribute "+e+" --\x3e "+a.attributes[f].value)}}return c}function Q(a,b,c){for(var f in a.attributes)if(a.attributes[f].uri===b&&a.attributes[f].local===c)return a.attributes[f].value;return null}function aa(a,b){a=Q(a,l.ns_tts,"extent");if(null===a)return null;var c=a.split(" ");if(2!==c.length)return V(b,"Malformed extent (ignoring)"),null;a=m.parseLength(c[0]);c=m.parseLength(c[1]);return c&&a?{h:c,w:a}:(V(b,"Malformed extent values (ignoring)"),null)}function Y(a,b,
c){var f=/^(\d{2,}):(\d\d):(\d\d(?:\.\d+)?)$/,e=/^(\d{2,}):(\d\d):(\d\d):(\d{2,})$/,d=/^(\d+(?:\.\d+)?)t$/,h=/^(\d+(?:\.\d+)?)ms$/,n=/^(\d+(?:\.\d+)?)s$/,g=/^(\d+(?:\.\d+)?)h$/,v=/^(\d+(?:\.\d+)?)m$/,k,l=null;null!==(k=/^(\d+(?:\.\d+)?)f$/.exec(c))?null!==b&&(l=parseFloat(k[1])/b):null!==(k=d.exec(c))?null!==a&&(l=parseFloat(k[1])/a):null!==(k=h.exec(c))?l=parseFloat(k[1])/1E3:null!==(k=n.exec(c))?l=parseFloat(k[1]):null!==(k=g.exec(c))?l=3600*parseFloat(k[1]):null!==(k=v.exec(c))?l=60*parseFloat(k[1]):
null!==(k=f.exec(c))?l=3600*parseInt(k[1])+60*parseInt(k[2])+parseFloat(k[3]):null!==(k=e.exec(c))&&null!==b&&(l=3600*parseInt(k[1])+60*parseInt(k[2])+parseInt(k[3])+(null===k[4]?0:parseInt(k[4])/b));return l}function u(a,b,c){for(;0<b.styleRefs.length;){var f=b.styleRefs.pop();f in a.styles?(u(a,a.styles[f],c),T(a.styles[f].styleAttrs,b.styleAttrs)):J(c,"Non-existant style id referenced")}}function X(a,b,c,f){for(var e=b.length-1;0<=e;e--){var d=b[e];d in a.styles?T(a.styles[d].styleAttrs,c):J(f,
"Non-existant style id referenced")}}function T(a,b){for(var c in a)c in b||(b[c]=a[c])}function V(a,b){if(a&&a.warn&&a.warn(b))throw b;}function J(a,b){if(a&&a.error&&a.error(b))throw b;}function P(a,b){a&&a.fatal&&a.fatal(b);throw b;}function ba(a,b){for(var c=0,f=a.length-1,e;c<=f;){e=Math.floor((c+f)/2);var d=a[e];if(d<b)c=e+1;else if(d>b)f=e-1;else return{found:!0,index:e}}return{found:!1,index:c}}c.fromXML=function(c,e,m){var t=d.parser(!0,{xmlns:!0}),x=[],E=[],N=[],Z=0,y=null;t.onclosetag=
function(a){if(x[0]instanceof f)for(var b in x[0].styles)u(x[0],x[0].styles[b],e);else if(x[0]instanceof O||x[0]instanceof G){if(1<x[0].contents.length){a=[x[0].contents[0]];for(b=1;b<x[0].contents.length;b++)x[0].contents[b]instanceof A&&a[a.length-1]instanceof A?a[a.length-1].text+=x[0].contents[b].text:a.push(x[0].contents[b]);x[0].contents=a}x[0]instanceof G&&1===x[0].contents.length&&x[0].contents[0]instanceof A&&(x[0].text=x[0].contents[0].text,delete x[0].contents)}else if(x[0]instanceof D)if(x[0].node.uri===
l.ns_tt&&"metadata"===x[0].node.local)Z--;else if(0<Z&&m&&"onCloseTag"in m)m.onCloseTag();N.shift();E.shift();x.shift()};t.ontext=function(a){if(void 0!==x[0])if(x[0]instanceof G||x[0]instanceof O){if(x[0]instanceof G){var b=x[0].styleAttrs[p.byName.ruby.qname];if("container"===b||"textContainer"===b||"baseContainer"===b)return}b=new A;b.initFromText(y,x[0],a,N[0],e);x[0].contents.push(b)}else if(x[0]instanceof D&&0<Z&&m&&"onText"in m)m.onText(a)};t.onopentag=function(b){function c(a){l.ttaf_map[a.uri]&&
(a.uri=l.ttaf_map[a.uri])}var d=b.attributes["xml:space"];d?N.unshift(d.value):0===N.length?N.unshift("default"):N.unshift(N[0]);(d=b.attributes["xml:lang"])?E.unshift(d.value):0===E.length?E.unshift(""):E.unshift(E[0]);c(b);if(b.attributes)for(var h in b.attributes)b.attributes.hasOwnProperty(h)&&c(b.attributes[h]);if(b.uri===l.ns_tt)if("tt"===b.local)null!==y&&P(e,"Two <tt> elements at ("+this.line+","+this.column+")"),y=new q,y.initFromNode(b,e),x.unshift(y);else if("head"===b.local)x[0]instanceof
...
else if("region"===b.local)x[0]instanceof C||P(e,"Parent of <region> element is not <layout> at "+this.line+","+this.column+")"),g=new k,g.initFromNode(y,b,e),!g.id||g.id in y.head.layout.regions?J(e,"Ignoring <region> with duplicate or missing @id at "+this.line+","+this.column+")"):y.head.layout.regions[g.id]=g,x.unshift(g);else if("body"===b.local)x[0]instanceof q||P(e,"Parent of <body> element is not <tt> at "+this.line+","+this.column+")"),null!==y.body&&P(e,"Second <body> element at "+this.line+
","+this.column+")"),g=new z,g.initFromNode(y,b,e),y.body=g,x.unshift(g);else if("div"===b.local){x[0]instanceof K||x[0]instanceof z||P(e,"Parent of <div> element is not <body> or <div> at "+this.line+","+this.column+")");g=new K;g.initFromNode(y,x[0],b,e);if(h=g.styleAttrs[p.byName.backgroundImage.qname])g.contents.push(new r(h)),delete g.styleAttrs[p.byName.backgroundImage.qname];x[0].contents.push(g);x.unshift(g)}else"image"===b.local?(x[0]instanceof K||P(e,"Parent of <image> element is not <div> at "+
this.line+","+this.column+")"),g=new r,g.initFromNode(y,x[0],b,e),x[0].contents.push(g),x.unshift(g)):"p"===b.local?(x[0]instanceof K||P(e,"Parent of <p> element is not <div> at "+this.line+","+this.column+")"),g=new O,g.initFromNode(y,x[0],b,e),x[0].contents.push(g),x.unshift(g)):"span"===b.local?(x[0]instanceof G||x[0]instanceof O||P(e,"Parent of <span> element is not <span> or <p> at "+this.line+","+this.column+")"),g=new G,g.initFromNode(y,x[0],b,N[0],e),x[0].contents.push(g),x.unshift(g)):"br"===
b.local?(x[0]instanceof G||x[0]instanceof O||P(e,"Parent of <br> element is not <span> or <p> at "+this.line+","+this.column+")"),g=new R,g.initFromNode(y,x[0],b,e),x[0].contents.push(g),x.unshift(g)):"set"===b.local?(x[0]instanceof G||x[0]instanceof O||x[0]instanceof K||x[0]instanceof z||x[0]instanceof k||x[0]instanceof R||P(e,"Parent of <set> element is not a content element or a region at "+this.line+","+this.column+")"),g=new I,g.initFromNode(y,x[0],b,e),x[0].sets.push(g),x.unshift(g)):x.unshift(new D(b));
else x.unshift(new D(b));if(x[0]instanceof D)if(b.uri===l.ns_tt&&"metadata"===b.local)Z++;else if(0<Z&&m&&"onOpenTag"in m){g=[];for(var t in b.attributes)g[b.attributes[t].uri+" "+b.attributes[t].local]={uri:b.attributes[t].uri,local:b.attributes[t].local,value:b.attributes[t].value};m.onOpenTag(b.uri,b.local,g)}};t.write(c).close();delete y.head.styling.styles;c=!1;for(var w in y.head.layout.regions){c=!0;break}c||(w=k.prototype.createDefaultRegion(y,e),y.head.layout.regions[w.id]=w);for(var S in y.head.layout.regions)h(y,
...
e=Q(a,l.ns_ittp,"aspectRatio");null===e&&(e=Q(a,l.ns_ttp,"displayAspectRatio"));f=null;null!==e&&(c=/(\d+)\s+(\d+)/.exec(e),null!==c?(e=parseInt(c[1]),c=parseInt(c[2]),0!==e&&0!==c?f=e/c:J(b,"Illegal aspectRatio values (ignoring)")):J(b,"Malformed aspectRatio attribute (ignoring)"));this.aspectRatio=f;f=Q(a,l.ns_ttp,"timeBase");null!==f&&"media"!==f&&P(b,"Unsupported time base");a=aa(a,b);null===a?this.pxLength={h:null,w:null}:("px"===a.h.unit&&"px"===a.w.unit||P(b,"Extent on TT must be in px or absent"),
this.pxLength={h:new m.ComputedLength(0,1/a.h.value),w:new m.ComputedLength(1/a.w.value,0)});this.dimensions={h:new m.ComputedLength(0,1),w:new m.ComputedLength(1,0)}};q.prototype._registerEvent=function(a){if(!(a.end<=a.begin)){var b=ba(this.events,a.begin);b.found||this.events.splice(b.index,0,a.begin);a.end!==Number.POSITIVE_INFINITY&&(b=ba(this.events,a.end),b.found||this.events.splice(b.index,0,a.end))}};q.prototype.getMediaTimeRange=function(){return[this.events[0],this.events[this.events.length-
...
c.attributes.src.value:null)||J(f,"Invalid image@src attribute");(this.type="type"in c.attributes?c.attributes.type.value:null)||J(f,"Invalid image@type attribute");L.prototype.initFromNode.call(this,a,b,c,f);H.prototype.initFromNode.call(this,a,b,c,f);E.prototype.initFromNode.call(this,a,b,c,f);w.prototype.initFromNode.call(this,a,b,c,f)};y.prototype.initFromNode=function(a,b,c,f){this.id=e(c)};w.prototype.initFromNode=function(a,b,c,f){this.regionID=c&&"region"in c.attributes?c.attributes.region.value:
""};L.prototype.initFromNode=function(a,b,c,f){this.styleAttrs=W(c,f);null!==a.head&&null!==a.head.styling&&X(a.head.styling,t(c),this.styleAttrs,f)};E.prototype.initFromNode=function(a,b,c,f){this.sets=[]};M.prototype.initFromNode=function(a,b,c,f){this.contents=[]};H.prototype.initFromNode=function(a,b,c,f){b=null;c&&"begin"in c.attributes&&(b=Y(a.tickRate,a.effectiveFrameRate,c.attributes.begin.value),null===b&&V(f,"Malformed begin value "+c.attributes.begin.value+" (using 0)"));var e=null;c&&
"dur"in c.attributes&&(e=Y(a.tickRate,a.effectiveFrameRate,c.attributes.dur.value),null===e&&V(f,"Malformed dur value "+c.attributes.dur.value+" (ignoring)"));var d=null;c&&"end"in c.attributes&&(d=Y(a.tickRate,a.effectiveFrameRate,c.attributes.end.value),null===d&&V(f,"Malformed end value (ignoring)"));this.explicit_begin=b;this.explicit_end=d;this.explicit_dur=e;(a=c&&"timeContainer"in c.attributes?c.attributes.timeContainer.value:null)&&"par"!==a?"seq"===a?f="seq":(J(f,"Illegal value of timeContainer (assuming 'par')"),
f="par"):f="par";this.timeContainer=f};z.prototype.initFromNode=function(a,b,c){L.prototype.initFromNode.call(this,a,null,b,c);H.prototype.initFromNode.call(this,a,null,b,c);E.prototype.initFromNode.call(this,a,null,b,c);w.prototype.initFromNode.call(this,a,null,b,c);M.prototype.initFromNode.call(this,a,null,b,c)};K.prototype.initFromNode=function(a,b,c,f){L.prototype.initFromNode.call(this,a,b,c,f);H.prototype.initFromNode.call(this,a,b,c,f);E.prototype.initFromNode.call(this,a,b,c,f);w.prototype.initFromNode.call(this,
a,b,c,f);M.prototype.initFromNode.call(this,a,b,c,f)};O.prototype.initFromNode=function(a,b,c,f){L.prototype.initFromNode.call(this,a,b,c,f);H.prototype.initFromNode.call(this,a,b,c,f);E.prototype.initFromNode.call(this,a,b,c,f);w.prototype.initFromNode.call(this,a,b,c,f);M.prototype.initFromNode.call(this,a,b,c,f)};G.prototype.initFromNode=function(a,b,c,f,e){L.prototype.initFromNode.call(this,a,b,c,e);H.prototype.initFromNode.call(this,a,b,c,e);E.prototype.initFromNode.call(this,a,b,c,e);w.prototype.initFromNode.call(this,
a,b,c,e);M.prototype.initFromNode.call(this,a,b,c,e);this.space=f};A.prototype.initFromText=function(a,b,c,f,e){H.prototype.initFromNode.call(this,a,b,null,e);this.text=c;this.space=f};R.prototype.initFromNode=function(a,b,c,f){w.prototype.initFromNode.call(this,a,b,c,f);H.prototype.initFromNode.call(this,a,b,c,f)};k.prototype.createDefaultRegion=function(a,b){var c=new k;c.id="";L.prototype.initFromNode.call(c,a,null,{name:"region",attributes:{"tts:displayAlign":{name:"tts:displayAlign",value:"after",
...
b,c);L.prototype.initFromNode.call(this,a,null,b,c);H.prototype.initFromNode.call(this,a,null,b,c);E.prototype.initFromNode.call(this,a,null,b,c);null!==a.head&&null!==a.head.styling&&X(a.head.styling,t(b),this.styleAttrs,c)};I.prototype.initFromNode=function(a,b,c,f){H.prototype.initFromNode.call(this,a,b,c,f);a=W(c,f);this.value=this.qname=null;for(var e in a){if(this.qname){J(f,"More than one style specified on set");break}this.qname=e;this.value=a[e]}}})("undefined"===typeof m?this.imscDoc={}:
...
else if("baseContainer"===d.styleAttrs[l.byName.ruby.qname])f=document.createElement("rbc");else if("textContainer"===d.styleAttrs[l.byName.ruby.qname])f=document.createElement("rtc");else{if("delimiter"===d.styleAttrs[l.byName.ruby.qname])return;f=document.createElement("span")}(h=d.styleAttrs[l.byName.textEmphasis.qname])&&"none"!==h.style&&(a.textEmphasis=!0)}else"br"===d.kind&&(f=document.createElement("br"));if(f){c.appendChild(f);f.style.margin="0";for(var q in D)c=D[q],h=d.styleAttrs[c.qname],
void 0!==h&&null!==c.map&&c.map(a,f,d,h);q=f;if("region"===d.kind)if(c=d.styleAttrs[l.byName.writingMode.qname],"lrtb"===c||"lr"===c)a.ipd="lr",a.bpd="tb";else if("rltb"===c||"rl"===c)a.ipd="rl",a.bpd="tb";else if("tblr"===c)a.ipd="tb",a.bpd="lr";else if("tbrl"===c||"tb"===c)a.ipd="tb",a.bpd="rl";(c=d.styleAttrs[l.byName.linePadding.qname])&&!c.isZero()&&(h=c.toUsedLength(a.w,a.h),0<h&&(h=Math.ceil(h)+"px","tb"===a.bpd?(q.style.paddingLeft=h,q.style.paddingRight=h):(q.style.paddingTop=h,q.style.paddingBottom=
h),a.lp=c));(c=d.styleAttrs[l.byName.multiRowAlign.qname])&&"auto"!==c&&(q=document.createElement("span"),q.style.display="inline-block",q.style.textAlign=c,f.appendChild(q),a.mra=c);(c=d.styleAttrs[l.byName.rubyReserve.qname])&&"none"!==c[0]&&(a.rubyReserve=c);d.styleAttrs[l.byName.fillLineGap.qname]&&(a.flg=!0);if("span"===d.kind&&d.text)if(l.byName.textCombine.qname in d.styleAttrs&&"all"===d.styleAttrs[l.byName.textCombine.qname][0])f.textContent=d.text;else for(c="",h=0;h<d.text.length;h++){c+=
d.text.charAt(h);var v=d.text.charCodeAt(h);if(55296>v||56319<v||h===d.text.length)v=document.createElement("span"),v.textContent=c,f.appendChild(v),c=""}for(var p in d.contents)g(a,q,d.contents[p]);p=[];if((a.lp||a.mra||a.flg||a.ruby||a.textEmphasis||a.rubyReserve)&&"p"===d.kind){b(a,q,p,null);if(a.rubyReserve){for(c=0;c<p.length;c++){h=document.createElement("ruby");v=document.createElement("rb");v.textContent="\u200b";h.appendChild(v);var w=a.rubyReserve[1].toUsedLength(a.w,a.h)+"px";if("both"===
a.rubyReserve[0]){v=document.createElement("rtc");v.style.rubyPosition="under";v.textContent="\u200b";v.style.fontSize=w;var E=document.createElement("rtc");E.style.rubyPosition="over";E.textContent="\u200b";E.style.fontSize=w;h.appendChild(v);h.appendChild(E)}else v=document.createElement("rtc"),v.textContent="\u200b",v.style.fontSize=w,v.style.rubyPosition="after"===a.rubyReserve[0]||"outside"===a.rubyReserve[0]&&0<c?"tb"===a.bpd||"rl"===a.bpd?"under":"over":"tb"===a.bpd||"rl"===a.bpd?"over":"under",
h.appendChild(v);p[c].elements[0].node.parentElement.insertBefore(h,p[c].elements[0].node)}a.rubyReserve=null}if(a.ruby||a.rubyReserve){for(c=0;c<p.length;c++)for(h=0;h<p[c].rbc.length;h++)p[c].rbc[h].style.rubyPosition||(p[c].rbc[h].style.rubyPosition="tb"===a.bpd?0===c?"over":"under":"rl"===a.bpd?0===c?"over":"under":0===c?"under":"over");a.ruby=null}if(a.textEmphasis){for(c=0;c<p.length;c++)for(h=0;h<p[c].te.length;h++)p[c].te[h].style.textEmphasisPosition&&"none"!==p[c].te[h].style.textEmphasisPosition||
(p[c].te[h].style.textEmphasisPosition="tb"===a.bpd?0===c?"left over":"left under":"rl"===a.bpd?0===c?"right under":"left under":0===c?"left under":"right under");a.textEmphasis=null}if(a.mra){for(c=0;c<p.length-1;c++)v=p[c].elements.length,0!==v&&!1===p[c].br&&(h=document.createElement("br"),v=p[c].elements[v-1].node,v.parentElement.insertBefore(h,v.nextSibling));a.mra=null}if(a.lp){c=a.lp.toUsedLength(a.w,a.h);for(var B in p)h=p[B].elements[p[B].start_elem],v=p[B].elements[p[B].end_elem],E=Math.ceil(c)+
"px",w="-"+Math.ceil(c)+"px",0!==p[B].elements.length&&("lr"===a.ipd?(h.node.style.borderLeftColor=h.bgcolor||"#00000000",h.node.style.borderLeftStyle="solid",h.node.style.borderLeftWidth=E,h.node.style.marginLeft=w):"rl"===a.ipd?(h.node.style.borderRightColor=h.bgcolor||"#00000000",h.node.style.borderRightStyle="solid",h.node.style.borderRightWidth=E,h.node.style.marginRight=w):"tb"===a.ipd&&(h.node.style.borderTopColor=h.bgcolor||"#00000000",h.node.style.borderTopStyle="solid",h.node.style.borderTopWidth=
E,h.node.style.marginTop=w),"lr"===a.ipd?(v.node.style.borderRightColor=v.bgcolor||"#00000000",v.node.style.borderRightStyle="solid",v.node.style.borderRightWidth=E,v.node.style.marginRight=w):"rl"===a.ipd?(v.node.style.borderLeftColor=v.bgcolor||"#00000000",v.node.style.borderLeftStyle="solid",v.node.style.borderLeftWidth=E,v.node.style.marginLeft=w):"tb"===a.ipd&&(v.node.style.borderBottomColor=v.bgcolor||"#00000000",v.node.style.borderBottomStyle="solid",v.node.style.borderBottomWidth=E,v.node.style.marginBottom=
w));a.lp=null}if(a.flg){c=r(q.getBoundingClientRect(),a);B=c.before;c=c.after;h=Math.sign(c-B);for(v=0;v<=p.length;v++){E=0===v?B:v===p.length?c:(p[v].before+p[v-1].after)/2;if(0<v)for(var H=0;H<p[v-1].elements.length;H++)if(null!==p[v-1].elements[H].bgcolor){var z=p[v-1].elements[H];0>h*(z.after-E)&&(w=Math.ceil(Math.abs(E-z.after))+"px",z.node.style.backgroundColor=z.bgcolor,"lr"===a.bpd?z.node.style.paddingRight=w:"rl"===a.bpd?z.node.style.paddingLeft=w:"tb"===a.bpd&&(z.node.style.paddingBottom=
w))}if(v<p.length)for(H=0;H<p[v].elements.length;H++)z=p[v].elements[H],null!==z.bgcolor&&0<h*(z.before-E)&&(w=Math.ceil(Math.abs(z.before-E))+"px",z.node.style.backgroundColor=z.bgcolor,"lr"===a.bpd?z.node.style.paddingLeft=w:"rl"===a.bpd?z.node.style.paddingRight=w:"tb"===a.bpd&&(z.node.style.paddingTop=w))}a.flg=null}}"region"===d.kind&&(b(a,q,p),"tb"===a.bpd&&a.enableRollUp&&0<d.contents.length&&"after"===d.styleAttrs[l.byName.displayAlign.qname]&&(d=new m(""===d.id?"_":d.id,p),a.currentISDState[d.id]=
d,a.previousISDState&&d.id in a.previousISDState&&0<a.previousISDState[d.id].plist.length&&1<d.plist.length&&d.plist[d.plist.length-2].text===a.previousISDState[d.id].plist[a.previousISDState[d.id].plist.length-1].text&&(a=f.firstElementChild,d=d.plist[d.plist.length-1].after-d.plist[d.plist.length-1].before,a.style.bottom="-"+d+"px",a.style.transition="transform 0.4s",a.style.position="relative",a.style.transform="translateY(-"+d+"px)")))}else if(a=a.errorHandler,d="Error processing ISD element kind: "+
d.kind,a&&a.error&&a.error(d))throw d;}function m(a,b){this.id=a;this.plist=b}function r(a,b){var c={before:null,after:null,start:null,end:null};"tb"===b.bpd?(c.before=a.top,c.after=a.bottom,"lr"===b.ipd?(c.start=a.left,c.end=a.right):(c.start=a.right,c.end=a.left)):"lr"===b.bpd?(c.before=a.left,c.after=a.right,c.start=a.top,c.end=a.bottom):"rl"===b.bpd&&(c.before=a.right,c.after=a.left,c.start=a.top,c.end=a.bottom);return c}function b(a,c,d,h){if("rt"!==c.localName&&"rtc"!==c.localName)if(h=c.style.backgroundColor||
h,0===c.childElementCount)if("span"===c.localName||"rb"===c.localName){var f=c.getBoundingClientRect();if(0!==f.height&&0!==f.width){a=r(f,a);if(!(f=0===d.length)){f=a.before;var g=a.after,n=d[d.length-1].before,l=d[d.length-1].after;f=!(g<l&&f>n||l<=g&&n>=f)}f?d.push({before:a.before,after:a.after,start:a.start,end:a.end,start_elem:0,end_elem:0,elements:[],rbc:[],te:[],text:"",br:!1}):(f=Math.sign(a.after-a.before),g=Math.sign(a.end-a.start),0>f*(a.before-d[d.length-1].before)&&(d[d.length-1].before=
a.before),0<f*(a.after-d[d.length-1].after)&&(d[d.length-1].after=a.after),0>g*(a.start-d[d.length-1].start)&&(d[d.length-1].start=a.start,d[d.length-1].start_elem=d[d.length-1].elements.length),0<g*(a.end-d[d.length-1].end)&&(d[d.length-1].end=a.end,d[d.length-1].end_elem=d[d.length-1].elements.length));d[d.length-1].text+=c.textContent;d[d.length-1].elements.push({node:c,bgcolor:h,before:a.before,after:a.after})}}else"br"===c.localName&&0!==d.length&&(d[d.length-1].br=!0);else for(c=c.firstChild;c;)c.nodeType===
Node.ELEMENT_NODE&&(b(a,c,d,h),"ruby"===c.localName||"rtc"===c.localName?0<d.length&&d[d.length-1].rbc.push(c):"span"===c.localName&&c.style.textEmphasisStyle&&"none"!==c.style.textEmphasisStyle&&0<d.length&&d[d.length-1].te.push(c)),c=c.nextSibling}function h(a,b){this.qname=a;this.map=b}c.render=function(a,b,c,d,h,l,q,p,m){d=d||b.clientHeight;h=h||b.clientWidth;if(null!==a.aspectRatio){var f=d*a.aspectRatio;f>h?d=Math.round(h/a.aspectRatio):h=f}f=document.createElement("div");f.style.position="relative";
f.style.width=h+"px";f.style.height=d+"px";f.style.margin="auto";f.style.top=0;f.style.bottom=0;f.style.left=0;f.style.right=0;f.style.zIndex=0;c={h:d,w:h,regionH:null,regionW:null,imgResolver:c,displayForcedOnlyMode:l||!1,isd:a,errorHandler:q,previousISDState:p,enableRollUp:m||!1,currentISDState:{},flg:null,lp:null,mra:null,ipd:null,bpd:null,ruby:null,textEmphasis:null,rubyReserve:null};b.appendChild(f);for(var n in a.contents)g(c,f,a.contents[n]);return c.currentISDState};var D=[new h("http://www.w3.org/ns/ttml#styling backgroundColor",
...
{}:m,"undefined"===typeof imscNames?d("./names"):imscNames,"undefined"===typeof imscStyles?d("./styles"):imscStyles,"undefined"===typeof imscUtils?d("./utils"):imscUtils)},{"./names":37,"./styles":38,"./utils":39}],35:[function(d,r,m){(function(c,d,l,p){function g(a,c,d,h,r,w,y,B,L){if(c<y.begin||c>=y.end)return null;w="regionID"in y&&""!==y.regionID?y.regionID:w;if(null!==r&&w!==d.id&&(!("contents"in y)||"contents"in y&&0===y.contents.length||""!==w))return null;var f=new D(y);for(n in y.sets)c<
y.sets[n].begin||c>=y.sets[n].end||(f.styleAttrs[y.sets[n].qname]=y.sets[n].value);var n={};for(var v in f.styleAttrs)if(n[v]=!0,v===l.byName.writingMode.qname&&!(l.byName.direction.qname in f.styleAttrs)){var z=f.styleAttrs[v];if("lrtb"===z||"lr"===z)f.styleAttrs[l.byName.direction.qname]="ltr";else if("rltb"===z||"rl"===z)f.styleAttrs[l.byName.direction.qname]="rtl"}if(null!==r)for(var C in l.all)if(v=l.all[C],v.qname===l.byName.textDecoration.qname){z=r.styleAttrs[v.qname];var F=f.styleAttrs[v.qname],
G=[];void 0===F?G=z:-1===F.indexOf("none")?((-1===F.indexOf("noUnderline")&&-1!==z.indexOf("underline")||-1!==F.indexOf("underline"))&&G.push("underline"),(-1===F.indexOf("noLineThrough")&&-1!==z.indexOf("lineThrough")||-1!==F.indexOf("lineThrough"))&&G.push("lineThrough"),(-1===F.indexOf("noOverline")&&-1!==z.indexOf("overline")||-1!==F.indexOf("overline"))&&G.push("overline")):G.push("none");f.styleAttrs[v.qname]=G}else v.qname!==l.byName.fontSize.qname||v.qname in f.styleAttrs||"span"!==f.kind||
...
new p.ComputedLength(.5*z.rw,.5*z.rh));for(var A in l.all)(C=l.all[A],C.qname in f.styleAttrs||C.qname===l.byName.position.qname&&l.byName.origin.qname in f.styleAttrs||C.qname===l.byName.origin.qname&&l.byName.position.qname in f.styleAttrs||(v=a.head.styling.initials[C.qname]||C.initial,"region"!==f.kind&&(!1!==C.inherit||null===v)))||(f.styleAttrs[C.qname]=C.parse(v),n[C.qname]=!0);for(var R in l.all)if(A=l.all[R],A.qname in n&&null!==A.compute)if(C=A.compute(a,r,f,f.styleAttrs[A.qname],L),null!==
C)f.styleAttrs[A.qname]=C;else if(f.styleAttrs[A.qname]=A.compute(a,r,f,A.parse(A.initial),L),A="Style '"+A.qname+"' on element '"+f.kind+"' cannot be computed",B&&B.error&&B.error(A))throw A;if("none"===f.styleAttrs[l.byName.display.qname])return null;if(null===r)var k=null===h?[]:[h];else"contents"in y&&(k=y.contents);for(var I in k)r=g(a,c,d,h,f,w,k[I],B,L),null!==r&&f.contents.push(r.element);for(var e in f.styleAttrs)a=!1,"span"===f.kind&&(c=f.styleAttrs[l.byName.ruby.qname],(a=("container"===
...
"./styles":38,"./utils":39}],36:[function(d,r,m){m.generateISD=d("./isd").generateISD;m.fromXML=d("./doc").fromXML;m.renderHTML=d("./html").render},{"./doc":33,"./html":34,"./isd":35}],37:[function(d,r,m){d="undefined"===typeof m?this.imscNames={}:m;d.ns_tt="http://www.w3.org/ns/ttml";d.ns_tts="http://www.w3.org/ns/ttml#styling";d.ns_ttp="http://www.w3.org/ns/ttml#parameter";d.ns_xml="http://www.w3.org/XML/1998/namespace";d.ns_itts="http://www.w3.org/ns/ttml/profile/imsc1#styling";d.ns_ittp="http://www.w3.org/ns/ttml/profile/imsc1#parameter";
d.ns_smpte="http://www.smpte-ra.org/schemas/2052-1/2010/smpte-tt";d.ns_ebutts="urn:ebu:tt:style";d.ttaf_map={"http://www.w3.org/2006/10/ttaf1":d.ns_tt,"http://www.w3.org/2006/10/ttaf1#style":d.ns_tts,"http://www.w3.org/2006/10/ttaf1#parameter":d.ns_ttp}},{}],38:[function(d,r,m){(function(c,d,l){function g(b,c,d,g,a,f,l,m){this.name=c;this.ns=b;this.qname=b+" "+c;this.inherit=a;this.animatable=f;this.initial=d;this.applies=g;this.parse=l;this.compute=m}c.all=[new g(d.ns_tts,"backgroundColor","transparent",
["body","div","p","region","span"],!1,!0,l.parseColor,null),new g(d.ns_tts,"color","white",["span"],!0,!0,l.parseColor,null),new g(d.ns_tts,"direction","ltr",["p","span"],!0,!0,function(b){return b},null),new g(d.ns_tts,"display","auto",["body","div","p","region","span"],!1,!0,function(b){return b},null),new g(d.ns_tts,"displayAlign","before",["region"],!1,!0,function(b){return b},null),new g(d.ns_tts,"extent","auto",["tt","region"],!1,!0,function(b){if("auto"===b)return b;var c=b.split(" ");if(2!==
c.length)return null;b=l.parseLength(c[0]);return(c=l.parseLength(c[1]))&&b?{h:c,w:b}:null},function(b,c,d,g,a){if("auto"===g)c=new l.ComputedLength(0,1);else if(c=l.toComputedLength(g.h.value,g.h.unit,null,b.dimensions.h,null,b.pxLength.h),null===c)return null;if("auto"===g)b=new l.ComputedLength(1,0);else if(b=l.toComputedLength(g.w.value,g.w.unit,null,b.dimensions.w,null,b.pxLength.w),null===b)return null;return{h:c,w:b}}),new g(d.ns_tts,"fontFamily","default",["span"],!0,!0,function(b){b=b.split(",");
var c=[],d;for(d in b)"'"!==b[d].charAt(0)&&'"'!==b[d].charAt(0)?"default"===b[d]?c.push("monospaceSerif"):c.push(b[d]):c.push(b[d]);return c},null),new g(d.ns_tts,"shear","0%",["p"],!0,!0,l.parseLength,function(b,c,d,g){if("%"===g.unit)b=100<Math.abs(g.value)?100*Math.sign(g.value):g.value;else return null;return b}),new g(d.ns_tts,"fontSize","1c",["span"],!0,!0,l.parseLength,function(b,d,g,q,a){return l.toComputedLength(q.value,q.unit,null!==d?d.styleAttrs[c.byName.fontSize.qname]:b.cellLength.h,
null!==d?d.styleAttrs[c.byName.fontSize.qname]:b.cellLength.h,b.cellLength.h,b.pxLength.h)}),new g(d.ns_tts,"fontStyle","normal",["span"],!0,!0,function(b){return b},null),new g(d.ns_tts,"fontWeight","normal",["span"],!0,!0,function(b){return b},null),new g(d.ns_tts,"lineHeight","normal",["p"],!0,!0,function(b){return"normal"===b?b:l.parseLength(b)},function(b,d,g,q,a){if("normal"===q)b=q;else if(b=l.toComputedLength(q.value,q.unit,g.styleAttrs[c.byName.fontSize.qname],g.styleAttrs[c.byName.fontSize.qname],
b.cellLength.h,b.pxLength.h),null===b)return null;return b}),new g(d.ns_tts,"opacity",1,["region"],!1,!0,parseFloat,null),new g(d.ns_tts,"origin","auto",["region"],!1,!0,function(b){if("auto"===b)return b;var c=b.split(" ");if(2!==c.length)return null;b=l.parseLength(c[0]);return(c=l.parseLength(c[1]))&&b?{h:c,w:b}:null},function(b,c,d,g,a){if("auto"===g)c=new l.ComputedLength(0,0);else if(c=l.toComputedLength(g.h.value,g.h.unit,null,b.dimensions.h,null,b.pxLength.h),null===c)return null;if("auto"===
g)b=new l.ComputedLength(0,0);else if(b=l.toComputedLength(g.w.value,g.w.unit,null,b.dimensions.w,null,b.pxLength.w),null===b)return null;return{h:c,w:b}}),new g(d.ns_tts,"overflow","hidden",["region"],!1,!0,function(b){return b},null),new g(d.ns_tts,"padding","0px",["region"],!1,!0,function(b){b=b.split(" ");if(4<b.length)return null;var c=[],d;for(d in b){var g=l.parseLength(b[d]);if(!g)return null;c.push(g)}return c},function(b,d,g,q,a){if(1===q.length)d=[q[0],q[0],q[0],q[0]];else if(2===q.length)d=
[q[0],q[1],q[0],q[1]];else if(3===q.length)d=[q[0],q[1],q[2],q[1]];else if(4===q.length)d=[q[0],q[1],q[2],q[3]];else return null;q=g.styleAttrs[c.byName.writingMode.qname];if("lrtb"===q||"lr"===q)d=[d[0],d[3],d[2],d[1]];else if("rltb"===q||"rl"===q)d=[d[0],d[1],d[2],d[3]];else if("tblr"===q)d=[d[3],d[0],d[1],d[2]];else if("tbrl"===q||"tb"===q)d=[d[3],d[2],d[1],d[0]];else return null;q=[];for(var f in d)if(0===d[f].value)q[f]=new l.ComputedLength(0,0);else if(q[f]=l.toComputedLength(d[f].value,d[f].unit,
g.styleAttrs[c.byName.fontSize.qname],"0"===f||"2"===f?g.styleAttrs[c.byName.extent.qname].h:g.styleAttrs[c.byName.extent.qname].w,"0"===f||"2"===f?b.cellLength.h:b.cellLength.w,"0"===f||"2"===f?b.pxLength.h:b.pxLength.w),null===q[f])return null;return q}),new g(d.ns_tts,"position","top left",["region"],!1,!0,function(b){return l.parsePosition(b)},function(b,d,g,q){d=l.toComputedLength(q.v.offset.value,q.v.offset.unit,null,new l.ComputedLength(-g.styleAttrs[c.byName.extent.qname].h.rw,b.dimensions.h.rh-
g.styleAttrs[c.byName.extent.qname].h.rh),null,b.pxLength.h);if(null===d)return null;"bottom"===q.v.edge&&(d=new l.ComputedLength(-d.rw-g.styleAttrs[c.byName.extent.qname].h.rw,b.dimensions.h.rh-d.rh-g.styleAttrs[c.byName.extent.qname].h.rh));var a=l.toComputedLength(q.h.offset.value,q.h.offset.unit,null,new l.ComputedLength(b.dimensions.w.rw-g.styleAttrs[c.byName.extent.qname].w.rw,-g.styleAttrs[c.byName.extent.qname].w.rh),null,b.pxLength.w);if(null===d)return null;"right"===q.h.edge&&(a=new l.ComputedLength(b.dimensions.w.rw-
a.rw-g.styleAttrs[c.byName.extent.qname].w.rw,-a.rh-g.styleAttrs[c.byName.extent.qname].w.rh));return{h:d,w:a}}),new g(d.ns_tts,"ruby","none",["span"],!1,!0,function(b){return b},null),new g(d.ns_tts,"rubyAlign","center",["span"],!0,!0,function(b){return"center"!==b&&"spaceAround"!==b?null:b},null),new g(d.ns_tts,"rubyPosition","outside",["span"],!0,!0,function(b){return b},null),new g(d.ns_tts,"rubyReserve","none",["p"],!0,!0,function(b){var c=b.split(" ");b=[null,null];if(0===c.length||2<c.length||
"none"!==c[0]&&"both"!==c[0]&&"after"!==c[0]&&"before"!==c[0]&&"outside"!==c[0])return null;b[0]=c[0];if(2===c.length&&"none"!==c[0])if(c=l.parseLength(c[1]))b[1]=c;else return null;return b},function(b,d,g,q,a){if("none"===q[0])return q;b=null===q[1]?new l.ComputedLength(.5*g.styleAttrs[c.byName.fontSize.qname].rw,.5*g.styleAttrs[c.byName.fontSize.qname].rh):l.toComputedLength(q[1].value,q[1].unit,g.styleAttrs[c.byName.fontSize.qname],g.styleAttrs[c.byName.fontSize.qname],b.cellLength.h,b.pxLength.h);
return null===b?null:[q[0],b]}),new g(d.ns_tts,"showBackground","whenActive",["region"],!1,!0,function(b){return b},null),new g(d.ns_tts,"textAlign","start",["p"],!0,!0,function(b){return b},function(b,c,d,g,a){return"left"===g?"start":"right"===g?"end":g}),new g(d.ns_tts,"textCombine","none",["span"],!0,!0,function(b){b=b.split(" ");return 1!==b.length||"none"!==b[0]&&"all"!==b[0]?null:[b[0]]},null),new g(d.ns_tts,"textDecoration","none",["span"],!0,!0,function(b){return b.split(" ")},null),new g(d.ns_tts,
"textEmphasis","none",["span"],!0,!0,function(b){b=b.split(" ");var c={style:null,symbol:null,color:null,position:null},d;for(d in b)if("none"===b[d]||"auto"===b[d])c.style=b[d];else if("filled"===b[d]||"open"===b[d])c.style=b[d];else if("circle"===b[d]||"dot"===b[d]||"sesame"===b[d])c.symbol=b[d];else if("current"===b[d])c.color=b[d];else if("outside"===b[d]||"before"===b[d]||"after"===b[d])c.position=b[d];else if(c.color=l.parseColor(b[d]),null===c.color)return null;null==c.style&&null==c.symbol?
c.style="auto":(c.symbol=c.symbol||"circle",c.style=c.style||"filled");c.position=c.position||"outside";c.color=c.color||"current";return c},null),new g(d.ns_tts,"textOutline","none",["span"],!0,!0,function(b){if("none"===b)return b;var c={};b=b.split(" ");if(0===b.length||2<b.length)return null;var d=l.parseColor(b[0]);c.color=d;null!==d&&b.shift();if(1!==b.length)return null;b=l.parseLength(b[0]);if(!b)return null;c.thickness=b;return c},function(b,d,g,q,a){if("none"===q)return q;d={};d.color=null===
q.color?g.styleAttrs[c.byName.color.qname]:q.color;d.thickness=l.toComputedLength(q.thickness.value,q.thickness.unit,g.styleAttrs[c.byName.fontSize.qname],g.styleAttrs[c.byName.fontSize.qname],b.cellLength.h,b.pxLength.h);return null===d.thickness?null:d}),new g(d.ns_tts,"textShadow","none",["span"],!0,!0,l.parseTextShadow,function(b,d,g,q){if("none"===q)return q;d=[];for(var a in q){var f={};f.x_off=l.toComputedLength(q[a][0].value,q[a][0].unit,null,g.styleAttrs[c.byName.fontSize.qname],null,b.pxLength.w);
if(null===f.x_off)return null;f.y_off=l.toComputedLength(q[a][1].value,q[a][1].unit,null,g.styleAttrs[c.byName.fontSize.qname],null,b.pxLength.h);if(null===f.y_off)return null;if(null===q[a][2])f.b_radius=0;else if(f.b_radius=l.toComputedLength(q[a][2].value,q[a][2].unit,null,g.styleAttrs[c.byName.fontSize.qname],null,b.pxLength.h),null===f.b_radius)return null;f.color=null===q[a][3]?g.styleAttrs[c.byName.color.qname]:q[a][3];d.push(f)}return d}),new g(d.ns_tts,"unicodeBidi","normal",["span","p"],
!1,!0,function(b){return b},null),new g(d.ns_tts,"visibility","visible",["body","div","p","region","span"],!0,!0,function(b){return b},null),new g(d.ns_tts,"wrapOption","wrap",["span"],!0,!0,function(b){return b},null),new g(d.ns_tts,"writingMode","lrtb",["region"],!1,!0,function(b){return b},null),new g(d.ns_tts,"zIndex","auto",["region"],!1,!0,function(b){"auto"!==b&&(b=parseInt(b),isNaN(b)&&(b=null));return b},null),new g(d.ns_ebutts,"linePadding","0c",["p"],!0,!1,l.parseLength,function(b,c,d,
g,a){return l.toComputedLength(g.value,g.unit,null,null,b.cellLength.w,null)}),new g(d.ns_ebutts,"multiRowAlign","auto",["p"],!0,!1,function(b){return b},null),new g(d.ns_smpte,"backgroundImage",null,["div"],!1,!1,function(b){return b},null),new g(d.ns_itts,"forcedDisplay","false",["body","div","p","region","span"],!0,!0,function(b){return"true"===b?!0:!1},null),new g(d.ns_itts,"fillLineGap","true",["p"],!0,!0,function(b){return"true"===b?!0:!1},null)];c.byQName={};for(var m in c.all)c.byQName[c.all[m].qname]=
c.all[m];c.byName={};for(var r in c.all)c.byName[c.all[r].name]=c.all[r]})("undefined"===typeof m?this.imscStyles={}:m,"undefined"===typeof imscNames?d("./names"):imscNames,"undefined"===typeof imscUtils?d("./utils"):imscUtils)},{"./names":37,"./utils":39}],39:[function(d,r,m){(function(c){var d=/#([0-9a-fA-F]{2})([0-9a-fA-F]{2})([0-9a-fA-F]{2})([0-9a-fA-F]{2})?/,l=/rgb\(\s*(\d+)\s*,\s*(\d+)\s*,\s*(\d+)\s*\)/,m=/rgba\(\s*(\d+),\s*(\d+)\s*,\s*(\d+)\s*,\s*(\d+)\s*\)/,r={transparent:[0,0,0,0],black:[0,
0,0,255],silver:[192,192,192,255],gray:[128,128,128,255],white:[255,255,255,255],maroon:[128,0,0,255],red:[255,0,0,255],purple:[128,0,128,255],fuchsia:[255,0,255,255],magenta:[255,0,255,255],green:[0,128,0,255],lime:[0,255,0,255],olive:[128,128,0,255],yellow:[255,255,0,255],navy:[0,0,128,255],blue:[0,0,255,255],teal:[0,128,128,255],aqua:[0,255,255,255],cyan:[0,255,255,255]};c.parseColor=function(b){var c,g=null,q=r[b.toLowerCase()];void 0!==q?g=q:null!==(c=d.exec(b))?g=[parseInt(c[1],16),parseInt(c[2],
16),parseInt(c[3],16),void 0!==c[4]?parseInt(c[4],16):255]:null!==(c=l.exec(b))?g=[parseInt(c[1]),parseInt(c[2]),parseInt(c[3]),255]:null!==(c=m.exec(b))&&(g=[parseInt(c[1]),parseInt(c[2]),parseInt(c[3]),parseInt(c[4])]);return g};var B=/^((?:\+|\-)?\d*(?:\.\d+)?)(px|em|c|%|rh|rw)$/;c.parseLength=function(b){var c,d=null;null!==(c=B.exec(b))&&(d={value:parseFloat(c[1]),unit:c[2]});return d};c.parseTextShadow=function(b){b=b.split(",");var d=[],g;for(g in b){var l=b[g].split(" ");if(1===l.length&&
"none"===l[0])return"none";if(1<l.length&&5>l.length){var a=[null,null,null,null],f=c.parseLength(l.shift());if(null===f)return null;a[0]=f;f=c.parseLength(l.shift());if(null===f)return null;a[1]=f;if(0!==l.length&&(f=c.parseLength(l[0]),null!==f&&(a[2]=f,l.shift()),0!==l.length)){l=c.parseColor(l[0]);if(null===l)return null;a[3]=l}d.push(a)}}return d};c.parsePosition=function(b){b=b.split(" ");var d=function(a){return"center"===a||"left"===a||"top"===a||"bottom"===a||"right"===a};if(4<b.length)return null;
for(var g in b)if(!d(b[g])){var l=c.parseLength(b[g]);if(null===l)return null;b[g]=l}g={h:{edge:"left",offset:{value:50,unit:"%"}},v:{edge:"top",offset:{value:50,unit:"%"}}};for(l=0;l<b.length;){var a=b[l++];if(d(a)){var f={value:0,unit:"%"};2!==b.length&&l<b.length&&!d(b[l])&&(f=b[l++]);"right"===a?(g.h.edge=a,g.h.offset=f):"bottom"===a?(g.v.edge=a,g.v.offset=f):"left"===a?g.h.offset=f:"top"===a&&(g.v.offset=f)}else if(1===b.length||2===b.length)1===l?g.h.offset=a:g.v.offset=a;else return null}return g};
...
d?new c.ComputedLength(b/100,0):null}})("undefined"===typeof m?this.imscUtils={}:m)},{}]},{},[36])(36)});
