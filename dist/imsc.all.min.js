...
{},k;for(k in d)e[k]=d[k];e.contents=[];d.contents.filter(c).forEach(function(d){d=b(a,d);n.add(d.regionID);null!==d&&e.contents.push(d)});return e}return d}var e=new k(a),h={},g={},n=new Set;g=b(d,a.body);0===n.length&&0<a.head.layout.regions.length&&n.add("");n.forEach(function(b){b=l(a,d,a.head.layout.regions[b],g,null,"",a.head.layout.regions[b],c,h);null!==b&&e.contents.push(b.element)});return e};var w=[e.byName.color.qname,e.byName.textCombine.qname,e.byName.textDecoration.qname,e.byName.textEmphasis.qname,
