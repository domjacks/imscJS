...
p[a>>12&63]+p[a>>6&63]+p[a&63]);return d.join("")}k.byteLength=function(e){e=b(e);var a=e[1];return 3*(e[0]+a)/4-a};k.toByteArray=function(e){var a=b(e);var t=a[0];a=a[1];var d=new v(3*(t+a)/4-a),p=0,D=0<a?t-4:t,x;for(x=0;x<D;x+=4)t=u[e.charCodeAt(x)]<<18|u[e.charCodeAt(x+1)]<<12|u[e.charCodeAt(x+2)]<<6|u[e.charCodeAt(x+3)],d[p++]=t>>16&255,d[p++]=t>>8&255,d[p++]=t&255;2===a&&(t=u[e.charCodeAt(x)]<<2|u[e.charCodeAt(x+1)]>>4,d[p++]=t&255);1===a&&(t=u[e.charCodeAt(x)]<<10|u[e.charCodeAt(x+1)]<<4|u[e.charCodeAt(x+
2)]>>2,d[p++]=t>>8&255,d[p++]=t&255);return d};k.fromByteArray=function(b){for(var a=b.length,d=a%3,u=[],A=0,D=a-d;A<D;A+=16383)u.push(e(b,A,A+16383>D?D:A+16383));1===d?(b=b[a-1],u.push(p[b>>2]+p[b<<4&63]+"==")):2===d&&(b=(b[a-2]<<8)+b[a-1],u.push(p[b>>10]+p[b>>4&63]+p[b<<2&63]+"="));return u.join("")};var p=[],u=[],v="undefined"!==typeof Uint8Array?Uint8Array:Array;for(d=0;64>d;++d)p[d]="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/"[d],u["ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charCodeAt(d)]=
...
typeof g);}function u(g){if("number"!==typeof g)throw new TypeError('"size" argument must be of type number');if(0>g)throw new RangeError('The value "'+g+'" is invalid for option "size"');}function v(g){u(g);return e(0>g?0:t(g)|0)}function D(g){for(var q=0>g.length?0:t(g.length)|0,f=e(q),l=0;l<q;l+=1)f[l]=g[l]&255;return f}function a(g){if(b.isBuffer(g)){var q=t(g.length)|0,f=e(q);if(0===f.length)return f;g.copy(f,0,0,q);return f}if(void 0!==g.length)return(q="number"!==typeof g.length)||(q=g.length,
q=q!==q),q?e(0):D(g);if("Buffer"===g.type&&Array.isArray(g.data))return D(g.data)}function t(g){if(2147483647<=g)throw new RangeError("Attempt to allocate Buffer larger than maximum size: 0x"+(2147483647).toString(16)+" bytes");return g|0}function w(g,q){if(b.isBuffer(g))return g.length;if(ArrayBuffer.isView(g)||M(g,ArrayBuffer))return g.byteLength;if("string"!==typeof g)throw new TypeError('The "string" argument must be one of type string, Buffer, or ArrayBuffer. Received type '+typeof g);var f=
...
this.length;if(0>=f)return"";f>>>=0;q>>>=0;if(f<=q)return"";for(g||(g="utf8");;)switch(g){case "hex":g=q;q=f;f=this.length;if(!g||0>g)g=0;if(!q||0>q||q>f)q=f;l="";for(f=g;f<q;++f)g=l,l=this[f],l=16>l?"0"+l.toString(16):l.toString(16),l=g+l;return l;case "utf8":case "utf-8":return F(this,q,f);case "ascii":g="";for(f=Math.min(this.length,f);q<f;++q)g+=String.fromCharCode(this[q]&127);return g;case "latin1":case "binary":g="";for(f=Math.min(this.length,f);q<f;++q)g+=String.fromCharCode(this[q]);return g;
case "base64":return q=0===q&&f===this.length?N.fromByteArray(this):N.fromByteArray(this.slice(q,f)),q;case "ucs2":case "ucs-2":case "utf16le":case "utf-16le":q=this.slice(q,f);f="";for(g=0;g<q.length;g+=2)f+=String.fromCharCode(q[g]+256*q[g+1]);return f;default:if(l)throw new TypeError("Unknown encoding: "+g);g=(g+"").toLowerCase();l=!0}}function y(g,q,f){var l=g[q];g[q]=g[f];g[f]=l}function x(g,q,f,l,a){if(0===g.length)return-1;"string"===typeof f?(l=f,f=0):2147483647<f?f=2147483647:-2147483648>
...
65536,l.push(c>>>10&1023|55296),c=56320|c&1023);l.push(c);q+=b}g=l.length;if(g<=E)l=String.fromCharCode.apply(String,l);else{f="";for(q=0;q<g;)f+=String.fromCharCode.apply(String,l.slice(q,q+=E));l=f}return l}function z(g,a,f){if(0!==g%1||0>g)throw new RangeError("offset is not uint");if(g+a>f)throw new RangeError("Trying to access beyond buffer length");}function C(g,a,f,l,c,n){if(!b.isBuffer(g))throw new TypeError('"buffer" argument must be a Buffer instance');if(a>c||a<n)throw new RangeError('"value" argument is out of bounds');
...
c.push(f>>6|192,f&63|128)}else if(65536>f){if(0>(a-=3))break;c.push(f>>12|224,f>>6&63|128,f&63|128)}else if(1114112>f){if(0>(a-=4))break;c.push(f>>18|240,f>>12&63|128,f>>6&63|128,f&63|128)}else throw Error("Invalid code point");}return c}function H(g){for(var a=[],f=0;f<g.length;++f)a.push(g.charCodeAt(f)&255);return a}function J(g,a,f,l){for(var q=0;q<l&&!(q+f>=a.length||q>=g.length);++q)a[q+f]=g[q];return q}function M(g,a){return g instanceof a||null!=g&&null!=g.constructor&&null!=g.constructor.name&&
...
this._events;if(b){a=b[a];if("function"===typeof a)return 1;if(a)return a.length}return 0}function a(a,b){for(var c=Array(b),d=0;d<b;++d)c[d]=a[d];return c}function t(a){var b=function(){};b.prototype=a;return new b}function w(a){var b=[],c;for(c in a)Object.prototype.hasOwnProperty.call(a,c)&&b.push(c);return c}function A(a){var b=this;return function(){return b.apply(a,arguments)}}var y=Object.create||t,x=Object.keys||w,G=Function.prototype.bind||A;h.exports=b;b.EventEmitter=b;b.prototype._events=
...
D;b.prototype.eventNames=function(){return 0<this._eventsCount?Reflect.ownKeys(this._events):[]}},{}],6:[function(d,h,k){k.read=function(b,d,p,u,v){var e=8*v-u-1;var a=(1<<e)-1,t=a>>1,w=-7;v=p?v-1:0;var A=p?-1:1,k=b[d+v];v+=A;p=k&(1<<-w)-1;k>>=-w;for(w+=e;0<w;p=256*p+b[d+v],v+=A,w-=8);e=p&(1<<-w)-1;p>>=-w;for(w+=u;0<w;e=256*e+b[d+v],v+=A,w-=8);if(0===p)p=1-t;else{if(p===a)return e?NaN:Infinity*(k?-1:1);e+=Math.pow(2,u);p-=t}return(k?-1:1)*e*Math.pow(2,p-u)};k.write=function(b,d,p,u,v,D){var a,e=8*
...
(this._write=b.write),"function"===typeof b.writev&&(this._writev=b.writev),"function"===typeof b.destroy&&(this._destroy=b.destroy),"function"===typeof b.final&&(this._final=b.final));c.call(this)}function t(a,c,b,d,n,e,m){c.writelen=d;c.writecb=m;c.writing=!0;c.sync=!0;b?a._writev(n,c.onwrite):a._write(n,e,c.onwrite);c.sync=!1}function w(a,c,b,d){!b&&0===c.length&&c.needDrain&&(c.needDrain=!1,a.emit("drain"));c.pendingcb--;d();G(a,c)}function A(a,c){c.bufferProcessing=!0;var b=c.bufferedRequest;
...
default:if(b)return;a=(""+a).toLowerCase();b=!0}}function e(d){var e=b(d);if("string"!==typeof e&&(x.isEncoding===G||!G(d)))throw Error("Unknown encoding: "+d);this.encoding=e||d;switch(this.encoding){case "utf16le":this.text=D;this.end=a;d=4;break;case "utf8":this.fillLast=v;d=4;break;case "base64":this.text=t;this.end=w;d=3;break;default:this.write=A;this.end=y;return}this.lastTotal=this.lastNeed=0;this.lastChar=x.allocUnsafe(d)}function p(a){return 127>=a?0:6===a>>5?2:14===a>>4?3:30===a>>3?4:2===
...
d("readable-stream/transform.js");b.PassThrough=d("readable-stream/passthrough.js");b.Stream=b;b.prototype.pipe=function(b,d){function p(a){b.writable&&!1===b.write(a)&&k.pause&&k.pause()}function u(){k.readable&&k.resume&&k.resume()}function a(){x||(x=!0,b.end())}function t(){x||(x=!0,"function"===typeof b.destroy&&b.destroy())}function w(a){A();if(0===e.listenerCount(this,"error"))throw a;}function A(){k.removeListener("data",p);b.removeListener("drain",u);k.removeListener("end",a);k.removeListener("close",
t);k.removeListener("error",w);b.removeListener("error",w);k.removeListener("end",A);k.removeListener("close",A);b.removeListener("close",A)}var k=this;k.on("data",p);b.on("drain",u);b._isStdio||d&&!1===d.end||(k.on("end",a),k.on("close",t));var x=!1;k.on("error",w);b.on("error",w);k.on("end",A);k.on("close",A);b.on("close",A);b.emit("pipe",k);return b}},{events:5,inherits:7,"readable-stream/duplex.js":12,"readable-stream/passthrough.js":23,"readable-stream/readable.js":24,"readable-stream/transform.js":25,
"readable-stream/writable.js":26}],30:[function(d,h,k){arguments[4][22][0].apply(k,arguments)},{dup:22,"safe-buffer":27}],31:[function(d,h,k){(function(b,e){function p(a,b){this._id=a;this._clearFn=b}var u=d("process/browser.js").nextTick,h=Function.prototype.apply,D=Array.prototype.slice,a={},t=0;k.setTimeout=function(){return new p(h.call(setTimeout,window,arguments),clearTimeout)};k.setInterval=function(){return new p(h.call(setInterval,window,arguments),clearInterval)};k.clearTimeout=k.clearInterval=
...
t++,e=2>arguments.length?!1:D.call(arguments,1);a[d]=!0;u(function(){a[d]&&(e?b.apply(null,e):b.call(null),k.clearImmediate(d))});return d};k.clearImmediate="function"===typeof e?e:function(b){delete a[b]}}).call(this,d("timers").setImmediate,d("timers").clearImmediate)},{"process/browser.js":11,timers:31}],32:[function(d,h,k){(function(b){function d(d){try{if(!b.localStorage)return!1}catch(u){return!1}d=b.localStorage[d];return null==d?!1:"true"===String(d).toLowerCase()}h.exports=function(b,e){if(d("noDeprecation"))return b;
...
")"),e=new q,e.initFromNode(w,m[0],a,b),m[0].sets.push(e),m.unshift(e)):m.unshift(new u(a));else m.unshift(new u(a));if(m[0]instanceof u)if(a.uri===p.ns_tt&&"metadata"===a.local)H++;else if(0<H&&f&&"onOpenTag"in f){e=[];for(var t in a.attributes)e[a.attributes[t].uri+" "+a.attributes[t].local]={uri:a.attributes[t].uri,local:a.attributes[t].local,value:a.attributes[t].value};f.onOpenTag(a.uri,a.local,e)}};n.write(c).close();delete w.head.styling.styles;c=!1;for(var h in w.head.layout.regions){c=!0;
break}c||(h=g.prototype.createDefaultRegion(w,b),w.head.layout.regions[h.id]=h);for(var aa in w.head.layout.regions)t(w,w.head.layout.regions[aa],null,null);w.body&&t(w,w.body,null,null);w.body&&a(w.body);w.body&&e(w.body);return w};A.prototype.initFromNode=function(a,c){var b=P(a,p.ns_ttp,"cellResolution"),d=15;var f=32;null!==b&&(b=/(\d+) (\d+)/.exec(b),null!==b?(f=parseInt(b[1]),d=parseInt(b[2])):R(c,"Malformed cellResolution value (using initial value instead)"));this.cellLength={h:new h.ComputedLength(0,
...
g.prototype.initFromNode=function(a,c,b){I.prototype.initFromNode.call(this,a,null,c,b);H.prototype.initFromNode.call(this,a,null,c,b);n.prototype.initFromNode.call(this,a,null,c,b);this.styleAttrs=Q(c,b);this.styleRefs=l(c)};q.prototype.initFromNode=function(a,c,b,d){H.prototype.initFromNode.call(this,a,c,b,d);a=Q(b,d);this.value=this.qname=null;for(var f in a){if(this.qname){L(d,"More than one style specified on set");break}this.qname=f;this.value=a[f]}}})("undefined"===typeof k?this.imscDoc={}:
k,"undefined"===typeof sax?d("sax"):sax,"undefined"===typeof imscNames?d("./names"):imscNames,"undefined"===typeof imscStyles?d("./styles"):imscStyles,"undefined"===typeof imscUtils?d("./utils"):imscUtils)},{"./names":37,"./styles":38,"./utils":39,sax:28}],34:[function(d,h,k){(function(b,d,p,k){function e(a){var c={};colorAdjustMapEntries=Object.entries(a);for(var b in colorAdjustMapEntries)fromColor=k.parseColor(colorAdjustMapEntries[b][0]),toColor=k.parseColor(colorAdjustMapEntries[b][1]),fromColor&&
toColor&&(c[fromColor.toString()]=toColor);return c}function u(c,b,d){if("region"===d.kind){var e=document.createElement("div");e.style.position="absolute"}else if("body"===d.kind)e=document.createElement("div");else if("div"===d.kind)e=document.createElement("div");else if("image"===d.kind){if(e=document.createElement("img"),null!==c.imgResolver&&null!==d.src){var n=c.imgResolver(d.src,e);n&&(e.src=n);e.height=c.regionH;e.width=c.regionW}}else if("p"===d.kind)e=document.createElement("p");else if("span"===
d.kind)if("container"===d.styleAttrs[p.byName.ruby.qname])e=document.createElement("ruby"),c.ruby=!0;else if("base"===d.styleAttrs[p.byName.ruby.qname])e=document.createElement("rb");else if("text"===d.styleAttrs[p.byName.ruby.qname])e=document.createElement("rt");else if("baseContainer"===d.styleAttrs[p.byName.ruby.qname])e=document.createElement("rbc");else if("textContainer"===d.styleAttrs[p.byName.ruby.qname])e=document.createElement("rtc");else{if("delimiter"===d.styleAttrs[p.byName.ruby.qname])return;
e=document.createElement("span")}else"br"===d.kind&&(e=document.createElement("br"));if(e){b.appendChild(e);e.style.margin="0";if("region"===d.kind)if(b=d.styleAttrs[p.byName.writingMode.qname],"lrtb"===b||"lr"===b)c.ipd="lr",c.bpd="tb";else if("rltb"===b||"rl"===b)c.ipd="rl",c.bpd="tb";else if("tblr"===b)c.ipd="tb",c.bpd="lr";else{if("tbrl"===b||"tb"===b)c.ipd="tb",c.bpd="rl"}else"p"===d.kind&&"tb"===c.bpd&&(c.ipd="ltr"===d.styleAttrs[p.byName.direction.qname]?"lr":"rl");for(var k in x)b=x[k],n=
d.styleAttrs[b.qname],void 0!==n&&null!==b.map&&b.map(c,e,d,n);k=e;(b=d.styleAttrs[p.byName.linePadding.qname])&&!b.isZero()&&(n=b.multiply(b.toUsedLength(c.w,c.h),c.options.sizeAdjust),0<n&&(n=Math.ceil(n)+"px","tb"===c.bpd?(k.style.paddingLeft=n,k.style.paddingRight=n):(k.style.paddingTop=n,k.style.paddingBottom=n),c.lp=b));(b=d.styleAttrs[p.byName.multiRowAlign.qname])&&"auto"!==b&&(k=document.createElement("span"),k.style.display="inline-block",k.style.textAlign=b,e.appendChild(k),c.mra=b);(b=
d.styleAttrs[p.byName.rubyReserve.qname])&&"none"!==b[0]&&(c.rubyReserve=b);d.styleAttrs[p.byName.fillLineGap.qname]&&(c.flg=!0);if("span"===d.kind&&d.text)if((b=d.styleAttrs[p.byName.textEmphasis.qname])&&"none"!==b.style&&(c.textEmphasis=!0),p.byName.textCombine.qname in d.styleAttrs&&"all"===d.styleAttrs[p.byName.textCombine.qname][0])e.textContent=d.text,b&&A(c,e,d,b);else{n="";for(var h=0;h<d.text.length;h++){n+=d.text.charAt(h);var B=d.text.charCodeAt(h);if(55296>B||56319<B||h===d.text.length)B=
document.createElement("span"),B.textContent=n,b&&A(c,B,d,b),e.appendChild(B),n=""}}for(var y in d.contents)u(c,k,d.contents[y]);y=[];if((c.lp||c.mra||c.flg||c.ruby||c.textEmphasis||c.rubyReserve)&&"p"===d.kind){w(c,k,y,null);if(c.rubyReserve){for(b=0;b<y.length;b++){n=document.createElement("ruby");h=document.createElement("rb");h.textContent="\u200b";n.appendChild(h);var v=c.rubyReserve[1].toUsedLength(c.w,c.h)+"px";"both"===c.rubyReserve[0]||"outside"===c.rubyReserve[0]&&1==y.length?(h=document.createElement("rtc"),
h.style[z]=F?"after":"under",h.textContent="\u200b",h.style.fontSize=v,B=document.createElement("rtc"),B.style[z]=F?"before":"over",B.textContent="\u200b",B.style.fontSize=v,n.appendChild(h),n.appendChild(B)):(h=document.createElement("rtc"),h.textContent="\u200b",h.style.fontSize=v,h.style[z]="after"===c.rubyReserve[0]||"outside"===c.rubyReserve[0]&&0<b?F?"after":"tb"===c.bpd||"rl"===c.bpd?"under":"over":F?"before":"tb"===c.bpd||"rl"===c.bpd?"over":"under",n.appendChild(h));h=null;for(B=0;B<y[b].rbc.length;B++)if("ruby"===
y[b].rbc[B].localName){h=y[b].rbc[B];for(B=0;B<h.style.length;B++)n.style.setProperty(h.style.item(B),h.style.getPropertyValue(h.style.item(B)));break}h=h||y[b].elements[0].node;h.parentElement.insertBefore(n,h)}c.rubyReserve=null}if(c.ruby||c.rubyReserve){for(b=0;b<y.length;b++)for(n=0;n<y[b].rbc.length;n++)y[b].rbc[n].style[z]||(y[b].rbc[n].style[z]=F?0===b?"before":"after":"tb"===c.bpd?0===b?"over":"under":"rl"===c.bpd?0===b?"over":"under":0===b?"under":"over");c.ruby=null}if(c.textEmphasis){for(b=
0;b<y.length;b++)for(n=0;n<y[b].te.length;n++)y[b].te[n].style[I]&&"none"!==y[b].te[n].style[I]||(y[b].te[n].style[I]="tb"===c.bpd?0===b?"left over":"left under":"rl"===c.bpd?0===b?"right under":"left under":0===b?"left under":"right under");c.textEmphasis=null}if(c.mra){for(b=0;b<y.length-1;b++)h=y[b].elements.length,0!==h&&!1===y[b].br&&(n=document.createElement("br"),h=y[b].elements[h-1].node,h.parentElement.insertBefore(n,h.nextSibling));c.mra=null}if(c.lp){b=c.lp.multiply(c.lp.toUsedLength(c.w,
c.h),c.options.sizeAdjust);for(var C in y)n=y[C].elements[y[C].start_elem],h=y[C].elements[y[C].end_elem],B=Math.ceil(b)+"px",v="-"+Math.ceil(b)+"px",0!==y[C].elements.length&&("lr"===c.ipd?(n.node.style.borderLeftColor=n.bgcolor||"#00000000",n.node.style.borderLeftStyle="solid",n.node.style.borderLeftWidth=B,n.node.style.marginLeft=v):"rl"===c.ipd?(n.node.style.borderRightColor=n.bgcolor||"#00000000",n.node.style.borderRightStyle="solid",n.node.style.borderRightWidth=B,n.node.style.marginRight=v):
"tb"===c.ipd&&(n.node.style.borderTopColor=n.bgcolor||"#00000000",n.node.style.borderTopStyle="solid",n.node.style.borderTopWidth=B,n.node.style.marginTop=v),"lr"===c.ipd?(h.node.style.borderRightColor=h.bgcolor||"#00000000",h.node.style.borderRightStyle="solid",h.node.style.borderRightWidth=B,h.node.style.marginRight=v):"rl"===c.ipd?(h.node.style.borderLeftColor=h.bgcolor||"#00000000",h.node.style.borderLeftStyle="solid",h.node.style.borderLeftWidth=B,h.node.style.marginLeft=v):"tb"===c.ipd&&(h.node.style.borderBottomColor=
h.bgcolor||"#00000000",h.node.style.borderBottomStyle="solid",h.node.style.borderBottomWidth=B,h.node.style.marginBottom=v));c.lp=null}if(c.flg){b=t(k.getBoundingClientRect(),c);C=b.before;b=b.after;n=Math.sign(b-C);for(h=0;h<=y.length;h++){B=0===h?C:h===y.length?b:(y[h].before+y[h-1].after)/2;if(0<h)for(var g=0;g<y[h-1].elements.length;g++)if(null!==y[h-1].elements[g].bgcolor){var q=y[h-1].elements[g];0>n*(q.after-B)&&(v=Math.ceil(Math.abs(B-q.after))+"px",q.node.style.backgroundColor=q.bgcolor,
"lr"===c.bpd?q.node.style.paddingRight=v:"rl"===c.bpd?q.node.style.paddingLeft=v:"tb"===c.bpd&&(q.node.style.paddingBottom=v))}if(h<y.length)for(g=0;g<y[h].elements.length;g++)q=y[h].elements[g],null!==q.bgcolor&&0<n*(q.before-B)&&(v=Math.ceil(Math.abs(q.before-B))+"px",q.node.style.backgroundColor=q.bgcolor,"lr"===c.bpd?q.node.style.paddingLeft=v:"rl"===c.bpd?q.node.style.paddingRight=v:"tb"===c.bpd&&(q.node.style.paddingTop=v))}c.flg=null}}"region"===d.kind&&(w(c,k,y),"tb"===c.bpd&&c.enableRollUp&&
0<d.contents.length&&"after"===d.styleAttrs[p.byName.displayAlign.qname]&&(d=new a(""===d.id?"_":d.id,y),c.currentISDState[d.id]=d,c.previousISDState&&d.id in c.previousISDState&&0<c.previousISDState[d.id].plist.length&&1<d.plist.length&&d.plist[d.plist.length-2].text===c.previousISDState[d.id].plist[c.previousISDState[d.id].plist.length-1].text&&(c=e.firstElementChild,d=d.plist[d.plist.length-1].after-d.plist[d.plist.length-1].before,c.style.bottom="-"+d+"px",c.style.transition="transform 0.4s",
c.style.position="relative",c.style.transform="translateY(-"+d+"px)")))}else if(c=c.errorHandler,d="Error processing ISD element kind: "+d.kind,c&&c.error&&c.error(d))throw d;}function a(a,b){this.id=a;this.plist=b}function t(a,b){var c={before:null,after:null,start:null,end:null};"tb"===b.bpd?(c.before=a.top,c.after=a.bottom,"lr"===b.ipd?(c.start=a.left,c.end=a.right):(c.start=a.right,c.end=a.left)):"lr"===b.bpd?(c.before=a.left,c.after=a.right,c.start=a.top,c.end=a.bottom):"rl"===b.bpd&&(c.before=
a.right,c.after=a.left,c.start=a.top,c.end=a.bottom);return c}function w(a,b,d,e){if("rt"!==b.localName&&"rtc"!==b.localName)if(e=b.style.backgroundColor||e,0===b.childElementCount)if("span"===b.localName||"rb"===b.localName){var c=b.getBoundingClientRect();if(0!==c.height&&0!==c.width){a=t(c,a);if(!(c=0===d.length)){c=a.before;var m=a.after,n=d[d.length-1].before,h=d[d.length-1].after;c=!(m<h&&c>n||h<=m&&n>=c)}c?d.push({before:a.before,after:a.after,start:a.start,end:a.end,start_elem:0,end_elem:0,
elements:[],rbc:[],te:[],text:"",br:!1}):(c=Math.sign(a.after-a.before),m=Math.sign(a.end-a.start),0>c*(a.before-d[d.length-1].before)&&(d[d.length-1].before=a.before),0<c*(a.after-d[d.length-1].after)&&(d[d.length-1].after=a.after),0>m*(a.start-d[d.length-1].start)&&(d[d.length-1].start=a.start,d[d.length-1].start_elem=d[d.length-1].elements.length),0<m*(a.end-d[d.length-1].end)&&(d[d.length-1].end=a.end,d[d.length-1].end_elem=d[d.length-1].elements.length));d[d.length-1].text+=b.textContent;d[d.length-
1].elements.push({node:b,bgcolor:e,before:a.before,after:a.after})}}else"br"===b.localName&&0!==d.length&&(d[d.length-1].br=!0);else for(b=b.firstChild;b;)b.nodeType===Node.ELEMENT_NODE&&(w(a,b,d,e),"ruby"===b.localName||"rtc"===b.localName?0<d.length&&d[d.length-1].rbc.push(b):"span"===b.localName&&b.style[C]&&"none"!==b.style[C]&&0<d.length&&d[d.length-1].te.push(b)),b=b.nextSibling}function A(a,b,d,e){if("none"===e.style)b.style[C]="none";else if(b.style[C]="auto"===e.style?"filled":e.style+" "+
e.symbol,"before"===e.position||"after"===e.position)b.style[I]="tb"===a.bpd?"before"===e.position?"left over":"left under":"rl"===a.bpd?"before"===e.position?"right under":"left under":"before"===e.position?"left under":"right under"}function h(a,b){this.qname=a;this.map=b}b.render=function(a,b,d,m,t,h,p,k,A,w){m=m||b.clientHeight;t=t||b.clientWidth;if(null!==a.aspectRatio){var c=m*a.aspectRatio;c>t?m=Math.round(t/a.aspectRatio):t=c}c=document.createElement("div");c.style.position="relative";c.style.width=
t+"px";c.style.height=m+"px";c.style.margin="auto";c.style.top=0;c.style.bottom=0;c.style.left=0;c.style.right=0;c.style.zIndex=0;w&&(w.colorAdjust&&(w.colorAdjust=e(w.colorAdjust)),w.spanBackgroundColorAdjust&&(w.spanBackgroundColorAdjust=e(w.spanBackgroundColorAdjust)));d={h:m,w:t,regionH:null,regionW:null,imgResolver:d,displayForcedOnlyMode:h||!1,isd:a,errorHandler:p,previousISDState:k,enableRollUp:A||!1,currentISDState:{},flg:null,lp:null,mra:null,ipd:null,bpd:null,ruby:null,textEmphasis:null,
rubyReserve:null,options:w||{}};b.appendChild(c);for(var g in a.contents)u(d,c,a.contents[g]);return d.currentISDState};var x=[new h("http://www.w3.org/ns/ttml#styling backgroundColor",function(a,b,d,e){var c=null;"span"==d.kind&&(c=a.options.spanBackgroundColorAdjust);void 0!=c&&(map_attr=c[e.toString()])&&(e=map_attr);d=e[3];0!==d&&(void 0!=a.options.backgroundOpacityScale&&(d*=a.options.backgroundOpacityScale),b.style.backgroundColor="rgba("+e[0].toString()+","+e[1].toString()+","+e[2].toString()+
","+(d/255).toString()+")")}),new h("http://www.w3.org/ns/ttml#styling color",function(a,b,d,e){opacityMultiplier=a.options.colorOpacityScale||1;colorAdjustMap=a.options.colorAdjust;void 0!=colorAdjustMap&&(map_attr=colorAdjustMap[e.toString()])&&(e=map_attr);b.style.color="rgba("+e[0].toString()+","+e[1].toString()+","+e[2].toString()+","+(opacityMultiplier*e[3]/255).toString()+")"}),new h("http://www.w3.org/ns/ttml#styling direction",function(a,b,d,e){b.style.direction=e}),new h("http://www.w3.org/ns/ttml#styling display",
function(a,b,d,e){}),new h("http://www.w3.org/ns/ttml#styling displayAlign",function(a,b,d,e){b.style.display="flex";b.style.flexDirection="column";"before"===e?b.style.justifyContent="flex-start":"center"===e?b.style.justifyContent="center":"after"===e&&(b.style.justifyContent="flex-end")}),new h("http://www.w3.org/ns/ttml#styling extent",function(a,b,d,e){a.regionH=e.h.toUsedLength(a.w,a.h);a.regionW=e.w.toUsedLength(a.w,a.h);var c=e=0;if(d=d.styleAttrs["http://www.w3.org/ns/ttml#styling padding"])e=
d[0].toUsedLength(a.w,a.h)+d[2].toUsedLength(a.w,a.h),c=d[1].toUsedLength(a.w,a.h)+d[3].toUsedLength(a.w,a.h);b.style.height=a.regionH-e+"px";b.style.width=a.regionW-c+"px"}),new h("http://www.w3.org/ns/ttml#styling fontFamily",function(a,b,d,e){d=[];a.options.fontFamily&&(e=a.options.fontFamily.split(","));for(var c in e)e[c]=e[c].trim(),"monospaceSerif"===e[c]?(d.push("Courier New"),d.push('"Liberation Mono"'),d.push("Courier"),d.push("monospace")):"proportionalSansSerif"===e[c]||"default"===e[c]?
(d.push("Arial"),d.push("Helvetica"),d.push('"Liberation Sans"'),d.push("sans-serif")):"monospace"===e[c]?d.push("monospace"):"sansSerif"===e[c]?d.push("sans-serif"):"serif"===e[c]?d.push("serif"):"monospaceSansSerif"===e[c]?(d.push("Consolas"),d.push("monospace")):"proportionalSerif"===e[c]?d.push("serif"):d.push(e[c]);b.style.fontFamily=d.join(",")}),new h("http://www.w3.org/ns/ttml#styling shear",function(a,b,d,e){0!==e&&(d=-.9*e,b.style.transform="tb"===a.bpd?"skewX("+d+"deg)":"skewY("+d+"deg)")}),
new h("http://www.w3.org/ns/ttml#styling fontSize",function(a,b,d,e){b.style.fontSize=e.multiply(e.toUsedLength(a.w,a.h),a.options.sizeAdjust)+"px"}),new h("http://www.w3.org/ns/ttml#styling fontStyle",function(a,b,d,e){b.style.fontStyle=e}),new h("http://www.w3.org/ns/ttml#styling fontWeight",function(a,b,d,e){b.style.fontWeight=e}),new h("http://www.w3.org/ns/ttml#styling lineHeight",function(a,b,d,e){b.style.lineHeight="normal"===e?"normal":e.multiply(e.toUsedLength(a.w,a.h),a.options.sizeAdjust)+
"px"}),new h("http://www.w3.org/ns/ttml#styling opacity",function(a,b,d,e){d=e;void 0!=a.options.regionOpacityScale&&(d*=a.options.regionOpacityScale);b.style.opacity=d}),new h("http://www.w3.org/ns/ttml#styling origin",function(a,b,d,e){b.style.top=e.h.toUsedLength(a.w,a.h)+"px";b.style.left=e.w.toUsedLength(a.w,a.h)+"px"}),new h("http://www.w3.org/ns/ttml#styling overflow",function(a,b,d,e){b.style.overflow=e}),new h("http://www.w3.org/ns/ttml#styling padding",function(a,b,d,e){d=[];d[0]=e[0].toUsedLength(a.w,
a.h)+"px";d[1]=e[3].toUsedLength(a.w,a.h)+"px";d[2]=e[2].toUsedLength(a.w,a.h)+"px";d[3]=e[1].toUsedLength(a.w,a.h)+"px";b.style.padding=d.join(" ")}),new h("http://www.w3.org/ns/ttml#styling position",function(a,b,d,e){b.style.top=e.h.toUsedLength(a.w,a.h)+"px";b.style.left=e.w.toUsedLength(a.w,a.h)+"px"}),new h("http://www.w3.org/ns/ttml#styling rubyAlign",function(a,b,d,e){b.style.rubyAlign="spaceAround"===e?"space-around":"center"}),new h("http://www.w3.org/ns/ttml#styling rubyPosition",function(a,
b,d,e){if("before"===e||"after"===e)b.parentElement.style[z]=F?e:"tb"===a.bpd?"before"===e?"over":"under":"rl"===a.bpd?"before"===e?"over":"under":"before"===e?"under":"over"}),new h("http://www.w3.org/ns/ttml#styling showBackground",null),new h("http://www.w3.org/ns/ttml#styling textAlign",function(a,b,d,e){b.style.textAlign="start"===e?"rl"===a.ipd?"right":"left":"end"===e?"rl"===a.ipd?"left":"right":e}),new h("http://www.w3.org/ns/ttml#styling textDecoration",function(a,b,d,e){b.style.textDecoration=
...
b,d,e){b.style.zIndex=e}),new h("http://www.w3.org/ns/ttml/profile/imsc1#styling forcedDisplay",function(a,b,d,e){a.displayForcedOnlyMode&&!1===e&&(b.style.visibility="hidden")})],G;for(G in x);var F="webkitRubyPosition"in window.getComputedStyle(document.documentElement),z=F?"webkitRubyPosition":"rubyPosition",C="webkitTextEmphasisStyle"in window.getComputedStyle(document.documentElement)?"webkitTextEmphasisStyle":"textEmphasisStyle",I="webkitTextEmphasisPosition"in window.getComputedStyle(document.documentElement)?
"webkitTextEmphasisPosition":"textEmphasisPosition"})("undefined"===typeof k?this.imscHTML={}:k,"undefined"===typeof imscNames?d("./names"):imscNames,"undefined"===typeof imscStyles?d("./styles"):imscStyles,"undefined"===typeof imscUtils?d("./utils"):imscUtils)},{"./names":37,"./styles":38,"./utils":39}],35:[function(d,h,k){(function(b,d,h,k){function e(b,d,w,y,v,D,c,B,n){if(d<c.begin||d>=c.end)return null;D="regionID"in c&&""!==c.regionID?c.regionID:D;if(null!==v&&D!==w.id&&(!("contents"in c)||"contents"in
c&&0===c.contents.length||""!==D))return null;var m=new A(c);for(x in c.sets)d<c.sets[x].begin||d>=c.sets[x].end||(m.styleAttrs[c.sets[x].qname]=c.sets[x].value);var x={};for(var z in m.styleAttrs)if(x[z]=!0,"region"===m.kind&&z===h.byName.writingMode.qname&&!(h.byName.direction.qname in m.styleAttrs)){var C=m.styleAttrs[z];if("lrtb"===C||"lr"===C)m.styleAttrs[h.byName.direction.qname]="ltr";else if("rltb"===C||"rl"===C)m.styleAttrs[h.byName.direction.qname]="rtl"}if(null!==v)for(var G in h.all)if(z=
h.all[G],z.qname===h.byName.textDecoration.qname){C=v.styleAttrs[z.qname];var F=m.styleAttrs[z.qname],E=[];void 0===F?E=C:-1===F.indexOf("none")?((-1===F.indexOf("noUnderline")&&-1!==C.indexOf("underline")||-1!==F.indexOf("underline"))&&E.push("underline"),(-1===F.indexOf("noLineThrough")&&-1!==C.indexOf("lineThrough")||-1!==F.indexOf("lineThrough"))&&E.push("lineThrough"),(-1===F.indexOf("noOverline")&&-1!==C.indexOf("overline")||-1!==F.indexOf("overline"))&&E.push("overline")):E.push("none");m.styleAttrs[z.qname]=
E}else z.qname!==h.byName.fontSize.qname||z.qname in m.styleAttrs||"span"!==m.kind||"textContainer"!==m.styleAttrs[h.byName.ruby.qname]?z.qname!==h.byName.fontSize.qname||z.qname in m.styleAttrs||"span"!==m.kind||"text"!==m.styleAttrs[h.byName.ruby.qname]?z.inherit&&z.qname in v.styleAttrs&&!(z.qname in m.styleAttrs)&&(m.styleAttrs[z.qname]=v.styleAttrs[z.qname]):(C=v.styleAttrs[h.byName.fontSize.qname],m.styleAttrs[z.qname]="textContainer"===v.styleAttrs[h.byName.ruby.qname]?C:new k.ComputedLength(.5*
C.rw,.5*C.rh)):(C=v.styleAttrs[h.byName.fontSize.qname],m.styleAttrs[z.qname]=new k.ComputedLength(.5*C.rw,.5*C.rh));for(var I in h.all)if(G=h.all[I],!(G.qname in m.styleAttrs||G.qname===h.byName.position.qname&&h.byName.origin.qname in m.styleAttrs||G.qname===h.byName.origin.qname&&h.byName.position.qname in m.styleAttrs)&&(z=b.head.styling.initials[G.qname]||G.initial,null!==z&&("region"===m.kind||!1===G.inherit&&null!==z)))if(z=G.parse(z),null!==z)m.styleAttrs[G.qname]=z,x[G.qname]=!0;else if(G=
"Invalid initial value for '"+G.qname+"' on element '"+m.kind,B&&B.error&&B.error(G))throw G;for(var g in h.all)if(I=h.all[g],I.qname in x&&null!==I.compute)if(G=I.compute(b,v,m,m.styleAttrs[I.qname],n),null!==G)m.styleAttrs[I.qname]=G;else if(m.styleAttrs[I.qname]=I.compute(b,v,m,I.parse(I.initial),n),I="Style '"+I.qname+"' on element '"+m.kind+"' cannot be computed",B&&B.error&&B.error(I))throw I;if("none"===m.styleAttrs[h.byName.display.qname])return null;if(null===v)var q=null===y?[]:[y];else"contents"in
c&&(q=c.contents);for(var f in q)v=e(b,d,w,y,m,D,q[f],B,n),null!==v&&m.contents.push(v.element);for(var l in m.styleAttrs)b=!1,"span"===m.kind&&(d=m.styleAttrs[h.byName.ruby.qname],(b=("container"===d||"textContainer"===d||"baseContainer"===d)&&-1!==u.indexOf(l))||(b="container"!==d&&l===h.byName.rubyAlign.qname),b||(b=!("textContainer"===d||"text"===d)&&l===h.byName.rubyPosition.qname)),b||(b=-1===h.byQName[l].applies.indexOf(m.kind)),b&&delete m.styleAttrs[l];l=m.styleAttrs[h.byName.ruby.qname];
if("p"===m.kind||"span"===m.kind&&("textContainer"===l||"text"===l))l=[],a(m,l),p(l),t(m);return"div"===m.kind&&h.byName.backgroundImage.qname in m.styleAttrs||"br"===m.kind||"image"===m.kind||"contents"in m&&0<m.contents.length||"span"===m.kind&&null!==m.text||"region"===m.kind&&"always"===m.styleAttrs[h.byName.showBackground.qname]?{region_id:D,element:m}:null}function p(a){function b(a){return"br"===a.kind||/[\r\n\t ]$/.test(a.text)}function d(a){return"br"===a.kind||"preserve"===a.space&&/^[\r\n]/.test(a.text)}
...
parseInt(b[3]),parseInt(b[4])]);return e};var D=/^((?:\+|\-)?\d*(?:\.\d+)?)(px|em|c|%|rh|rw)$/;b.parseLength=function(a){var b,d=null;null!==(b=D.exec(a))&&(d={value:parseFloat(b[1]),unit:b[2]});return d};b.parseTextShadow=function(a){a=a.split(",");var d=[],e;for(e in a){var h=a[e].split(" ");if(1===h.length&&"none"===h[0])return"none";if(1<h.length&&5>h.length){var k=[null,null,null,null],p=b.parseLength(h.shift());if(null===p)return null;k[0]=p;p=b.parseLength(h.shift());if(null===p)return null;
